 ...
 *
 * MDMOID_ETHERNET_FRAME_EXTENDED_P_M 2152
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER3_DATA_SERVICES 2153
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_CONFIG_DATA 2154
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IP_HOST_CONFIG_DATA 2155
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_PM_HISTORY_DATA 2156
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_HOST_CONFIG_DATA 2157
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ADDRESS_TABLE 2158
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DEFAULT_ROUTER_TABLE 2159
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DNS_TABLE 2160
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ONLINK_PREFIX_TABLE 2161
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IPV6_HOST_CONFIG_DATA 2162
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TCP_UDP_CONFIG_DATA 2163
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA 2166
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA2 2167
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA3 2168
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VIRTUAL_ETHERNET_INTERFACE_POINT 2169
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_CONFIG_DATA 2173
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_MEDIA_PROFILE 2175
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_APP_SERVICE_PROFILE 2178
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_FEATURE_ACCESS_CODES 2179
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_NETWORK_DIAL_PLAN_TABLE 2180
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_CALL_CONTROL_PM_HISTORY_DATA 2183
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RTP_PM_HISTORY_DATA 2184
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_PM_HISTORY_DATA 2185
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_CALL_INIT_PM_HISTORY_DATA 2186
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MGC_PM_HISTORY_DATA 2188
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BRCM_PPTP_MOCA_UNI 2192
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_ETHERNET_PM_HISTORY_DATA 2195
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA 2196
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA_NODE_TABLE 2197
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TRAFFIC_MANAGEMENT 2198
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TRAFFIC_SCHEDULER_G 2200
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_TRAFFIC_DESCRIPTOR 2201
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_AUTHENTICATION_SECURITY_METHOD 2206
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TR069_MANAGEMENT_SERVER 2211
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
