 ...
 *
 * $Id: channelcapacity.js 603186 2015-12-01 07:49:11Z spalanga $
 */
...
function FetchDataForChCapacity(islayoutreq, selectedBand) {
	...
	$.ajax({
		type:'GET',
		url:urlchcapacity,
		data:{Req:'ChannelCapacity', DutMac:selectedBand.mac, FreqBand:selectedBand.band,sessionKey:sessionKey},
		success:function(result){
			if (isHTTPDWebserver == 1)
				chnldata = result;
			else
