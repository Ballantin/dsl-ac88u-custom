...
#                Example: 'export STUNC_ROOT := prot_NATtrvrsl/stacks/turnc'
#     ICE_ROOT:  The absolute path to the directory containing the ICE module.
#
include	$(STUNC_ROOT)/build/xchg/stunc_target.mk
include	$(TURNC_ROOT)/turnc_target.mk
include	$(ICE_ROOT)/ice_target.mk
export	NATT_BUILD_EXPORTED_INCLUDE	=	$(STUNC_BUILD_EXPORTED_INCLUDE)	\
