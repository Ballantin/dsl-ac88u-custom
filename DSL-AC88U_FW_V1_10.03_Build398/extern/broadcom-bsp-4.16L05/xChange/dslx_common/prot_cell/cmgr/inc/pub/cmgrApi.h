...
** TODO: Remove or replaced wiht NET_CLID_LEN
*/
...
/***********************************************************************************
** FUNCTION:   CMGRNETREQCB
**
** PURPOSE:    Callback functionality for  network action outside of the
**             Call Manager.
**
** PARAMETERS: eCmd  - the command of interest.
**             uNetCid - the network handle for call control commands (may be INVALID)
**             pCmData - pointer with CMGR data associated to the request. (may be NULL)
**             pAppData - pointer for application to fill in additional data (may be NULL)
**
** RETURNS:    Nothing.
**
** NOTE:
***********************************************************************************/
typedef void ( *CMGRNETREQCB )( CMGRNETREQ eReq,
                                BOS_UINT32 uNetCid,
                                void *pCmData,
                                void *pAppData );
