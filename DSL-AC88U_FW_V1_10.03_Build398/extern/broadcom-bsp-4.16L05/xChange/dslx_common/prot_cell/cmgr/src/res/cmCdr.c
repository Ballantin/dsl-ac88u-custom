...
**    Description:
**
**      This module implements the Call Data Record engine which keeps call and
...
void cmCdr ( BOS_BOOL bCreate )
{
   if ( bCreate )
   {
      CMGRLOG_INFORMATION (( "cmCdr: creating CDR support." ));

      gpCmgrCdr = (CCTKCDR *) malloc ( sizeof( CCTKCDR ) );
   }
   else
   {
      CMGRLOG_INFORMATION (( "cmCdr: terminating CDR support." ));
