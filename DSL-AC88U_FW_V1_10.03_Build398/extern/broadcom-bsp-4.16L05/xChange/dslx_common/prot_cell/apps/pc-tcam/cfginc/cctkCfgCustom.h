...
#undef CCTKCFG_REMOTE_USER_CONTROL
#define CCTKCFG_REMOTE_USER_CONTROL                      1

#undef CCTKCFG_MESSAGE_PASS_THROUGH
#define CCTKCFG_MESSAGE_PASS_THROUGH                     1

#undef CCTKCFG_IP_ADDRESS_DIALING
#define CCTKCFG_IP_ADDRESS_DIALING                       1
