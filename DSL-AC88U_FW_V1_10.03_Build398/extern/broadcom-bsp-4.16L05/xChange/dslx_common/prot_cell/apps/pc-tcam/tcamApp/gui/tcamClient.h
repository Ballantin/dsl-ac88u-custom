...
**    Description:
**
**      This module defines the basic API necessary to run the TCAM client
**      application which is the user application of the GUI.
**
***********************************************************************************/

#ifndef __TCAM_CLIENT__H__INCLUDED__
#define __TCAM_CLIENT__H__INCLUDED__
...
#endif /* __TCAM_CLIENT__H__INCLUDED__ */
