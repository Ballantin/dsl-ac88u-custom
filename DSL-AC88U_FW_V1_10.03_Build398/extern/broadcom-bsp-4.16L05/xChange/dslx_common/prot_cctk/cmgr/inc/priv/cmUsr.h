...
typedef struct
{
   ...
   CMALGALRMCFGSTATE  eAlarmCfgState; /* Analog Alarm Config state */
   BOS_BOOL           bAlarmActive;
   BOS_BOOL           bDisableAutoCallSwitch;   /* The user is attempting to create a parallel call */
...
**
** PARAMETERS: pCurUsr - the user of interest.
**             uRemoteUsrHdl - the handle of the remote user to be linked with
**             the current user.
**
** RETURNS:    None.
***********************************************************************************/
void cmUsrLinkRemoteUser ( CMUSR *pCurUsr, BOS_UINT32 uRemoteUsrHdl );
...
**
** PURPOSE:    Disssociates a CCTK account for a user.  This will clear the uUid and
**             the uUindex for the CM user.
**
...
**
** PURPOSE:    Update the CCTK account info for the user
**
