...
**    Description:
**
**      This file contains the profile specific functionality.
**
***********************************************************************************/

#ifndef __CM_PROF__H__INCLUDED__
#define __CM_PROF__H__INCLUDED__
...
/***********************************************************************************
** FUNCTION:   cmProfCustUserAdd
**
** PURPOSE:    Configure a specific user for a custom application.
**
** PARAMETERS: pRes - the user resource to configure.
**
** RETURNS:    Nothing.
...
**             completely.
***********************************************************************************/
void cmProfCustUserAdd ( void *pRes );
#endif
...
#endif /* __CM_PROF__H__INCLUDED__ */
