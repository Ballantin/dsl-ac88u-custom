...
#if CMGRCFG_MULTILINE
   BOS_UINT32 uLine; /* The SIP line from which this signal is coming, if applicable */
#endif /* CMGRCFG_MULTILINE */
   CMGREPSIGACT eAct;
   void *pData;
