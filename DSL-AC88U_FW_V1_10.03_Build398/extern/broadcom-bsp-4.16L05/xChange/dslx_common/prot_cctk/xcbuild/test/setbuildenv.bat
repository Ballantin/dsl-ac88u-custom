...
:: Error check.
::
if "%2" == "reinit" goto oscheck

if not "%CCTK_ENVIRONMENT_INITIALIZED%" == "1" goto oscheck
echo.
...
::
set CCTK_ENVIRONMENT_INITIALIZED=1
