...
**    Description:
**
**      This file contains the Telephony Client Application Manager asynchronous
**      Call Manager Callback thread.
**
***********************************************************************************/

#ifndef __TCAM_ASYNC_CMGR_CB__H__INCLUDED__
#define __TCAM_ASYNC_CMGR_CB__H__INCLUDED__
...
** TCAM asynchronous CMGR callback thread.
*/
typedef struct
{
   BOS_UINT32 uEvt;
...
**
** PURPOSE:    Post an event to the TCAM asynchronous CMGR callback thread.
**
...
#endif /* __TCAM_ASYNC_CMGR_CB__H__INCLUDED__ */
