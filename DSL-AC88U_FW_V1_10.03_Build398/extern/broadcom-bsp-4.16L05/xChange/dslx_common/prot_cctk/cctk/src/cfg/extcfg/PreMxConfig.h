...
**    Description:
**
**      This file contains the pre M5T configuration definitions.
**
***********************************************************************************/
...
/* OS configuration */
   ...
   #define MXD_ARCH_MIPS
   #define MXD_BIG_ENDIAN
#elif defined( MXD_OS_LINUX_LE )
   /* Linux configuration - Little Endian */
   #define MXD_OS_LINUX
   #define MXD_COMPILER_GNU_GCC
   #define MXD_ARCH_ARM
   #define MXD_LITTLE_ENDIAN
#elif defined( MXD_OS_LINUX_BE )
   /* Linux configuration - Big Endian */
   #define MXD_OS_LINUX
   #define MXD_COMPILER_GNU_GCC
   #define MXD_ARCH_ARM
   #define MXD_BIG_ENDIAN
#elif defined( MXD_OS_ANDROID_LE )
   /* Android configuration - Little Endian */
   #define MXD_OS_ANDROID
   #define MXD_COMPILER_GNU_GCC
   #define MXD_ARCH_ARM
   #define MXD_LITTLE_ENDIAN
#elif defined( MXD_OS_ANDROID_BE )
   /* Android configuration - Big Endian */
   #define MXD_OS_ANDROID
   #define MXD_COMPILER_GNU_GCC
   #define MXD_ARCH_ARM
   #define MXD_BIG_ENDIAN
