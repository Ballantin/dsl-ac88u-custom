   ...
   gFsmFnc[gFsmNumberOfStates][gFsmNumberOfEvents] =
{
   /* ---- eCEFSMSTATE_CALLOUT_IDLE -------------------------------------------- */
   {
        ...
        /* ---- eCEEVT_CALL_USR_CREATE ------------ */ &CeFsmCallProxyOut::fsmCreate,
        /* ---- eCEEVT_CALL_USR_MAKE -------------- */ &CeFsmCallProxyOut::fsmMake,
   ...
   /* ---- eCEFSMSTATE_CALLOUT_ATTEMPT ----------------------------------------- */
   {
        ...
        /* ---- eCEEVT_CALL_NET_TERMUSR ----------- */ &CeFsmCall::fsmEnded,
        /* ---- eCEEVT_CALL_NET_TERMNET ----------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_FAILED  ----------- */ &CeFsmCallProxyOut::fsmFailed,
        /* ---- eCEEVT_CALL_NET_ANSWER  ----------- */ &CeFsmCallProxyOut::fsmAnswer,
        /* ---- eCEEVT_CALL_NET_RING -------------- */ &CeFsmCallProxyOut::fsmRing,
        /* ---- eCEEVT_CALL_NET_EARLYMEDIA -------- */ &CeFsmCallProxyOut::fsmEarlyMedia,
        /* ---- eCEEVT_CALL_NET_REPLACE ----------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_MEDIA ------------- */ &CeFsmCall::fsmMedia,
        /* ---- eCEEVT_CALL_NET_MEDIA_FAIL -------- */ &CeFsmCall::fsmEnd,
        /* ---- eCEEVT_CALL_NET_HOLD -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_XFER -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_PEND_OFFER_SDP ---- */ &CeFsmCallProxyOut::fsmPendSdpOfr,
        /* ---- eCEEVT_CALL_NET_PEND_ANSWER_SDP --- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_ANSWER_SDP -------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_INFO -------------- */ &CeFsmBase::fsmNoOp,
   ...
   /* ---- eCEFSMSTATE_CALLOUT_ALERT ------------------------------------------- */
   {
        ...
        /* ---- eCEEVT_CALL_NET_PEND_OFFER_SDP ---- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_PEND_ANSWER_SDP --- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_ANSWER_SDP -------- */ &CeFsmCallProxyOut::fsmSdpAns,
        /* ---- eCEEVT_CALL_NET_INFO -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_CREATE ------------ */ &CeFsmBase::fsmInvalid,
        /* ---- eCEEVT_CALL_USR_MAKE -------------- */ &CeFsmBase::fsmNoOp,
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmRun
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmRun( CeResBase &rRes )
{
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmFailed
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmFailed( CeResBase &rRes )
{
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmAnswer
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmAnswer( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
      ...
      */
      ...
      if ( pSceGenEvt != NULL )
      {
         ...
         if ( ( pNaiSip == NULL ) && ( pNaiTel == NULL ) )
         {
            ...
            ** name field.
            */
            sprintf( reinterpret_cast<char *> ( pCall->clid.cName ),
                     "P" );
            if ( pCdr )
            {
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmRing
**
**  PURPOSE:    Outgoing call is ringing on the remote side (remote user has been
**              alerted).
**
**  PARAMETERS:
**              rRes - reference to the resource this function applies to.
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmRing( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;

   if ( rRes.resourceGender() == CeResBase::eCERESTYPE_CALL )
   {
      CCTKCALLINFO callInfo;
      memset ( reinterpret_cast<void *> ( &callInfo ),
               0,
               sizeof ( CCTKCALLINFO ) );
      ...
      */
         ...
         if ( pPacket )
         {
            ...
            */
            ...
            if ( pAlertInfo )
            {
               ...
               memcpy( static_cast<void *> ( callInfo.cAlertInfo[ 0 ] ),
                       hdrValue.GetFirstIndexPtr(),
                       (( hdrValue.GetSize() > CCTK_STR_LEN ) ?
                                       CCTK_STR_LEN : hdrValue.GetSize()) );
            }
      ...
      pResCall->resourceSetCallInfo( &callInfo );
      tkmEvent( pResCall->resourceParent(),
                pResCall->resourceGuid(),
                eCCTKEVT_ALERTED,
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmEarlyMedia
**
...
**              at this point.
***********************************************************************************/
void CeFsmCallProxyOut::fsmEarlyMedia( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmCreate
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmCreate( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmMake
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyOut::fsmMake( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmPendSdpOfr
**
...
***********************************************************************************/
void CeFsmCallProxyOut::fsmPendSdpOfr( CeResBase &rRes )
{
#if CCTKCFG_REMOTE_USER_CONTROL
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyOut::fsmSdpAns
**
...
**              remote user.
***********************************************************************************/
void CeFsmCallProxyOut::fsmSdpAns( CeResBase &rRes )
{
                  ...
                  if ( pResCall->resourceSdpAnswer() )
                  {
                     ...
                     if ( pMse )
                     {
                        ...
                        */
                        ...
                        /* Similar as if the user picks up the call */
                        ceNotify ( pResProxyCall->resourceGuid(),
                             eCEEVT_CALL_USR_ANSWER,
                             NULL );
                        /* We have processed all according to intended expectations,
                        ** no need to reject this call locally.
