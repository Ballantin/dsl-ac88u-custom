...
**
***********************************************************************************/
#ifndef __CE_FSM_CALL_OUT__H__INCLUDED__
#define __CE_FSM_CALL_OUT__H__INCLUDED__
...
class CeFsmCallOut : virtual public CeFsmBase
{
   public:
      ...
      static void        fsmAlerted( CeResBase &rRes );
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallOut::CeFsmCallOut
**
...
**  NOTES:
***********************************************************************************/
inline CeFsmCallOut::CeFsmCallOut( void ) :
   CeFsmBase( CeFsmBase::eCEFSMTYPE_OUT )
{

}

#endif /* __CE_FSM_CALL_OUT__H__INCLUDED__ */
