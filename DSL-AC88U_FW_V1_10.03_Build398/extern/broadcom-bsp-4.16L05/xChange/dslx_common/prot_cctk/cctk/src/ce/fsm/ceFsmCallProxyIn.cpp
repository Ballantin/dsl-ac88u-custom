   ...
   gFsmFnc[gFsmNumberOfStates][gFsmNumberOfEvents] =
{
   ...
   {
        /* ---- eCEEVT_CALL_NET_CALLED ------------ */ &CeFsmCallProxyIn::fsmCalled,
        /* ---- eCEEVT_CALL_NET_TERMUSR ----------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_TERMNET ----------- */ &CeFsmCallProxyIn::fsmCanceled,
        /* ---- eCEEVT_CALL_NET_FAILED  ----------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_ANSWER  ----------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_RING -------------- */ &CeFsmCallProxyIn::fsmAlert,
        /* ---- eCEEVT_CALL_NET_EARLYMEDIA -------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_NET_REPLACE ----------- */ &CeFsmCallProxyIn::fsmReplace,
        ...
        /* ---- eCEEVT_CALL_USR_MEDIA ------------- */ &CeFsmCallProxyIn::fsmSetup,
        ...
        /* ---- eCEEVT_CALL_USR_ENDED ------------- */ &CeFsmCallProxyIn::fsmReject,
   ...
   /* ---- eCEFSMSTATE_CALLIN_ALERT -------------------------------------------- */
   {
        ...
        /* ---- eCEEVT_CALL_USR_CREATE ------------ */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_MAKE -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_MEDIA ------------- */ &CeFsmBase::fsmNoOp, /* &CeFsmCallProxyIn::fsmSetup, */
        /* ---- eCEEVT_CALL_USR_ANSWER ------------ */ &CeFsmCallProxyIn::fsmAnswer,
        /* ---- eCEEVT_CALL_USR_HOLD -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_UNHOLD ------------ */ &CeFsmCallProxyIn::fsmUnhold,
        /* ---- eCEEVT_CALL_USR_FORWARD ----------- */ &CeFsmCallProxyIn::fsmForward,
        /* ---- eCEEVT_CALL_USR_XFER -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_BXFER ------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_XFER_NOTERM ------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_ENDED ------------- */ &CeFsmCallProxyIn::fsmReject,
        /* ---- eCEEVT_CALL_USR_PROXY ------------- */ &CeFsmCallProxyIn::fsmProxy,
        /* ---- eCEEVT_CALL_USR_DTMF -------------- */ &CeFsmBase::fsmNoOp,
        /* ---- eCEEVT_CALL_USR_FLASH-------------- */ &CeFsmBase::fsmNoOp,
   },
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmRun
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmRun( CeResBase &rRes )
{
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmCalled
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmCalled( CeResBase &rRes )
{
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmAlert
**
...
**              call at all.
***********************************************************************************/
void CeFsmCallProxyIn::fsmAlert( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
            ...
            */
            ...
            if ( pAlertInfo )
            {
               while ( (pAlertInfo != NULL) && (uIx < CCTKCFG_MAX_ALERT_INFO) )
               {
                  ...
                  if ( pCall )
                  {
                     memcpy( static_cast<void *> ( pCall->cAlertInfo[ uIx ] ),
                             hdrValue.GetFirstIndexPtr(),
                                             ...
                                             CCTK_INTEROP_REVALRTNFO ) )
               {
                        ...
                        uJx++ )
                  {
                     memcpy( static_cast<void *> ( cAlertInfo[ uJx ] ),
                             static_cast<const void *> ( pCall->cAlertInfo[ uKx ] ),     
                             strlen ( reinterpret_cast<char *> (
                                                      pCall->cAlertInfo[ uKx ]) ));
                  ...
                  memcpy( static_cast<void *> ( pCall->cAlertInfo ),
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmReplace
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmReplace( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmAnswer
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmAnswer( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
   CeCdr *pCdr = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmUnhold
**
...
***********************************************************************************/
void CeFsmCallProxyIn::fsmUnhold( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmForward
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmForward( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmReject
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmReject( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
   CeCdr *pCdr = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmCanceled
**
...
**  NOTES:
***********************************************************************************/
void CeFsmCallProxyIn::fsmCanceled( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
   MXD_GNS::MseSdpSession *pMse = NULL;
   CeCdr *pCdr = NULL;
...
**  NOTES:      .
***********************************************************************************/
void CeFsmCallProxyIn::fsmSetup( CeResBase &rRes )
{
   CeResCall *pResCall = NULL;
   MXD_GNS::MseSdpSession *pMse = NULL;
...
/***********************************************************************************
**  FUNCTION:   CeFsmCallProxyIn::fsmProxy
**
...
***********************************************************************************/
void CeFsmCallProxyIn::fsmProxy( CeResBase &rRes )
{
#if CCTKCFG_REMOTE_USER_CONTROL
   CeResCall *pResCall = NULL;
      ...
      */
                              ...
                              pProxyCall ) )
      {
         if ( pProxyCall->resourceGender() == CeResBase::eCERESTYPE_CALL )
         {
            ...
            /* Since this is an outgoing call from remote user, association is
            ** done now.  So the call will end, when the proxy call ends.
            */
            pResCall->resourceProxyGuid( 
                  pResProxyCall->resourceGuid() );
         }
         else
         {
            fsmError( rRes );
