...
**    Description:
**
**      This file defines the BRCM custom transport service.
**
***********************************************************************************/
#ifndef __CBRCM_TRANSPORT_SVC__H__INCLUDED__
#define __CBRCM_TRANSPORT_SVC__H__INCLUDED__
...
//
// Description:
//   This class defines a BRCM custom transport service which is to be inserted
//   to the network end of the stack's transport service chain.
//
//==EDOC========================================================================
class CBrcmTransportSvc : public CSipTransportSvc,
...
public:
    ...
    // Summary:
    //  Initializes the custom transport service as a SipTransport service chain link.
    //---------------------------------------------------------------------------------
...
private:
    ...
    //  Copy Constructor.
    //--------------------
    CBrcmTransportSvc(IN const CBrcmTransportSvc& rSrc);

    // Summary:
    //  Assignment Operator.
    //-----------------------
    CBrcmTransportSvc& operator=(IN const CBrcmTransportSvc& rSrc);
...
inline
mxt_result CBrcmTransportSvc::Initialize(IN CSipTransportSvc* pNextSender,
                                         IN CSipTransportSvc* pNextReceiver)
{
...
#endif //-- #ifndef __CBRCM_TRANSPORT_SVC__H__INCLUDED__
