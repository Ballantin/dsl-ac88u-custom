...
#ifndef MXG_CSECURESEEDMITOSFW_H
#define MXG_CSECURESEEDMITOSFW_H
...
//==============================================================================
    ...
    #define MXD_CRYPTO_SECURESEED_CLASSNAME CSecureSeedMitosFw
#endif
...
private:
    ...
    static mxt_result InitializeCSecureSeedMitosFw();
    static void FinalizeCSecureSeedMitosFw();

// Friends declarations
//----------------------
    friend mxt_result InitializeCSecureSeedMitosFw();
    friend void FinalizeCSecureSeedMitosFw();
...
protected:
    ...
    //  Destructor.
    //----------------------
    virtual ~CSecureSeedMitosFw();

private:

#if defined(MXD_OS_WINDOWS) || defined(MXD_OS_WINDOWS_CE)
    static mxt_result ReadTimer(IN CSha1& rSha1);
#endif
...
#endif // #if !defined(MXD_CRYPTO_SHA1_NONE) && defined(MXD_CRYPTO_SECURESEED_MITOSFW)

#endif //-- #ifndef MXG_CSECURESEEDMITOSFW_H
