...
//==============================================================================
//==============================================================================
#ifndef MXG_IUAIMPPPRESENCEPUBLISHERMGR_H
//M5T_INTERNAL_USE_BEGIN
#define MXG_IUAIMPPPRESENCEPUBLISHERMGR_H
...
#include "SceCoreComponents/ISceSubscriberMgr.h" // ISceSubscriberMgr::ESubscriptionStatus
#endif
...
//
// Location:
//   SceUaImpp/IUaImppPresencePublisherMgr.h
//
// See Also:
...
public:
    ...
    //
    //==========================================================================
    virtual void EvPublicationStatus(IN IUaImppPresencePublisher* pPublisher,
...
protected:
    ...
    // Summary:
    //  Default Constructor.
    IUaImppPresencePublisherMgr(){}

    // Summary:
    //  Destructor.
    virtual ~IUaImppPresencePublisherMgr(){}
...
private:
    ...
    // Summary:
    //  Copy Constructor.
    IUaImppPresencePublisherMgr(IN const IUaImppPresencePublisherMgr& rSrc);

    // Summary:
    //  Assignment Operator.
    IUaImppPresencePublisherMgr& operator=(IN const IUaImppPresencePublisherMgr& rSrc);
...
#endif //-- #ifndef MXG_IUAIMPPPRESENCEPUBLISHERMGR_H
