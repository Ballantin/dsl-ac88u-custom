...
//==============================================================================
//==============================================================================
#ifndef MXG_CSCECOREINITIALIZER_H
//M5T_INTERNAL_USE_BEGIN
#define MXG_CSCECOREINITIALIZER_H
...
//   SceCore package. CSceCoreInitializer::Initialize must be called
//   before any of the functionalities from SceCore are used.
//   CSceCoreInitializer::Finalize must be called when the functionalities
//   from SceCore are not needed anymore.
//
...
private:
    ...
    //  Destructor.
    //--------------
    virtual ~CSceCoreInitializer();

    // Summary:
    //  Copy Constructor.
    //--------------------
    CSceCoreInitializer(IN const CSceCoreInitializer& rSrc);

    // Summary:
    //  Assignment Operator.
    //-----------------------
    CSceCoreInitializer& operator=(IN const CSceCoreInitializer& rSrc);
...
#endif //-- #ifndef MXG_CSCECOREINITIALIZER_H
