...
//==============================================================================
//==============================================================================
#ifndef MXG_CSCEUAIMPPINITIALIZER_H
//M5T_INTERNAL_USE_BEGIN
#define MXG_CSCEUAIMPPINITIALIZER_H
...
//==============================================================================
//== Class: CSceUaImppInitializer
//========================================
//<GROUP TID_PACKAGE_STARTUP_CLASSES>
//
// Summary:
//   This class offers APIs for initializing and finalizing the UaImpp package.
//
// Description:
//   This class contains the methods needed to initialize and finalize the
//   optional UA-IMPP package. CSceUaImppInitializer::Initialize must be called
//   before any of the functionalities from UaImpp are used, as this is where
//   the allocation of static data is performed for the whole UA-IMPP package.
//   CSceUaImppInitializer::Finalize must be called when the functionalities from
//   UaImpp are not needed anymore, which releases the allocated memory for
//   static data.
//
...
//
// Location:
//   Startup/CSceUaImppInitializer.h
//
//==============================================================================
class CSceUaImppInitializer
{
...
public:
    ...
    // Summary:
    //  Initializes the Ua Impp and its dependencies.
    //-----------------------------------------------
    static mxt_result Initialize();

    // Summary:
    //  Finalizes the Ua Impp and its dependencies.
    //---------------------------------------------
...
private:
    ...
    //  Destructor.
    //--------------
    virtual ~CSceUaImppInitializer();

    // Summary:
    //  Copy Constructor.
    //--------------------
    CSceUaImppInitializer(IN const CSceUaImppInitializer& rSrc);

    // Summary:
    //  Assignment Operator.
    //-----------------------
    CSceUaImppInitializer& operator=(IN const CSceUaImppInitializer& rSrc);
...
#endif //-- #ifndef MXG_CSCEUAIMPPINITIALIZER_H
