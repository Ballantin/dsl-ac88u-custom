...
//==============================================================================
//==============================================================================
#ifndef MXG_CSCEUASSPINITIALIZER_H
//M5T_INTERNAL_USE_BEGIN
#define MXG_CSCEUASSPINITIALIZER_H
...
//==============================================================================
//== Class: CSceUaSspInitializer
//========================================
//<GROUP TID_PACKAGE_STARTUP_CLASSES>
//
// Summary:
//   This class offers APIs for initializing and finalizing the UA-SSP package.
//
// Description:
//   This class contains the methods needed to initialize and finalize the UA-SSP
//   package. CSceUaSspInitializer::Initialize must be called before any of the
//   functionalities from UA-SSP are used, as this is where the allocation of
//   static data is performed for the whole UA-SSP.
//   CSceUaSspInitializer::Finalize must be called when the functionalities from
//   UA-SSP are no longer needed, which releases the allocated memory for
//   static data.
//
...
//
// Location:
//   Startup/CSceUaSspInitializer.h
//
//==============================================================================
class CSceUaSspInitializer
{
...
public:
    ...
    // Summary:
    //  Initializes the UA-SSP and its dependencies.
    //-----------------------------------------------
    static mxt_result Initialize();

    // Summary:
    //  Finalizes the UA-SSP and its dependencies.
    //---------------------------------------------
...
private:
    ...
    //  Default Constructor.
    //-----------------------
    CSceUaSspInitializer();

    // Summary:
    //  Destructor.
    //--------------
    virtual ~CSceUaSspInitializer();

    // Summary:
    //  Copy Constructor.
    //--------------------
    CSceUaSspInitializer(IN const CSceUaSspInitializer& rSrc);

    // Summary:
    //  Assignment Operator.
    //-----------------------
    CSceUaSspInitializer& operator=(IN const CSceUaSspInitializer& rSrc);
...
#endif //-- #ifndef MXG_CSCEUASSPINITIALIZER_H
