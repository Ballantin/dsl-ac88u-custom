...
**
** Date   : 2006-08-28
** Problem Description: The type of the variable "result" was not corresponding
**                      to the returning type of this function.
**
** Modification Description: Change the variable "return" type from XML_Error
**                           to XML_Status.
**
*******************************************************************************/
