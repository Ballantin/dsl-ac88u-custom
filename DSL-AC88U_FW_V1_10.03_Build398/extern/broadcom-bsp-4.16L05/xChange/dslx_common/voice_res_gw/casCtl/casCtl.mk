###########################################################################
#
# This makefile is used to build the CAS control module.
#
###########################################################################
...
#
XCHG_LIB_BASE  := casCtl

CAS_CTL_ROOT    := $(VRG_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(CAS_CTL_ROOT)/src/*.c $(CAS_CTL_ROOT)/src/profiles/*.c))
...
#
vpath %.c $(CAS_CTL_ROOT)/src $(CAS_CTL_ROOT)/src/profiles
...
# These must be absolute paths in order to support non-recursive makefiles.
#
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(CAS_CTL_ROOT)/src $(CAS_CTL_ROOT)/src/profiles
