...
#ifndef BOARD_HAL_DECT_H
#define BOARD_HAL_DECT_H
...
**
** PURPOSE:    Shutdown the DECT module
**
** PARAMETERS: none
**
** RETURNS:    0 on success, else 1
...
**
** PURPOSE:    Find out if a particular channel is a DECT channel
**
** PARAMETERS: chan - the line number ( 0 referenced )
**
...
*****************************************************************************
*/
void boardHalDectIStartDectBuffProcessing( XDRV_UINT32 ddrAddrTxV, XDRV_UINT32 ddrAddRxV );
