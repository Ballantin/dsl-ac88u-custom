...
*
 ***************************************************************************
 * File Name  : boardHalSpiClk.h
 *
 *    Description: Contains the interface for configuring the SPI clock
 *
 ***************************************************************************/
...
**
** PURPOSE:    Makes any necessary configurations to the SPI clock signal
**             (e.g. inverting clock polarity)
**
** PARAMETERS: none
**
** RETURNS:    none
