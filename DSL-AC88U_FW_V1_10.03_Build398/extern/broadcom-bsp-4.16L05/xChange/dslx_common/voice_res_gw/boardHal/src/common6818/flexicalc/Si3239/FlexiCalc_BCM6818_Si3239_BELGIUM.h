...
#ifndef FLEXICALC_BELGIUM_3239_H
#define FLEXICALC_BELGIUM_3239_H
...
#define flexicalcBELGIUMArchive3239 ((const APM6818_FLEXICALC_CFG*) NULL)
#else
const APM6818_FLEXICALC_CFG flexicalcBELGIUMArchive3239[] =
{
{
   ...
   */
   ...
   0x0004,               /* cic_int_shft */
   0x0004,               /* cic_dec_shft */
   0x4D2C,           /* asrc_int_scale */
   0x0B1E,           /* asrc_dec_scale */
   2,               /* vtx_pg */
   0,                /* vrx_pg */
   0,               /* hpf_en */
   4,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_BELGIUM_3239_H */
