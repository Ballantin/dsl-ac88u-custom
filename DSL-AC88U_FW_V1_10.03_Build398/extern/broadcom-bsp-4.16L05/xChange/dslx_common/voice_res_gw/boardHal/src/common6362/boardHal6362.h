...
#ifndef BOARD_HAL_6362_H
#define BOARD_HAL_6362_H
...
/*
** 6362vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_6362VCM_HW_DEBOUNCE_MS 0    /* no h/w debouncing */
#define BOARD_HAL_6362VCM_SW_DEBOUNCE_MS 15   /* use only s/w debouncing */
...
*/
#define BOARDCFG6362_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG6362_MODULE_DIAG6362   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG6362_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG6362_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG6362_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG6362_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG6362_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
#else 
extern DLB_6362_DRV              gHalDlbDrv;
#endif 
...
*****************************************************************************
*/
int boardHalInit6362( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit6362
**
...
void boardHalShutdown6362( void *context );
