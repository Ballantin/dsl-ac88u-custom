...
#define flexicalcUNITED_ARAB_EMIRATESArchive9530 ((const APM6828_FLEXICALC_CFG*) NULL)
#else
const APM6828_FLEXICALC_CFG flexicalcUNITED_ARAB_EMIRATESArchive9530[] =
{
{
