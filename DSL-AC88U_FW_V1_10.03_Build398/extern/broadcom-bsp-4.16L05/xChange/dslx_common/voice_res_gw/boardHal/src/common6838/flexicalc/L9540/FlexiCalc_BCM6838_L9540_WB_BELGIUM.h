...
#ifndef FLEXICALC_WB_BELGIUM_9540_H
#define FLEXICALC_WB_BELGIUM_9540_H
...
#define flexicalcWBBELGIUMArchive9540 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcWBBELGIUMArchive9540[] =
{
{
   ...
   */
   ...
   0x0003,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x44C1,           /* asrc_int_scale */
   0x1D91,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   0,                /* vrx_pg */
   0,                /* hpf_en */
   0,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_WB_BELGIUM_9540_H */
