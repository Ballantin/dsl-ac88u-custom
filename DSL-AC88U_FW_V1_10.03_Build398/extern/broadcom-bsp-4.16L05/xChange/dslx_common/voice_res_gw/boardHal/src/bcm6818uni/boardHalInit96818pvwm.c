...
*****************************************************************************
*
*    Filename: boardHalInit96818pvwm.c
*
****************************************************************************
*    Description:
*
...
int boardHalInit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg )
{
   ...
   */
   boardCfgModules = BOARDCFG6818_MODULE_TPD        |
                     BOARDCFG6818_MODULE_HVGRING    |
                     BOARDCFG6818_MODULE_FASTSLIC   |
                     BOARDCFG6818_MODULE_MSPI;  /* Added for le88276, si3226 */
   ...
   */
   ...
   status = boardHalInitUni( boardHalInitCfg, 
                             boardCfgModules 
#ifdef BRCM_NONDIST_BUILD
                           , PCM6818_DMA_MAX_BUFFER_SIZE
                           , VRG_BOARDHAL_BCM96818
...
int boardHalDeinit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg  )
{
   ...
   */
   ...
   /*
   ** Use common 6818 initialization sequence
   */
