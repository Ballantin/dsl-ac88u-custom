...
#define flexicalcHUNGARYArchive32392 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcHUNGARYArchive32392[] =
{
{
   ...
   */
   ...
   0x0003,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x4111,           /* asrc_int_scale */
   0x1010,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   1,                /* vrx_pg */
   0,                /* hpf_en */
   3,                /* hybal_smpl_offset */
