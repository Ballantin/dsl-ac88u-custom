...
#ifndef FLEXICALC_MEXICO_3239_H
#define FLEXICALC_MEXICO_3239_H
...
#define flexicalcMEXICOArchive3239 ((const APM6828_FLEXICALC_CFG*) NULL)
#else
const APM6828_FLEXICALC_CFG flexicalcMEXICOArchive3239[] =
{
{
   ...
   */
   ...
   0x0004,               /* cic_int_shft */
   0x0004,               /* cic_dec_shft */
   0x6162,           /* asrc_int_scale */
   0x0FB4,           /* asrc_dec_scale */
   2,               /* vtx_pg */
   1,               /* vrx_pg */
   0,               /* hpf_en */
   3,                /* hybal_smpl_offset */
