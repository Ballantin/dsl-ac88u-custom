...
#ifndef FLEXICALC_WB_UNITED_ARAB_EMIRATES_32392_H
#define FLEXICALC_WB_UNITED_ARAB_EMIRATES_32392_H
...
#define flexicalcWBUNITED_ARAB_EMIRATESArchive32392 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcWBUNITED_ARAB_EMIRATESArchive32392[] =
{
{
   ...
   */
   ...
   0x0003,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x6720,           /* asrc_int_scale */
   0x16BE,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   1,                /* vrx_pg */
   0,                /* hpf_en */
   3,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_WB_UNITED_ARAB_EMIRATES_32392_H */
