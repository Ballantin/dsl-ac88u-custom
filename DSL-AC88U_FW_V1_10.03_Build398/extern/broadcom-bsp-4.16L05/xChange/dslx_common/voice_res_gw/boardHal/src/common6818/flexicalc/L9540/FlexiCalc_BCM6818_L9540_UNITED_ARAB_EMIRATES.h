...
#ifndef FLEXICALC_BCM6818_L9540_UAE_H
#define FLEXICALC_BCM6818_L9540_UAE_H
...
#if !VRG_COUNTRY_CFG_UAE
#define flexicalcUNITED_ARAB_EMIRATESArchive9540 ((const APM6818_FLEXICALC_CFG*) NULL)
#else
const APM6818_FLEXICALC_CFG flexicalcUNITED_ARAB_EMIRATESArchive9540[] =
{
{
   0x9540,           /* Slic type:  */
   57,               /* Ring Voltage (RMS) */
   ...
   */
   ...
   4,                  /* hybal_shft */
   {0x50E2, 0xBF70, 0x12BF, 0x26C7, 0xE3F8},    /* hybal_audio_fir[5] */
   ...
   0x0004,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x6467,           /* asrc_int_scale */
   0x0B66,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   1,                /* vrx_pg */
   0,                /* hpf_en */
   4,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_BCM6818_L9540_UAE_H */
