...
*****************************************************************************
*
*    Filename: boardHal6368.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 6368 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_6368_H
#define BOARD_HAL_6368_H
...
/*
** 6368vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_6368VCM_HW_DEBOUNCE_MS 0    /* no h/w debouncing */
#define BOARD_HAL_6368VCM_SW_DEBOUNCE_MS 15   /* use only s/w debouncing */
...
*/
#define BOARDCFG6368_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG6368_MODULE_DIAG6368   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG6368_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG6368_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG6368_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG6368_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG6368_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
*****************************************************************************
*/
int boardHalInit6368( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit6368
**
...
void boardHalShutdown6368( void *context );
