...
*****************************************************************************
*
*    Filename: boardHal63381.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 63381 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_63381_H
#define BOARD_HAL_63381_H
...
/*
** 63381vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_63381VCM_HW_DEBOUNCE_MS 0    /* no h/w debouncing */
#define BOARD_HAL_63381VCM_SW_DEBOUNCE_MS 15   /* use only s/w debouncing */
...
*/
#define BOARDCFG63381_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG63381_MODULE_DIAG63381   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG63381_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG63381_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG63381_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG63381_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG63381_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
#else 
extern DLB_63381_DRV              gHalDlbDrv;
#endif 
...
*****************************************************************************
*/
int boardHalInit63381( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit63381
**
...
void boardHalShutdown63381( void *context );
