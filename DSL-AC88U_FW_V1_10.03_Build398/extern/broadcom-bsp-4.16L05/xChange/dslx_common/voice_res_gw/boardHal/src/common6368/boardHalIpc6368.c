...
int boardHalIpcReady( int notUsed )
{
   ...
   */
   ...
   sharedMemDescr.dmaBufferSize        = PCM6368_DMA_MAX_BUFFER_SIZE;
   sharedMemDescr.bcmChip              = BCM96368;
