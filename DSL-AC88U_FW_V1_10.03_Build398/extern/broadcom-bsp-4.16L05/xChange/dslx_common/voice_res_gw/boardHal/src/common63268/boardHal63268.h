...
*****************************************************************************
*
*    Filename: boardHal63268.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 63268 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_63268_H
#define BOARD_HAL_63268_H
...
/*
** 63268vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_63268VCM_HW_DEBOUNCE_MS 0    /* no h/w debouncing */
#define BOARD_HAL_63268VCM_SW_DEBOUNCE_MS 15   /* use only s/w debouncing */
...
*/
#define BOARDCFG63268_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG63268_MODULE_DIAG63268   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG63268_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG63268_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG63268_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG63268_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG63268_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
#else 
extern DLB_63268_DRV              gHalDlbDrv;
#endif 
...
*****************************************************************************
*/
int boardHalInit63268( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit63268
**
...
void boardHalShutdown63268( void *context );
