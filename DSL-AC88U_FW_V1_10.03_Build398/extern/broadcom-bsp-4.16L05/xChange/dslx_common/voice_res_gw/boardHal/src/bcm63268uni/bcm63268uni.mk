###########################################################################
#
# This makefile is used to build the bcm963268 module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm63268uni

BCM63268VCM_ROOT  := $(VRG_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63268VCM_ROOT)/*.c \
                                                       $(BCM63268VCM_ROOT)/../common/*.c))


# Source files used for both IKOS simulations and the real chip.
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalDsp63268.c     \
                                   boardHalIpc63268.c     \
                                   boardHalPower63268.c   \
                                   boardHalRelay63268.c   \
                                   boardHalGpio63268.c

ifeq ($(strip $(BRCM_NONDIST_BUILD)),1)
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(filter-out boardHalIpc63268.c,$(XCHG_SRC_FILES_$(XCHG_LIB_BASE)))
...
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalNtr63268.c
endif
...
#
vpath %.c $(BCM63268VCM_ROOT) $(BCM63268VCM_ROOT)/../common $(BCM63268VCM_ROOT)/../common63268 $(BCM63268VCM_ROOT)/../sim
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_LDX_DSP_APP_DIR) \
                                         $(BCM63268VCM_ROOT)/../common63268 \
                                         $(BCM63268VCM_ROOT)/../common \
                                         $(BCM63268VCM_ROOT) \
                                         $(VRG_LDX_DSP_APP_DIR) \
