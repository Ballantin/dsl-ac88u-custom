...
*/
#define DSP_TO_HOST_SIZE_WORDS   2048
#define HOST_TO_DSP_SIZE_WORDS   2048
...
int boardHalIpcReady( int notUsed )
{
   ...
   */
   ...
   sharedMemDescr.dmaBufferSize        = PCM63381_DMA_MAX_BUFFER_SIZE;
   sharedMemDescr.bcmChip              = BCM963381;
   sharedMemDescr.apmModeEnabled       = XDRV_FALSE;
