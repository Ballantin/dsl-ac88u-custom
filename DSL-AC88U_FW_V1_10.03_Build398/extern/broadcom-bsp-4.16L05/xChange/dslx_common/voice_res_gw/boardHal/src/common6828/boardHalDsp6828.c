...
/* Contains "DSP" thread processor binary image array, plus image capability
...
int boardHalDspInit( void )
{
   ...
   */
   status = boot6828LoadImage( NULL, (unsigned int *) NULL);
#endif /* BRCM_NONDIST_BUILD */
...
/*
*****************************************************************************
** FUNCTION:   boardHalGetDspArchive
**
...
*****************************************************************************
*/
const DSP_IMAGE_ARCHIVE* boardHalGetDspArchive( int dspNum )
{
   (void) dspNum;

   return ( dspImageArchiveGet() );
}
