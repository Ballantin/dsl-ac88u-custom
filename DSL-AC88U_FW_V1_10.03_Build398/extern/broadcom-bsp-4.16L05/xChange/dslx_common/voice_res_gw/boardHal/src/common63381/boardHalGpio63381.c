...
/*****************************************************************************
*
* FUNCTION:   boardHalGpioGetPinMuxSel
*
* PURPOSE:    gets the pinmuxsel value for GPIOs ( Not 1:1 in 63381 )
*
...
{
   if( gpioNum < BP_GPIO_45_AH )
   {
      return( gpioNum + 43 );      
   }
   else if ( ( BP_GPIO_45_AH <= gpioNum ) && ( gpioNum < BP_GPIO_50_AH ) )
   {
      return( gpioNum + 43 + 2 );      
   }
   else
