...
#ifndef FLEXICALC_INDIA_9540_H
#define FLEXICALC_INDIA_9540_H
...
#define flexicalcINDIAArchive9540 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcINDIAArchive9540[] =
{
{
