...
#ifndef FLEXI_CALC_6828VCM_H
#define FLEXI_CALC_6828VCM_H
...
const void* flexiCalcGetCfg6828Slic( VRG_COUNTRY country );

#ifdef __cplusplus
}
#endif

#endif  /* FLEXI_CALC_6828VCM_H */
