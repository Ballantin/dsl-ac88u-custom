...
*****************************************************************************
*
*    Filename: boardHal6816.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 6816 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_6816_H
#define BOARD_HAL_6816_H
...
#define BOARD_HAL_6816_NUM_ENDPTS   2

#define BOARD_HAL_NUM_SLIC_MAX      2

/*
** 6816pvwm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_6816PVWM_HW_DEBOUNCE_MS 0    /* h/w debouncing */
#define BOARD_HAL_6816PVWM_SW_DEBOUNCE_MS 0   /* s/w debouncing */
...
*/
#define BOARDCFG6816_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG6816_MODULE_DIAG6816   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG6816_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG6816_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG6816_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG6816_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG6816_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
/*
*****************************************************************************
** FUNCTION:   boardHalInit6816
**
** PURPOSE:    Initialize the HAL.
**
** PARAMETERS: boardHalInitCfg - current boardHal init config
**             initModules     - 6816 board modules to initialize
**
** RETURNS:    0 on success, otherwise error code.
**
*****************************************************************************
*/
int boardHalInit6816( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit6816
**
** PURPOSE:    Uninitialize the HAL. Reset any local storage and
**             free all resources.
**
** PARAMETERS: deinitModules - 6816 board modules to deinitialize
**
** RETURNS:    0 on success, otherwise error code.
...
*****************************************************************************
*/
int boardHalDeinit6816( int deinitModules );


#ifdef DYING_GASP_API
void boardHalShutdown6816( void *context );
#endif 
