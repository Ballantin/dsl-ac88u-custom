...
#ifndef FLEXICALC_SLOVAKIA_32392_H
#define FLEXICALC_SLOVAKIA_32392_H
...
#define flexicalcSLOVAKIAArchive32392 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcSLOVAKIAArchive32392[] =
{
{
   ...
   */
   ...
   0x0003,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x56E0,           /* asrc_int_scale */
   0x0C0F,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   1,                /* vrx_pg */
   0,                /* hpf_en */
   6,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_SLOVAKIA_32392_H */
