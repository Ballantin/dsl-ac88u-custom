###########################################################################
#
# This makefile is used to build the bcm96848 module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6848uni

BCM6848VCM_ROOT  := $(VRG_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6848VCM_ROOT)/*.c \
                                                       $(BCM6848VCM_ROOT)/../common/*.c))


# Source files used for both IKOS simulations and the real chip.
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalDsp6848.c     \
                                   boardHalIpc6848.c     \
                                   boardHalPower6848.c   \
                                   boardHalRelay6848.c   \
                                   boardHalGpio6848.c
...
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(filter-out boardHalIpc6848.c,$(XCHG_SRC_FILES_$(XCHG_LIB_BASE)))
...
#
vpath %.c $(BCM6848VCM_ROOT) $(BCM6848VCM_ROOT)/../common $(BCM6848VCM_ROOT)/../common6848 $(BCM6848VCM_ROOT)/../sim
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_LDX_DSP_APP_DIR) \
                                         $(BCM6848VCM_ROOT)/../common6848 \
                                         $(BCM6848VCM_ROOT)/../common \
                                         $(BCM6848VCM_ROOT) \
                                         $(VRG_LDX_DSP_APP_DIR) \
