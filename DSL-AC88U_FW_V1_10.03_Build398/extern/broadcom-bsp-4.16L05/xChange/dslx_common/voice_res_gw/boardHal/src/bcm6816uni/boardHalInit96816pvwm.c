...
*****************************************************************************
*
*    Filename: boardHalInit96816pvwm.c
*
****************************************************************************
*    Description:
*
...
int boardHalInit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg )
{
   ...
   */
   boardCfgModules = BOARDCFG6816_MODULE_TPD        |
                     BOARDCFG6816_MODULE_HVGRING    |
                     BOARDCFG6816_MODULE_FASTSLIC   |
                     BOARDCFG6816_MODULE_MSPI;  /* Added for le88276, si3226 */
   ...
   */
   ...
   status = boardHalInitUni( boardHalInitCfg, 
                             boardCfgModules 
#ifdef BRCM_NONDIST_BUILD
                           , PCM6816_DMA_MAX_BUFFER_SIZE
                           , VRG_BOARDHAL_BCM96816
...
int boardHalDeinit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg )
{
   ...
   */
   ...
   /*
   ** Use common 6816 initialization sequence
   */
