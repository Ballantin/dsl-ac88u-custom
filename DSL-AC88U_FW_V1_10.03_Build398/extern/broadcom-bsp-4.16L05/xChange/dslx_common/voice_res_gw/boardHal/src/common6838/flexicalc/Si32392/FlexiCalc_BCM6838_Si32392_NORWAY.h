...
#define flexicalcNORWAYArchive32392 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcNORWAYArchive32392[] =
{
{
   ...
   */
   ...
   7,                  /* hybal_shft */
   {0x9A3E, 0x7CE4, 0xB642, 0x7CE5, 0x9D37},    /* hybal_audio_fir[5] */
   ...
   0x0003,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x7127,           /* asrc_int_scale */
   0x0FB5,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   0,                /* vrx_pg */
   0,                /* hpf_en */
   6,                /* hybal_smpl_offset */
