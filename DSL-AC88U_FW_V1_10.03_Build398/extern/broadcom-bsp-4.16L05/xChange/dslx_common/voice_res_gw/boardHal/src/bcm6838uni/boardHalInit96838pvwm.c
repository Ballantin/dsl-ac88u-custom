...
*****************************************************************************
*
*    Filename: boardHalInit96838pvwm.c
*
****************************************************************************
*    Description:
*
...
int boardHalInit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg )
{
   ...
   */
   boardCfgModules = BOARDCFG6838_MODULE_HVGRING    |   
                     BOARDCFG6838_MODULE_TPD        |                     
                     BOARDCFG6838_MODULE_FASTSLIC   |
                     BOARDCFG6838_MODULE_MSPI;  /* Added for le88276, si3226 */
   ...
   */
   ...
   status = boardHalInitUni( boardHalInitCfg, 
                             boardCfgModules 
#ifdef BRCM_NONDIST_BUILD
                           , PCM6838_DMA_MAX_BUFFER_SIZE
                           , VRG_BOARDHAL_BCM96838
...
int boardHalDeinit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg  )
{
   ...
   */
   boardCfgModules = BOARDCFG6838_MODULE_TPD        |
                     BOARDCFG6838_MODULE_HVGRING; 

   /*
   ** Use common 6838 initialization sequence
   */
