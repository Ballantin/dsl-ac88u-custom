###########################################################################
#
# This makefile is used to build the bcm63138uni module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm63138uni

BCM63138_ROOT     := $(VRG_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63138_ROOT)/*.c \
                                                       $(BCM63138_ROOT)/../common/*.c))


# Source files used for both IKOS simulations and the real chip.
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalDsp63138.c     \
                                   boardHalPower63138.c   \
                                   boardHalRelay63138.c   \
                                   boardHalGpio63138.c
...
#
vpath %.c $(BCM63138_ROOT) $(BCM63138_ROOT)/../common $(BCM63138_ROOT)/../common63138 $(BCM63138_ROOT)/../sim
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_LDX_DSP_APP_DIR) \
                                         $(BCM63138_ROOT)/../common63138 \
                                         $(BCM63138_ROOT)/../common \
                                         $(BCM63138_ROOT) \
