###########################################################################
#
# This makefile is used to build the bcm93368vcm module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6328uni

BCM6328VCM_ROOT  := $(VRG_DIR_$(XCHG_LIB_BASE))

#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6328VCM_ROOT)/*.c \
                                                       $(BCM6328VCM_ROOT)/../common/*.c))


# Source files used for both IKOS simulations and the real chip.
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalDsp6328.c     \
                                   boardHalIpc6328.c     \
                                   boardHalPower6328.c   \
                                   boardHalRelay6328.c   \
                                   boardHalGpio6328.c    \
                                   boardHalSpiClk6328.c

ifeq ($(strip $(BRCM_NONDIST_BUILD)),1)
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(filter-out boardHalIpc6328.c,$(XCHG_SRC_FILES_$(XCHG_LIB_BASE)))
...
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalNtr6328.c
endif
...
#
vpath %.c $(BCM6328VCM_ROOT) $(BCM6328VCM_ROOT)/../common $(BCM6328VCM_ROOT)/../common6328 $(BCM6328VCM_ROOT)/../sim
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_LDX_DSP_APP_DIR) \
                                         $(BCM6328VCM_ROOT)/../common6328 \
                                         $(BCM6328VCM_ROOT)/../common \
                                         $(BCM6328VCM_ROOT) \
                                         $(VRG_LDX_DSP_APP_DIR) \
