...
#
XCHG_LIB_BASE     := bcm6368uni

BCM6368VCM_ROOT  := $(VRG_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6368VCM_ROOT)/*.c \
                                                       $(BCM6368VCM_ROOT)/../common/*.c))


# Source files used for both IKOS simulations and the real chip.
XCHG_SRC_FILES_$(XCHG_LIB_BASE) += boardHalDsp6368.c     \
                                   boardHalIpc6368.c     \
                                   boardHalPower6368.c   \
                                   boardHalRelay6368.c   \
                                   boardHalGpio6368.c
...
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(filter-out boardHalIpc6368.c,$(XCHG_SRC_FILES_$(XCHG_LIB_BASE)))
...
#
vpath %.c $(BCM6368VCM_ROOT) $(BCM6368VCM_ROOT)/../common $(BCM6368VCM_ROOT)/../common6368 $(BCM6368VCM_ROOT)/../sim
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_LDX_DSP_APP_DIR) \
                                         $(BCM6368VCM_ROOT)/../common6368 \
                                         $(BCM6368VCM_ROOT)/../common \
                                         $(BCM6368VCM_ROOT) \
                                         $(VRG_LDX_DSP_APP_DIR) \
