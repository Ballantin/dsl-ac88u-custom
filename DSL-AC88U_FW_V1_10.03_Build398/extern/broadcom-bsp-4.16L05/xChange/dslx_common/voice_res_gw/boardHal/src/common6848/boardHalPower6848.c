...
****************************************************************************
*
*    Filename: boardHalPower6848.c
*
****************************************************************************
*    Description:
*
*     Implements power savings features that are specific to 6848-based
*     reference design.
*
****************************************************************************/
...
void boardHalPowerSavingsEnable( void )
{
   ...
   */
   ...
   VRG_LOG_DBG((VRG_LOG_MOD_BOARDHAL, "6848 Board Hal: power savings Enabled!"));
...
void boardHalPowerSavingsDisable( void )
{
   ...
   */
   ...
   VRG_LOG_DBG((VRG_LOG_MOD_BOARDHAL, "6848 Board Hal: power savings Disabled!"));
