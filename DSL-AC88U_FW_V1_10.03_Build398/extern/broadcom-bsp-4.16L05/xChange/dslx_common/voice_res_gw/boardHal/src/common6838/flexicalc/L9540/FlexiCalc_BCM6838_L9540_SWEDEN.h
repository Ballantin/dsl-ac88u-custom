...
#ifndef FLEXICALC_SWEDEN_9540_H
#define FLEXICALC_SWEDEN_9540_H
...
#define flexicalcSWEDENArchive9540 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcSWEDENArchive9540[] =
{
{
