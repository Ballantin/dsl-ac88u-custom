...
*****************************************************************************
*
*    Filename: boardHal6328.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 6328 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_6328_H
#define BOARD_HAL_6328_H
...
/*
** 6328vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_6328VCM_HW_DEBOUNCE_MS 0    /* no h/w debouncing */
#define BOARD_HAL_6328VCM_SW_DEBOUNCE_MS 15   /* use only s/w debouncing */
...
*/
#define BOARDCFG6328_MODULE_GPIO       (1<<0)    /* GPIO */
#define BOARDCFG6328_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG6328_MODULE_DIAG6328   (1<<2)    /* 6816 diagnostics */
#define BOARDCFG6328_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG6328_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG6328_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG6328_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG6328_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
#else 
extern DLB_6328_DRV              gHalDlbDrv;
#endif 
...
*****************************************************************************
*/
int boardHalInit6328( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit6328
**
...
void boardHalShutdown6328( void *context );
