...
#include <bosSleep.h>
#include <pcm6838.h>
/*#include <map6838.h> TBD007 may not needed include this file*/
...
int boardHalIpcReady( int notUsed )
{
   ...
   */
   ...
   sharedMemDescr.dmaBufferSize        = PCM6838_DMA_MAX_BUFFER_SIZE;
   sharedMemDescr.bcmChip              = BCM96838;
