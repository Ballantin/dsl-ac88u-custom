...
*****************************************************************************
*
*    Filename: boardHalPower6838.c
*
****************************************************************************
*    Description:
*
*     Implements power savings features that are specific to 6838-based
*     reference design.
*
****************************************************************************/
...
void boardHalPowerSavingsInit( int reducedVoltage )
{
   ...
   */
   ...
   VRG_LOG_DBG(( VRG_LOG_MOD_BOARDHAL, "6838 power savings initialized!"));
...
void boardHalPowerSavingsEnable( void )
{
   ...
   */
   ...
   VRG_LOG_DBG(( VRG_LOG_MOD_BOARDHAL, "6838 power savings Enabled!"));
...
void boardHalPowerSavingsDisable( void )
{
   ...
   */
   ...
   VRG_LOG_DBG(( VRG_LOG_MOD_BOARDHAL, "6838 power savings Disabled!"));
