...
#ifndef FLEXICALC_BCM6818_L9530_NORTH_AMERICA_H
#define FLEXICALC_BCM6818_L9530_NORTH_AMERICA_H
...
#define flexicalcBCM6818L9530NORTH_AMERICAArchive9540 ((const APM6818_FLEXICALC_CFG*) NULL)
#else
const APM6818_FLEXICALC_CFG flexicalcBCM6818L9530NORTH_AMERICAArchive9540[] =
{
{
   0x9530,           /* Slic type: L9530 */
   57,               /* Ring Voltage (RMS) */
   -6,               /* DLP - Decode Level Point (receive loss) in dB */
   -6,               /* ELP - Encode Level Point (transmitt loss) in dB */
   0x0007,           /* eq_rx_shft */
   0x000A,           /* eq_tx_shft */
   0,                /* eq_imp_resp */
   ...
   */
   ...
   4,                  /* hybal_shft */
   {0x69A1, 0xA774, 0x178D, 0x3883, 0xD8A3},    /* hybal_audio_fir[5] */
   ...
   0x0004,           /* cic_int_shft */
   0x0004,           /* cic_dec_shft */
   0x5948,           /* asrc_int_scale */
   0x0CC7,           /* asrc_dec_scale */
   0,                /* vtx_pg */
   1,                /* vrx_pg */
   1,                /* hpf_en */
   4,                /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_BCM6818_L9530_NORTH_AMERICA_H */
