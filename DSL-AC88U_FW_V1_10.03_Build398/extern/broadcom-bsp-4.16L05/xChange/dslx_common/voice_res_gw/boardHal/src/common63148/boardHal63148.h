...
*****************************************************************************
*
*    Filename: boardHal63148.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 63148 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_63148_H
#define BOARD_HAL_63148_H
...
/*
** 63148vcm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_63148VCM_HW_DEBOUNCE_MS  0    /* no h/w debouncing */
#define BOARD_HAL_63148VCM_SW_DEBOUNCE_MS  15   /* use only s/w debouncing */
...
*****************************************************************************
*/
int boardHalInit63148( VRG_BOARDHAL_INIT_CFG *initCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit63148
**
...
void boardHalShutdown63148( void *context );
