...
*
****************************************************************************
*    Filename: boardHalInit93328vcm.c
*
****************************************************************************
*    Description:
*
...
int boardHalInit( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg )
{
   ...
   */
   boardCfgModules = BOARDCFG6328_MODULE_MSPI | BOARDCFG6328_MODULE_GPIO | BOARDCFG_MODULE_TPD ;

   status = boardHalInitUni( boardHalInitCfg, 
                             boardCfgModules 
#ifdef BRCM_NONDIST_BUILD
                           , PCM6328_DMA_MAX_BUFFER_SIZE
                           , VRG_BOARDHAL_BCM96328
