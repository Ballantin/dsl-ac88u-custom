...
*****************************************************************************
*
*    Filename: boardHalSlic6816L9530.c
*
****************************************************************************
*    Description:
*
...
extern void slic6816L9530UpdateState( SLIC_6816_L9530_DRV *pDev );
...
static SLIC_6816_L9530_DRV   gSlicDriver[ BOARD_HAL_6816_NUM_ENDPTS ];
...
static const BOARD_HAL_SLIC_FUNCS boardHal6816L9530DrvFuncs =
{
...
/*
** 6816 <-> L9530 SLIC connectivity configuration structure.
*/
static const SLICCFG_6816_L9530_PIN_INFO gSlicPinInfo6818RG[BOARD_HAL_6816_NUM_ENDPTS] =
{
   /* Chan 0 */
   {
      26,   //B0 pin
...
int boardHalSlicInit9530( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg, VRG_BOOL arg )
{
   ...
   boardHalInitCfg->pDrvSlicFuncs = &boardHal6816L9530DrvFuncs;
...
#define GPIO_MODE_SPI_SSN3_GPIO_29           (1<<29)
   ...
   for ( endpt = 0; endpt < BOARD_HAL_6816_NUM_ENDPTS; endpt++ )
   {
      ...
      {
         if( 0 == strcmp(baseBoardIdStr, "96818RG") )
         {
            slic6816L9530Init( pDev, endpt, &gSlicPinInfo6818RG[endpt], pApmDrv);
         }
      }
      else
      {
...
int boardHalSlicEnable9530( int lineId, VRG_BOOL enableSlic )
{
   ...
   {
      VRG_LOG_WARN(( VRG_LOG_MOD_BOARDHAL, "boardHalSlicEnable: line out of range %d/%d", lineId, BOARD_HAL_6816_NUM_ENDPTS));
      return ( 1 );
   }
}
...
void boardHalSetAnalogLoopback9530( int lineId, VRG_BOOL enabled )
{
   ...
   SLIC_6816_L9530_DRV *pDev = &(gSlicDriver[lineId]);
      ...
      if( gSlicTaskHalted == XDRV_FALSE )
      {
         for ( endpt = 0; endpt < BOARD_HAL_6816_NUM_ENDPTS; endpt++ )
         {
            if ( gSlicDriver[endpt].bDrvEnabled )
            {
               ...
               slic6816L9530UpdateState( &(gSlicDriver[endpt]) );
            }
         }
      }
...
int boardHalSlicL9530UpdateLineStatus( int lineId, VRG_BOOL enableSlic, VRG_BOOL enableHvg )
{
   ...
   if (( lineId < 0 ) && ( lineId >= BOARD_HAL_6816_NUM_ENDPTS ))
   {
      VRG_LOG_WARN(( VRG_LOG_MOD_BOARDHAL, "boardHalSlicL9530UpdateLineStatus: line out of range %d/%d", lineId, BOARD_HAL_6816_NUM_ENDPTS ));
      return ( 1 );
   }
