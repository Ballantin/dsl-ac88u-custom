...
#ifndef FLEXICALC_ETSI_9540_H
#define FLEXICALC_ETSI_9540_H
...
#define flexicalcETSIArchive9540 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcETSIArchive9540[] =
{
{
