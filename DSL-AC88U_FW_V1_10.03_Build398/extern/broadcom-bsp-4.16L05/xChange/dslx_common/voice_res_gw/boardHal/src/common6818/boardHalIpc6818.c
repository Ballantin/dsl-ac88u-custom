...
#include <bosSleep.h>
#include <pcm6818.h>
/*#include <map6818.h> TBD007 may not needed include this file*/
...
int boardHalIpcReady( int notUsed )
{
   ...
   */
   ...
   sharedMemDescr.dmaBufferSize        = PCM6818_DMA_MAX_BUFFER_SIZE;
   sharedMemDescr.bcmChip              = BCM96818;
