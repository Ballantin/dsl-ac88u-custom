...
#ifndef FLEXICALC_TAIWAN_9540_H
#define FLEXICALC_TAIWAN_9540_H
...
#define flexicalcTAIWANArchive9540 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcTAIWANArchive9540[] =
{
{
