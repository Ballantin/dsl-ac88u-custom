...
#ifndef FLEXICALC_AUSTRALIA_3239_H
#define FLEXICALC_AUSTRALIA_3239_H
...
#define flexicalcAUSTRALIAArchive3239 ((const APM6818_FLEXICALC_CFG*) NULL)
#else
const APM6818_FLEXICALC_CFG flexicalcAUSTRALIAArchive3239[] =
{
{
   ...
   */
   ...
   7,               /* hybal_shft */
   {0x53A1, 0x832C, 0x62D8, 0x8326, 0x54DE},    /* hybal_audio_fir[5] */
   ...
   0x0004,               /* cic_int_shft */
   0x0004,               /* cic_dec_shft */
   0x73F9,           /* asrc_int_scale */
   0x0856,           /* asrc_dec_scale */
   2,               /* vtx_pg */
   1,               /* vrx_pg */
   0,               /* hpf_en */
   6,               /* hybal_smpl_offset */
...
#endif  /* FLEXICALC_AUSTRALIA_3239_H */
