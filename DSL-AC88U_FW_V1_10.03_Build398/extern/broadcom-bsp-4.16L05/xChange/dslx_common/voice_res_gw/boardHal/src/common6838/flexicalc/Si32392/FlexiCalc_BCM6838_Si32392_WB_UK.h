...
#ifndef FLEXICALC_WB_UK_32392_H
#define FLEXICALC_WB_UK_32392_H
...
#define flexicalcWBUKArchive32392 ((const APM6838_FLEXICALC_CFG*) NULL)
#else
const APM6838_FLEXICALC_CFG flexicalcWBUKArchive32392[] =
{
{
