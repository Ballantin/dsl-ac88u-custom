...
*****************************************************************************
*
*    Filename: boardHalSlic6828Si32392.c
*
****************************************************************************
*    Description:
*
...
extern void slic6828Si32392UpdateState( SLIC_6828_SI32392_DRV *pDev );
...
static SLIC_6828_SI32392_DRV gSlicDriver[ BOARD_HAL_6828_NUM_ENDPTS ];
...
/*
** 6828 <-> SI32392 SLIC configuration structure.
*/
static SLICCFG_6828_SI32392_INFO gSlicCfgInfo[ BOARD_HAL_6828_NUM_ENDPTS ];
...
static const BOARD_HAL_SLIC_FUNCS boardHal6828Si32392DrvFuncs =
{
...
int boardHalSlicInit32392( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg, VRG_BOOL arg )
{
   ...
   boardHalInitCfg->pDrvSlicFuncs = &boardHal6828Si32392DrvFuncs;
   ...
   for ( endpt = 0; endpt < BOARD_HAL_6828_NUM_ENDPTS; endpt++ )
   {
      ...
      slic6828Si32392Init( endpt, pDev, &gSlicCfgInfo[endpt], pApmDrv );
...
int boardHalSlicEnable32392( int lineId, VRG_BOOL enableSlic )
{
   ...
   {
      VRG_LOG_WARN(( VRG_LOG_MOD_BOARDHAL, "boardHalSlicEnable32392: line out of range %d/%d", lineId, BOARD_HAL_6828_NUM_ENDPTS));
      return ( 1 );
   }
}
...
int boardHalSlicReadWriteMemory32392( int endpt, int addr, int data, int write )
{
   ...
   if( write )
   {
      slic6828Si32392RegisterWrite( endpt, ( VRG_UINT8 )addr, ( VRG_UINT16 )data );
      VRG_LOG_DBG(( VRG_LOG_MOD_BOARDHAL, "Data value 0x%04X written to address %d.", ( VRG_UINT16 )data, ( VRG_UINT8 )addr ));
   }
   else
   {
      slic6828Si32392RegisterRead( endpt, ( VRG_UINT8 )addr, &value );
...
void boardHalSetAnalogLoopback32392( int lineId, VRG_BOOL enabled )
{
   ...
   if (enabled)
   {
      ...
      slic6828Si32392RegisterMaskWrite( lineId, SI32392_REG_LINEFEED_CONFIG_2,
      ...
      if( gSlicTaskHalted == XDRV_FALSE )
      {
         for ( endpt = 0; endpt < BOARD_HAL_6828_NUM_ENDPTS; endpt++ )
         {
            if ( gSlicDriver[endpt].bDrvEnabled )
            {
               ...
               slic6828Si32392UpdateState( &(gSlicDriver[endpt]) );
            }
         }
      }
...
int boardHalSlicSi32392UpdateLineStatus( int lineId, VRG_BOOL enableSlic, VRG_BOOL enableHvg )
{
   ...
   if (( lineId < 0 ) && ( lineId >= BOARD_HAL_6828_NUM_ENDPTS ))
   {
      VRG_LOG_WARN(( VRG_LOG_MOD_BOARDHAL, "boardHalSlicSi32392UpdateLineStatus: line out of range %d/%d", lineId, BOARD_HAL_6828_NUM_ENDPTS ));
      return ( 1 );
   }
