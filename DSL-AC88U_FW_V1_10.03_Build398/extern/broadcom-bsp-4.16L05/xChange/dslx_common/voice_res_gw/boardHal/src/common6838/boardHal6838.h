...
*****************************************************************************
*
*    Filename: boardHal6838.h
*
****************************************************************************
*    Description:
*
*     Private defines for the 6838 board HAL.
*
****************************************************************************/

#ifndef BOARD_HAL_6838_H
#define BOARD_HAL_6838_H
...
#define BOARD_HAL_6838_NUM_ENDPTS   2

#define BOARD_HAL_NUM_SLIC_MAX      2

/*
** 6838pvwm based reference design doesn't support hook state
** debouncing in hardware, so use only s/w debouncing.
*/
#define BOARD_HAL_6838PVWM_HW_DEBOUNCE_MS 0    /* h/w debouncing */
#define BOARD_HAL_6838PVWM_SW_DEBOUNCE_MS 0   /* s/w debouncing */
...
*/
#define BOARDCFG6838_MODULE_TPD        (1<<1)    /* TPD (linetests) */
#define BOARDCFG6838_MODULE_DIAG6838   (1<<2)    /* 6838 diagnostics */
#define BOARDCFG6838_MODULE_HVGRING    (1<<3)    /* HVG ring support */
#define BOARDCFG6838_MODULE_MSPI       (1<<4)    /* MSPI support */
#define BOARDCFG6838_MODULE_FASTSLIC   (1<<5)    /* Fast SLIC mode change support */
#define BOARDCFG6838_MODULE_HVGALTREGS (1<<6)    /* Use Alternate HVG Settings */
#define BOARDCFG6838_MODULE_HVGTYPEFB  (1<<7)    /* HVG design topology */
...
/*
*****************************************************************************
** FUNCTION:   boardHalInit6838
**
** PURPOSE:    Initialize the HAL.
**
** PARAMETERS: boardHalInitCfg - current boardHal init config
**             initModules     - 6838 board modules to initialize
**
** RETURNS:    0 on success, otherwise error code.
**
*****************************************************************************
*/
int boardHalInit6838( VRG_BOARDHAL_INIT_CFG *boardHalInitCfg, int initModules );


/*
*****************************************************************************
** FUNCTION:   boardHalDeinit6838
**
** PURPOSE:    Uninitialize the HAL. Reset any local storage and
**             free all resources.
**
** PARAMETERS: deinitModules - 6838 board modules to deinitialize
**
** RETURNS:    0 on success, otherwise error code.
...
*****************************************************************************
*/
int boardHalDeinit6838( int deinitModules );


#ifdef DYING_GASP_API
void boardHalShutdown6838( void *context );
#endif 
