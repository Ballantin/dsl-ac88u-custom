 ...
 *    Description:
 *
 *      This file contains a hardware-specific (63268 platform) interface for
...
#include <ntr63268.h>          /* Implementation */
...
{
   ntr63268_getCounts( localCount, ntrCount );
   return;
}
...
{
   ntr63268_setFeedback( pcmStepsAdjust, isEnbl );
   return;
}
...
{
   ntr63268_print( numSamples, sampleIntervalMs );   
   return;
}
...
{
   ntr63268_getNdiv( ndivInt, ndivFrac ); 
   return; 
}
