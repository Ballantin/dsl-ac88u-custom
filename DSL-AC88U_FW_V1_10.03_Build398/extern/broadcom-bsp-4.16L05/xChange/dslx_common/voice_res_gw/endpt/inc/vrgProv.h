...
#define MAX_PROV_PARM_SIZE          1024

/* ---- Function Prototypes -------------------------------------- */

EPSTATUS endptProvInit(void);
EPSTATUS endptProvDeinit(void);
EPSTATUS endptProvSetValue( int lineId, EPPROV itemId, void* itemValue, int itemLength );
EPSTATUS endptProvGetValue( int lineId, EPPROV itemId, void* itemValue );
...
#define endptProvSetCB  endptProvSetValue
#define endptProvGetCB  endptProvGetValue
