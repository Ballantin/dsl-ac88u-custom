...
)
{
   ...
   blogStrUsr(( gBosBlog, BOS_LOG_PARAMS, "Created task %s \n", name));
...
{
   blogStrErr(( gBosBlog, "bosTaskSuspend not implemented for Linux User mode "));
   return( BOS_STATUS_ERR );
...
{
   blogStrErr(( gBosBlog, "bosTaskResume not implemented for Linux User mode "));
   return( BOS_STATUS_ERR );
...
{
   blogStrErr(( gBosBlog, "bosTaskExists not implemented for Linux User mode "));
   return( BOS_STATUS_ERR );
