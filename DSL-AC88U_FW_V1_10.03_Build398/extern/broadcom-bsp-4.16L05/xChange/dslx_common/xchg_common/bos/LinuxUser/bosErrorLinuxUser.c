...
/**
*
*  @file    bosErrorLinuxUser.c
*
*  @brief   LinuxUser implementation of the BOS Error module.
*
****************************************************************************/
...
/**
 * @addtogroup bosErrorLinuxUser
 * @{
 */

/***************************************************************************/
/**
*  Translates native LinuxUser error codes into an appropriate BOS status code.
*
*  @param   err         (in) The LinuxUser error code
...
#if 1
      blogStrErr(( gBosBlog, "returned by %s: %s (%u)",
                errSrcStr, errStr,  err ));
#endif
