...
/**
*
*  @file    bosTypesLinuxUser.h
*
*  @brief   LinuxUser Specific BOS Types.
*
****************************************************************************/

#if !defined( BOSTYPESLINUXUSER_H )
#define BOSTYPESLINUXUSER_H           /**< Include Guard                           */
