...
BOS_STATUS bosTimeGetGmTime ( const time_t *gmTime, struct tm *brokenDownTime )
{
   ...
   {
      blogStrErr(( gBosBlog, "bosTimeGetGmTime() - cannot convert the calender time to broken down time"));
      return BOS_STATUS_ERR;
   }
...
BOS_STATUS bosTimeGetLocalTime ( const time_t *localTime, struct tm *brokenDownTime )
{
   ...
   {
      blogStrErr(( gBosBlog, "bosTimeGetLocalTime() - cannot convert the calender time to broken down time"));
      return BOS_STATUS_ERR;
   }
...
BOS_STATUS bosTimeMkTime ( struct tm *brokenDownTime, time_t *timep )
{
   ...
   */
   ...
   {
      blogStrErr(( gBosBlog, "ERROR: bosTimeMkTime() - mktime() returned error" ));
      return ( BOS_STATUS_ERR );
   }
