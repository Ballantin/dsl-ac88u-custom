...
{
   XCHG_ASSERT( !gBosIpAddrInitialized);
...
)
{
   ...
   switch (type)
   {
      ...
      case BOS_IPADDRESS_TYPE_V6:
         ...
         break;
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpaddrCreateFromStr : type unknown.\n" ));
         return BOS_STATUS_ERR;    
   }
#else
   if( !bcm_inet_pton4((BOS_UINT8 *)ipstr, 
...
)
{
	...
	switch (ipp->ipType)
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpaddrCreateFromU8: type unknown.\n" ));
         return BOS_STATUS_ERR;    
   }
#else
...
#if BOS_CFG_IP_ADDR_V6_SUPPORT
   XCHG_ASSERT( gBosIpAddrInitialized);
   XCHG_ASSERT( ipv6 != NULL );
   XCHG_ASSERT( ipv4 != NULL );
...
BOS_STATUS bosIpAddrCreateZero( BOS_IP_ADDRESS_TYPE type, BOS_IP_ADDRESS *ipp )
{
   ...
   switch (type)
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpAddrCreateZero : type unknown.\n" ));
         return BOS_STATUS_ERR;
   }
#else
   ipp->s4Addr32 = 0;
...
BOS_STATUS bosIpAddrCreateAny( BOS_IP_ADDRESS_TYPE type, BOS_IP_ADDRESS *ipp )
{
   ...
   switch (type)
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpAddrCreateAny : type unknown.\n" ));
         return BOS_STATUS_ERR;
   }
#else
...
BOS_STATUS bosIpAddrCreateLoopback( BOS_IP_ADDRESS_TYPE type, BOS_IP_ADDRESS *ipp )
{
   ...
   switch (type)
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpaddrSetToLoopback error: type unknown.\n" ));
         return BOS_STATUS_ERR;
   }
#else
   bosIpAddrCreateFromStr((char *)IPV4_LOOPBACK_ADDRESS, ipp);
...
BOS_STATUS bosIpAddrGetStr( const BOS_IP_ADDRESS *ipp, char *ipstr, int maxlen )
{
   ...
   switch (ipp->ipType) 
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpadrrGetStr error: type unknown.\n" ));
...
)
{
   ...
   switch (ipp->ipType)
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpaddrGetUchar : type unknown.\n" ));
         return BOS_STATUS_ERR;    
   }
#else
...
BOS_STATUS bosIpAddrV4GetU32( const BOS_IP_ADDRESS *ipp, BOS_UINT32 *ipNum )
{
   ...
   switch (ipp->ipType)
   {
      ...
      case BOS_IPADDRESS_TYPE_V6:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpAddrV4GetU32 error: v6 is not supported for this function.\n" ));
         return BOS_STATUS_ERR;    
         break;
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpAddrV4GetU32 error: type unknown.\n" ));
         return BOS_STATUS_ERR;    
   }
#else
...
BOS_BOOL bosIpAddrIsEqual( const BOS_IP_ADDRESS *ip1, const BOS_IP_ADDRESS *ip2 )
{
   ...
   XCHG_ASSERT( gBosIpAddrInitialized);
   XCHG_ASSERT( ip1 != NULL );
   XCHG_ASSERT( ip2 != NULL );
   ...
   switch ( ip1->ipType )
   {
      ...
      default:
         blogStrUsr(( gBosBlog, BOS_LOG_IPADDR_PARAMS, 
                  "bosIpAddrIsEqual error: type unknown.\n" ));
         return BOS_FALSE;    
   }
   if (rc)
   {
...
#else
   blogStrErr(( gBosBlog, "This function is not supported for v4.\n"));
#endif
}
