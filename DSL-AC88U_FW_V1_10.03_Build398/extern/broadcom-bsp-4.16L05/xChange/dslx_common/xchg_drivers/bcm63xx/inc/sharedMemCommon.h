...
****************************************************************************
*
*    Filename: sharedMemCommon.h
*
****************************************************************************
*    Description:
*
*     Shared memory definitions used for handshaking and communication
*     between the MIPS thread-processors.
*
****************************************************************************/

#ifndef SHARED_MEM_COMMON_H
#define SHARED_MEM_COMMON_H
...
*/
typedef struct SHARED_MEM_DESCRIPTOR
{
   ...
   ** to shared memory data structures by both MIPS cores. */
   ...
   /* BCMChip id. Passed from host to DSP to determine what processor we 
   ** are running on. */
   BCMCHIP                   bcmChip;
   
   /* Flag to indicate whether APM mode is enabled or not. */
   XDRV_UINT32               apmModeEnabled;

} SHARED_MEM_DESCRIPTOR;
