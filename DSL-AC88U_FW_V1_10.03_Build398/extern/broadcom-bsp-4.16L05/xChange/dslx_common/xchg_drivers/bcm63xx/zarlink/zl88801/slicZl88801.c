...
/*
*****************************************************************************
** FUNCTION:   slicZl88801Init
**
** PURPOSE:    Initialize and open the Zarlink 88801 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88801Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   DEV_PROFILE_47UH_BBABS;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for ZL888", LOG_DEV_NAME ));
   }
   else
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: ZL88801 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = ZL88801_FXS_LINES;
   ...
   zarlinkConfig.pDcProfile        = DC_FXS_BBABS100V_DEF;
   zarlinkConfig.pRingProfile      = RING_25HZ_70VPK;
...
**
** PURPOSE:    Shutdown the ZL88801 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88801Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicZl88801Shutdown( XDRV_UINT16 rstGpioPin )
{
