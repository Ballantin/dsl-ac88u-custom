...
****************************************************************************
*    Description: 
*      This is the Legerity Le88536 - Single Channel Digital SLIC Device
...
/*
*****************************************************************************
** FUNCTION:   slicLe88536Init
**
** PURPOSE:    Initialize and open the Zarlink 88536 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88536Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   if( pDev->deviceProfile == ZARLINK_INVBOOST_THALASSA )
   {
      zarlinkConfig.pDevProfile = DEV_VE880_88536_PROFILE_INV_BOOST_100V_THALASSA;   
   }
   else if( pDev->deviceProfile == ZARLINK_INVBOOST )
   {
      zarlinkConfig.pDevProfile = DEV_VE880_88536_PROFILE_INV_BOOST_100V_ZSI;   
   }
   
   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE88536_FXS_LINES;
   ...
   zarlinkConfig.pDcProfile        = DC_25MA_CC;
...
/*
*****************************************************************************
** FUNCTION:   slicLe88536Deinit
**
** PURPOSE:    Shutdown the LE88536 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88536Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe88536Shutdown( XDRV_UINT16 rstGpioPin )
{
