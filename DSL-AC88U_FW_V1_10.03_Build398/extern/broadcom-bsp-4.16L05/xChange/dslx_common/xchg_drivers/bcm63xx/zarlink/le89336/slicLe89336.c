...
*    Description: 
*
*      Zarlink 89336 driver - 1FXS(SLIC) + 1FXO(DAA) Device
*
****************************************************************************/
...
/*
*****************************************************************************
** FUNCTION:   slicLe89336Init
**
** PURPOSE:    Initialize and open the Zarlink 89336 device (FXS+FXO)
**
...
XDRV_SLIC_STATUS slicLe89336Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   zarlinkConfig.numFxsPerDevice   = LE89336_FXS_LINES;
   zarlinkConfig.numFxoPerDevice   = LE89336_FXO_LINES;
...
/*
*****************************************************************************
** FUNCTION:   slicLe89336Deinit
**
** PURPOSE:    Shutdown the LE89336 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
