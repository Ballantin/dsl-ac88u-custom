...
/*
*****************************************************************************
** FUNCTION:   slicZl88601Init
**
** PURPOSE:    Initialize and open the Zarlink 88601 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88601Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   ZLR88621L_ZL880_ABS100V_DEVICE;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for ZL886", LOG_DEV_NAME ));
   }
   else
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: ZL88601 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = ZL88601_FXS_LINES;
...
**
** PURPOSE:    Shutdown the ZL88601 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88601Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicZl88601Shutdown( XDRV_UINT16 rstGpioPin )
{
