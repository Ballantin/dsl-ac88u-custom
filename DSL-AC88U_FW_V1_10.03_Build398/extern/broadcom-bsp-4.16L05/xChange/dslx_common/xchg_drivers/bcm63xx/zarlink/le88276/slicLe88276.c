...
****************************************************************************
*    Description: 
*      This is the Legerity Le88276 - Single Channel Digital SLIC Device
...
/*
*****************************************************************************
** FUNCTION:   slicLe88276Init
**
** PURPOSE:    Initialize and open the Zarlink 88506 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88276Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile = DEV_VE880_88276_PROFILE;   
   }
   
   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE88276_FXS_LINES;
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88276Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe88276Shutdown( XDRV_UINT16 rstGpioPin )
{
