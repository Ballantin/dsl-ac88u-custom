...
/*
*****************************************************************************
** FUNCTION:   slicLe9662Init
**
** PURPOSE:    Initialize and open the Zarlink 9662 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9662Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   ZLR88645L_VE960_ABS100V_DEVICE;/* for ZLR88645 FB duaghter card */
      zarlinkConfig.pDcProfile  =   DC_FXS_ZL880_ABS100V_DEF;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9662 flyback board.", LOG_DEV_NAME ));
   }
   else if( pDev->deviceProfile == ZARLINK_BUCKBOOST )
   {
      zarlinkConfig.pDevProfile =   ZLR96622REV0_VE960_BBABS_DEV_PROFILE_47UH;/* for ZLR96622 BBABS Line module.*/
      zarlinkConfig.pDcProfile  =   DC_FXS_VE960_ABS100V_DEF;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9662 buckboost board", LOG_DEV_NAME ));
   } 
   else 
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: LE9662 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE9662_FXS_LINES;
   zarlinkConfig.numFxoPerDevice   = 0;
   zarlinkConfig.deviceType        = VP_DEV_886_SERIES;
   ...
   zarlinkConfig.pRingProfile      = RING_ZL880_ABS100V_DEF;
...
/*
*****************************************************************************
** FUNCTION:   slicLe9662Deinit
**
** PURPOSE:    Shutdown the LE9662 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9662Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe9662Shutdown( XDRV_UINT16 rstGpioPin )
{
