...
/*
*****************************************************************************
** FUNCTION:   slicLe9641Init
**
** PURPOSE:    Initialize and open the Zarlink 9641 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9641Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   Le9641_DEV_PROFILE_ZSI_Buck_Boost;/* for customer only. Pending DC from Microsemi */
      zarlinkConfig.pDcProfile  =   DC_FXS_miSLIC_Le9661_BB_DEF;
      zarlinkConfig.pRingProfile=   RING_miSLIC_Le9661_BB_DEF;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9641 Buck-boost board.", LOG_DEV_NAME ));
   }
   else 
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: LE9641 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE9641_FXS_LINES;
...
/*
*****************************************************************************
** FUNCTION:   slicLe9641Deinit
**
** PURPOSE:    Shutdown the LE9641 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9641Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe9641Shutdown( XDRV_UINT16 rstGpioPin )
{
