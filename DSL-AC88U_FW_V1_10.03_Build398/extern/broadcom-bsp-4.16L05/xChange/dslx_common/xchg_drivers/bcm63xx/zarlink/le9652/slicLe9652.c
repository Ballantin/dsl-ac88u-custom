...
/*
*****************************************************************************
** FUNCTION:   slicLe9652Init
**
** PURPOSE:    Initialize and open the Zarlink 9652 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9652Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   DEV_PRODILE_Le9652_135V_IB;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9652 Invert-boost board.", LOG_DEV_NAME ));
   }
   else if( pDev->deviceProfile == ZARLINK_FLYBACK )
   {
      zarlinkConfig.pDevProfile =   DEV_PROFILE_Le9652_150V_FB;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9652 flyback board.", LOG_DEV_NAME ));
   }
   else 
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: LE9652 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE9652_FXS_LINES;
...
/*
*****************************************************************************
** FUNCTION:   slicLe9652Deinit
**
** PURPOSE:    Shutdown the LE9652 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9652Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe9652Shutdown( XDRV_UINT16 rstGpioPin )
{
