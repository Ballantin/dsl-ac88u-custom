...
/*
*****************************************************************************
** FUNCTION:   slicLe9642Init
**
** PURPOSE:    Initialize and open the Zarlink 9642 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9642Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   DEV_PROFILE_47UH_1_5A;/* for Le9642 miSLIC 2FXS_BUCK-BOOST ABS DC.*/
      zarlinkConfig.pDcProfile  =   DC_FXS_VE960_ABS100V;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for LE9642 buckboost board", LOG_DEV_NAME ));
   } 
   else 
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: LE9642 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE9642_FXS_LINES;
   ...
   zarlinkConfig.pRingProfile      = RING_VE960_ABS100V_DEF;
...
/*
*****************************************************************************
** FUNCTION:   slicLe9642Deinit
**
** PURPOSE:    Shutdown the LE9642 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe9642Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe9642Shutdown( XDRV_UINT16 rstGpioPin )
{
