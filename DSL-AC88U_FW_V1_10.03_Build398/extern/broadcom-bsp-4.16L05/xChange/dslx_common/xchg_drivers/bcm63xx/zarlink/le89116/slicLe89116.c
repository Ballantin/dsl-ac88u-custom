...
*    Description: 
*
*      Zarlink 89116 driver - 1FXS(SLIC) Device
*
****************************************************************************/
...
/*
*****************************************************************************
** FUNCTION:   slicLe89116Init
**
** PURPOSE:    Initialize and open the Zarlink 89116 device (FXS)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe89116Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   zarlinkConfig.numFxsPerDevice   = LE89116_FXS_LINES;
...
/*
*****************************************************************************
** FUNCTION:   slicLe89116Deinit
**
** PURPOSE:    Shutdown the LE89116 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe89116Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe89116Shutdown( XDRV_UINT16 resetGpioPin )
{
