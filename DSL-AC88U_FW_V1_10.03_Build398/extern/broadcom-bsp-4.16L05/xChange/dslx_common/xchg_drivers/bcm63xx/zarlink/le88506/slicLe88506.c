...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88506Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile = DEV_VE880_88506_PROFILE_FLYBACK_150V;   
   }

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = LE88506_FXS_LINES;
...
**
** PURPOSE:    Shutdown the LE88506 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicLe88506Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicLe88506Shutdown( XDRV_UINT16 rstGpioPin )
{
