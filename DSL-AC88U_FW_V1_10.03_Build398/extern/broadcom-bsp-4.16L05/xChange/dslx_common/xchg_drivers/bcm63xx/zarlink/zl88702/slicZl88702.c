...
/*
*****************************************************************************
** FUNCTION:   slicZl88702Init
**
** PURPOSE:    Initialize and open the Zarlink 88702 device (FXSx2)
**
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88702Init( SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   {
      zarlinkConfig.pDevProfile =   Le9672_12V_FB150V;
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: Configured for ZL887", LOG_DEV_NAME ));
   }
   else
   {
      XDRV_LOG_DBG((XDRV_LOG_MOD_SLIC, "%s: ZL88702 Device profile not supported!", LOG_MODULE_NAME ));
      return XDRV_SLIC_STATUS_ERROR;
   } 

   /* Setup Configuration Structure */
   zarlinkConfig.pDev              = pDev;
   zarlinkConfig.numFxsPerDevice   = ZL88702_FXS_LINES;
   ...
   zarlinkConfig.pRingProfile      = RING_VE960_FB150V_US;
...
**
** PURPOSE:    Shutdown the ZL88702 SLIC
**
** PARAMETERS: 
**
** RETURNS:    XDRV_SLIC_STATUS
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicZl88702Deinit( SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicZl88702Shutdown( XDRV_UINT16 rstGpioPin )
{
