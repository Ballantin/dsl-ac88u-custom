...
**
** $Id: vdaa.h 4727 2015-02-10 22:35:54Z nizajerk $
**
** Vdaa.h
...
/**
** Defines structure for configuring impedance 
 ...
 * @param[in] hTimer  - the timer object that is passed to all timer functions.
 * @retval int - error from @ref errorCodeType  @ref RC_NONE indicates no error.
 *
 ...
 * not return a standard error value and instead returns back some other value.
