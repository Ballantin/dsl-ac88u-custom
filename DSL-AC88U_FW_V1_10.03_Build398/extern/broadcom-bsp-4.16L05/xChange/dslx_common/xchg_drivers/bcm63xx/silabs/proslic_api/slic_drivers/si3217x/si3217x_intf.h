...
**
** $Id: si3217x_intf.h 4727 2015-02-10 22:35:54Z nizajerk $
**
** Si3217x_Intf.h
...
** Input Parameters: 
** pProslic: pointer to PROSLIC object
** size - number of consecutive channels to initialize
** initOption - see proslic.h for options.
**
** Return:
** none
*/
int Si3217x_with_Init_Options (proslicChanType_ptr *hProslic,int size,initOptionsType  initOption);
