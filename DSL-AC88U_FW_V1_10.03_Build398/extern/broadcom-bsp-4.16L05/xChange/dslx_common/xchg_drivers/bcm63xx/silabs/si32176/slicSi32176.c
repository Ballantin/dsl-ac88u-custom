...
/*
*****************************************************************************
** FUNCTION:   slicSi32176Init
**
** PURPOSE:    Initialize and open the Si32176 device
**
** PARAMETERS: pDev         - pointer to the Si32176 SLIC info structure
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi32176Init( SI_SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   else if( pDev->deviceProfile == SILABS_LCQCUK )
   {
      silabsConfig.bomType = SI3217x_GEN_PARAM_LCQC3W; 
   }
   else
   {
      XDRV_LOG_ERROR((XDRV_LOG_MOD_SLIC, "%s: unsupported SLAC power mode.", LOG_MODULE_NAME ));
      XCHG_ASSERT(0);
   }
...
/*
*****************************************************************************
** FUNCTION:   slicSi32176Deinit
**
** PURPOSE:    Shutdown the Si32176 SLIC
**
** PARAMETERS: pDev  - pointer to the Si32176 SLIC info structure
**
** RETURNS:    none
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi32176Deinit( SI_SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicSi32176Shutdown( XDRV_UINT16 rstGpioPin )
{
