...
**
** $Id: si321x_intf.c 4727 2015-02-10 22:35:54Z nizajerk $
**
** Author(s): 
** laj
**
...
*/
int Si321x_dbgSetDCFeedIloop(proslicChanType *pProslic, uInt32 uicurrent,int32 preset)
{
    if(uicurrent < SI321X_MIN_LOOP_CURRENT)
    {
        uicurrent = SI321X_MIN_LOOP_CURRENT;
    }

    if(uicurrent > SI321X_MAX_LOOP_CURRENT)
    {
        uicurrent = SI321X_MAX_LOOP_CURRENT;
    }

    Si321x_Dcfeed_Presets[preset].ilim= (uInt8)((uicurrent - SI321X_MIN_LOOP_CURRENT)/3); /* 0 = MIN LC, 3 mA steps */
