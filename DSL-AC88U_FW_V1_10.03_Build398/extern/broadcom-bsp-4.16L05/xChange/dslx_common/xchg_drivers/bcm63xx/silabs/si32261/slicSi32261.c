...
*
****************************************************************************
*    Filename: slicSi32261.c
*
****************************************************************************
*    Description:
*
*      This file contains functions related to the control of the
*      SI32261 which consists of 2 FXS channels.
*
****************************************************************************/
...
/*
*****************************************************************************
** FUNCTION:   slicSi32261Init
**
** PURPOSE:    Initialize and open the Si32261 device
**
** PARAMETERS: pDev         - pointer to the Si32261 SLIC info structure
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi32261Init( SI_SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   switch( pDev->deviceProfile )
   {
      ...
      break;
      case SILABS_FB_TSS:
         silabsConfig.bomType = SI3226X_GEN_PARAM_TSS;
      break;
      case SILABS_PMOS_BUCK_BOOST:
         silabsConfig.bomType = SI3226X_GEN_PARAM_PMOS_BUCK_BOOST;
      break;
      case SILABS_QCUK:
         silabsConfig.bomType = SI3226X_GEN_PARAM_QCUK;
      break;
      case SILABS_LCQCUK:
         silabsConfig.bomType = SI3226X_GEN_PARAM_LCQCUK;
      break;
      default:
         XDRV_LOG_ERROR((XDRV_LOG_MOD_SLIC, "%s: %s unknown BOM type!.", LOG_MODULE_NAME, LOG_DEV_NAME ));
         XCHG_ASSERT( 0 );
      break;
   }
   ...
   silabsConfig.writeRegister_fptr = ctrl_3226x_WriteRegisterWrapper;
   silabsConfig.readRegister_fptr  = ctrl_3226x_ReadRegisterWrapper;
   silabsConfig.writeRAM_fptr      = ctrl_3226x_WriteRAMWrapper;
   silabsConfig.readRAM_fptr       = ctrl_3226x_ReadRAMWrapper;
...
/*
*****************************************************************************
** FUNCTION:   slicSi32261Deinit
**
** PURPOSE:    Shutdown the Si32261 SLIC
**
** PARAMETERS: pDev  - pointer to the Si32261 SLIC info structure
**
** RETURNS:    none
...
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi32261Deinit( SI_SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicSi32261Shutdown( XDRV_UINT16 rstGpioPin )
{
