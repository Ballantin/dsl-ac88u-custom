...
*
****************************************************************************/
#ifndef SLAC_SI32176_LOCALE_H    /* support nested includes */
#define SLAC_SI32176_LOCALE_H
...
static SI3217x_LOCALE_MAP si3217xLocaleMap [VRG_COUNTRY_MAX] =
{
   #include <countryArchive.h>
};
#if 0
static SI3217x_LOCALE_MAP si3217xLocaleMap [] =
{
   ...
   { VRG_COUNTRY_BRAZIL,        SI3217x_BRAZIL      },        
#endif                                                         
