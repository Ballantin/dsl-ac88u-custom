...
*
****************************************************************************
*    Filename: slicSi3226.c
*
****************************************************************************
*    Description:
*
*      This file contains functions related to the control of the
*      SI3226 Subscriber Line Interface Circuits (SLIC).
*
****************************************************************************/
...
/*
*****************************************************************************
** FUNCTION:   slicSi3226Init
**
** PURPOSE:    Initialize and open the Si3226 SLIC
**
** PARAMETERS: chan      - endpt channel associated with slic
**             pDev      - pointer to the Si3226 SLIC info structure
**
** RETURNS:    none
**
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi3226Init( SI_SLIC_DEVICE_DRV *pDev, XDRV_UINT16 resetGpioPin )
{
   ...
   if( pDev->deviceProfile == SILABS_QCUK )
   {
      silabsConfig.bomType = SI3226_GEN_PARAM_QCUK;  
   }
   ...
   silabsConfig.chipType           = SI3226_TYPE;
   silabsConfig.writeRegister_fptr = ctrl_3226_WriteRegisterWrapper;
   silabsConfig.readRegister_fptr  = ctrl_3226_ReadRegisterWrapper;
   silabsConfig.writeRAM_fptr      = ctrl_3226_WriteRAMWrapper;
   silabsConfig.readRAM_fptr       = ctrl_3226_ReadRAMWrapper;
...
/*
*****************************************************************************
** FUNCTION:   slicSi3226Deinit
**
** PURPOSE:    Shutdown the Si3226 SLIC
**
** PARAMETERS: pDev  - pointer to the Si3226 SLIC info structure
**
** RETURNS:    none
**
*****************************************************************************
*/
XDRV_SLIC_STATUS slicSi3226Deinit( SI_SLIC_DEVICE_DRV *pDev )
{
   XDRV_SLIC_STATUS retStatus = XDRV_SLIC_STATUS_SUCESS;
...
*
*****************************************************************************/
XDRV_SLIC_STATUS slicSi3226Shutdown( XDRV_UINT16 rstGpioPin )
{
