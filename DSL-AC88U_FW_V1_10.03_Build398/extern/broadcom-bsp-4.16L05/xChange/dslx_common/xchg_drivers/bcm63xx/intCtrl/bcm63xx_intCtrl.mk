###########################################################################
#
# This makefile is used to build the BCM63xx interrupt control module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63xx_intCtrl

BCM63xx_INT_CTRL_ROOT   := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63xx_INT_CTRL_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63xx_INT_CTRL_ROOT)
