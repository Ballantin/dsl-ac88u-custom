###########################################################################
#
# This makefile is used to build the bcm63xx_timer module.
#
###########################################################################
...
#
XCHG_LIB_BASE        := bcm63xx_timer

BCM63xx_TIMER_ROOT   := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63xx_TIMER_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63xx_TIMER_ROOT)
