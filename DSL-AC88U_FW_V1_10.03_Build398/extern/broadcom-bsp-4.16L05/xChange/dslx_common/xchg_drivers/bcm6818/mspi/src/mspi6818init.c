...
BOS_SEM           mspi6818IsrSem;   /* MSPI ISR semaphore */
#endif /* MSPI6818_USE_INTERRUPTS */

BCM_MSPI6818_DRV  mspi6818Drv;      /* MSPI Driver */
...
int mspiInit( void )
{
   ...
   bosSemCreate( "MSPI6818ISR", 0, 1, &mspi6818IsrSem ); 
   ...
   if( bosSemTimedTake( &mspi6818IsrSem, 100 ))
   {
...
#if 0  /** NOTE: SPI enable should be fixed for 6818 */
   /* Enable SPI Block */
   SpiClockControl( 1, 1 );
#endif    
