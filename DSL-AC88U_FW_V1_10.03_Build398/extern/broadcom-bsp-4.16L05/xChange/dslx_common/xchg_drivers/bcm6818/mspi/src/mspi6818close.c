...
int mspiClose( void )
{
   volatile BCM_MSPI6818_DRV *pMspiDrv;
   pMspiDrv = &mspi6818Drv;

   /* Reset MSPI */
   pMspiDrv->p6818SpiRegs->spiCmd |= MMR6818_MSPI_START_HARD_RESET;
   ...
   mspi6818intc_intVectIrqIsrInstall( 0 );

   /* Destroy the semaphore */
   bosSemDestroy( &mspi6818IsrSem );
#endif /* MSPI6818_USE_INTERRUPTS */
