...
*
****************************************************************************/
#ifndef MSPI6818DEFS_H 
#define MSPI6818DEFS_H
...
#define MSPI6818_MAX_RX_SIZE                1088
                                   
#define BCM6818_MSPI_TX_QUEUE_SIZE           544
#define BCM6818_MSPI_RX_QUEUE_SIZE           544

#define MMR6818_MSPI_INTSTATUS_CMNDDONE     0x01
#define MMR6818_MSPI_INTSTATUS_RXOVERFL     0x02
#define MMR6818_MSPI_INTSTATUS_TXUNDRFL     0x04
#define MMR6818_MSPI_INTSTATUS_TXOVERFL     0x08
#define MMR6818_MSPI_INTSTATUS_RXUNDRFl     0x10
#define MMR6818_MSPI_INTSTATUS_MASK         0x1F

#define MMR6818_MSPI_START_NOOP             0x00
#define MMR6818_MSPI_START_SOFT_RESET       0x01
#define MMR6818_MSPI_START_HARD_RESET       0x02
#define MMR6818_MSPI_START_IMMEDIATE        0x03
#define MMR6818_MSPI_START_NONBUF           0x0F

#define MMR6818_MSPI_STATUS_RXEMPTY         0x02
#define MMR6818_MSPI_STATUS_CMDBUSY         0x04
#define MMR6818_MSPI_STATUS_SERBUSY         0x08
...
typedef struct
{
   volatile SpiControl *p6818SpiRegs;
   ...
   XDRV_UINT8   rxBuf[ MSPI6818_MAX_RX_SIZE ];
   unsigned     rxOffset;
...
typedef void (*MSPI6818_ISR)(void *contextP);
#endif /* MSPI6818_USE_INTERRUPTS */

/* ---- Variable Externs ------------------------------------- */

extern BCM_MSPI6818_DRV  mspi6818Drv;
extern BCM_MSPI6818_REGS mspi6818Registers;

#if MSPI6818_USE_INTERRUPTS
extern BOS_SEM           mspi6818IsrSem;
#endif /* MSPI6818_USE_INTERRUPTS */
