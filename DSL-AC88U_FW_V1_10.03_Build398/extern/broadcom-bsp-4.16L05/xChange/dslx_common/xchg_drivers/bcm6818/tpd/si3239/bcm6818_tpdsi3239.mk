...
#
XCHG_LIB_BASE     := bcm6818_tpdsi3239

BCM3378_TPD_SI3239_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM3378_TPD_SI3239_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM3378_TPD_SI3239_ROOT)
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_ROOT)/boardHal/inc \
                                         $(VRG_ROOT)/boardHal/src/bcm3378vcm/sharedinc \
                                         $(VRG_ROOT)/casCtl/inc \
                                         $(VRG_ROOT)/inc \
                                         $(VRG_LDX_DSP_APP_DIR)/../../chip3341_common/inc
