...
static void slic6818Si32392ModeControl( XDRV_SLIC *pDrv, XDRV_SLIC_MODE mode );
static void slic6818Si32392LedControl( XDRV_SLIC *pDrv, XDRV_UINT16 value );
static void slic6818Si32392PhaseReversalControl( XDRV_SLIC *pDrv, XDRV_UINT16 value );
static XDRV_BOOL slic6818Si32392IsOffhook( XDRV_SLIC *pDrv );
static int slic6818Si32392SetRingParms( XDRV_SLIC *pDrv, int ringFrequency, int ringWaveshape,
                                       int ringVoltage, int ringOffset, int ringOffsetCal );
static int slic6818Si32392GetRingParms( XDRV_SLIC *pDrv, int *ringFrequency, int *ringWaveshape,
                                       int *ringVoltage, int *ringOffset, int *ringOffsetCal );
static int slic6818Si32392SetBoostedLoopCurrent( XDRV_SLIC *pDrv, XDRV_UINT16 value );
static int slic6818Si32392SetPowerSource( XDRV_SLIC *pDrv, XDRV_UINT16 value );
static XDRV_BOOL slic6818Si32392GetOverCurrentStatus( XDRV_SLIC *pDrv );
static XDRV_SINT16 slic6818Si32392GetDlp( XDRV_SLIC *pDrv );
static void slic6818Si32392ProcessEvents( XDRV_SLIC *pDrv );
static XDRV_UINT32 slic6818Si32392Probe( XDRV_SLIC *pDrv, XDRV_UINT32 deviceId, XDRV_UINT32 chan, XDRV_UINT32 reg,
                                      XDRV_UINT32 regSize, void* value, XDRV_UINT32 valueSize, XDRV_UINT32 indirect, 
                                      XDRV_UINT8 set );
static int slic6818Si32392GetSlicParms( XDRV_SLIC *pDrv, int *phaseReversal, int *loopCurrent, int *powerSource, int *slicMode );
/*
...
static const XDRV_SLIC_FUNCS slic6818Si32392DrvFuncs =
{
   slic6818Si32392ModeControl,
   slic6818Si32392LedControl,
   slic6818Si32392PhaseReversalControl,
   slic6818Si32392IsOffhook,
   slic6818Si32392SetRingParms,
   slic6818Si32392GetRingParms,
   slic6818Si32392SetBoostedLoopCurrent,
   slic6818Si32392SetPowerSource,
   slic6818Si32392GetOverCurrentStatus,
   slic6818Si32392GetDlp,
   slic6818Si32392ProcessEvents,
   slic6818Si32392Probe,
   slic6818Si32392GetSlicParms
};

/* Private Functions */
static void OpenSlic( SLIC_6818_SI32392_DRV *pDev );
static void CloseSlic( SLIC_6818_SI32392_DRV *pDev );
static void InitSlicRegs( SLIC_6818_SI32392_DRV *pDev );
...
*****************************************************************************
*/
void slic6818Si32392Init
(
   int                   chan,
   SLIC_6818_SI32392_DRV *pDev,
   const SLICCFG_6818_SI32392_INFO *pSlicCfgInfo,
   XDRV_APM             *pApmDrv
)
{
   int status;
   ...
   pDev->chan = chan;
   pDev->pDrvFuncs = &slic6818Si32392DrvFuncs;
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392Deinit
**
...
*****************************************************************************
*/
void slic6818Si32392Deinit( SLIC_6818_SI32392_DRV *pDev )
{
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392IsOffhook
**
...
static XDRV_BOOL slic6818Si32392IsOffhook( XDRV_SLIC *pDrv )
{
   SLIC_6818_SI32392_DRV *pDev = (SLIC_6818_SI32392_DRV *)pDrv;
   int                   chan = pDev->chan;
   XDRV_UINT16           rc;
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392ModeControl
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392LedControl
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392PhaseReversalControl
**
...
static void slic6818Si32392PhaseReversalControl( XDRV_SLIC *pDrv, XDRV_UINT16 value )
{
   ...
   {
      slic6818Si32392ModeControl( pDrv, pDev->slicMode );
   }
}

/*
*****************************************************************************
** FUNCTION:   slic6818Si32392SetRingParms
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392GetRingParms
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392GetSlicParms
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392SetBoostedLoopCurrent
**
...
/*
******************************************************************************
** FUNCTION:  slic6818Si32392RegisterRead
**
** PURPOSE:   Read from a memory address via MSPI
**
** PARAMETERS:
...
*****************************************************************************
*/
void slic6818Si32392RegisterRead( int chan, XDRV_UINT8 addr, XDRV_UINT16 *data )
{
...
/*
******************************************************************************
** FUNCTION:  slic6818Si32392RegisterWrite
**
** PURPOSE:   Write to a memory address via MSPI
**
** PARAMETERS:
...
*****************************************************************************
*/
void slic6818Si32392RegisterWrite( int chan, XDRV_UINT8 addr, XDRV_UINT16 data )
{
...
/*
******************************************************************************
** FUNCTION:  slic6818Si32392RegisterMaskWrite
**
** PURPOSE:   Write to the masked location of a memory address via MSPI
**            and verify the write if requested to
**
...
*****************************************************************************
*/
void slic6818Si32392RegisterMaskWrite( int chan, XDRV_UINT8 addr, XDRV_UINT16 data, XDRV_UINT16 mask, int verify )
{
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392SetPowerSource
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392GetOverCurrentStatus
**
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392SetSpecialMode
**
...
*****************************************************************************
*/
int slic6818Si32392SetSpecialMode( SLIC_6818_SI32392_DRV *pDev, SLIC_6818_SI32392_SPECIAL_MODE mode, XDRV_BOOL enable )
{
   switch( mode )
   {
      case SLIC_6818_SI32392_SPECIAL_DISABLE_RING_TRANISTION_MODE:
      {
...
/*
*****************************************************************************
** FUNCTION:   slic6818Si32392UpdateState
**
...
*****************************************************************************
*/
void slic6818Si32392UpdateState( SLIC_6818_SI32392_DRV *pDev )
{
   if( pDev->pendingSlicTime > 0 )
   {
