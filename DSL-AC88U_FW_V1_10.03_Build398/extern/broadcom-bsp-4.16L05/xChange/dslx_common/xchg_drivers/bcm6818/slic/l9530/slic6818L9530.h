...
#ifndef SLIC_6818_L9530_H
#define SLIC_6818_L9530_H
...
} SLICCFG_6818_L9530_CONNECT_INFO;


/*
** 6818 L9530 SLIC driver structure. Conceptually, this structure is similar to
...
**
** L9530 SLIC driver state that is specific to the 6818 should be stored in the
** 'SLIC_6818_L9530_DRV' structure. A pointer to 'XDRV_SLIC_FUNCS' must be the first
** member of the 'SLIC_6818_L9530_DRV' struct.
*/
typedef struct
{
   ...
   /* L9530 6818-specific state info. */
   int                              chan;                  /* SLIC channel ID              */
   XDRV_APM                        *pApmDrv;               /* Pointer to APM driver structure */
   SLICCFG_6818_L9530_PIN_INFO      pinInfo;               /* SLIC pin information */
   SLICCFG_6818_L9530_CONNECT_INFO  slicCfgInfo;           /* SLIC conectivity configuration structure */
