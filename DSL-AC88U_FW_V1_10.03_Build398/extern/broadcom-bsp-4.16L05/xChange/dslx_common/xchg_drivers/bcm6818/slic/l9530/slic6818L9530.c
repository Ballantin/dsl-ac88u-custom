...
/* Private Functions */
static void OpenSlic( SLIC_6818_L9530_DRV *pDev );
static void CloseSlic( SLIC_6818_L9530_DRV *pDev );
static void SetIOCtrl( SLIC_6818_L9530_DRV *pDev, int mode );
static void SetState( SLIC_6818_L9530_DRV *pDev, int mode );
static XDRV_APM_HVG_VOLTAGE GetVoltage( XDRV_UINT16 mode );
static void SetupGpioControl( SLIC_6818_L9530_DRV *pDev, const SLICCFG_6818_L9530_PIN_INFO* pSlicPinInfo );
static void SetupGpioRegs( XDRV_UINT32 pin, XDRV_UINT32* ctrlp, XDRV_UINT32* datap, XDRV_UINT32* mask );
static XDRV_UINT64 ConvertBpinsToMask( SLICCFG_6818_L9530_PIN_INFO* pDev, XDRV_UINT32 value );

extern spinlock_t bcm_gpio_spinlock;

/*
*****************************************************************************
** FUNCTION:   slic6818L9530Init
**
...
*****************************************************************************
*/
void slic6818L9530Init
(
   SLIC_6818_L9530_DRV              *pDev,
   int                              chan,
   const SLICCFG_6818_L9530_PIN_INFO *pSlicPinInfo,
   XDRV_APM                         *pApmDrv
)
{
...
*****************************************************************************
*/
void slic6818L9530Deinit( SLIC_6818_L9530_DRV *pDev )
{
   if (!pDev->bDrvEnabled)
   {
...
static XDRV_BOOL slicIsOffhook( XDRV_SLIC *pDrv )
{
   SLIC_6818_L9530_DRV *pDev  = (SLIC_6818_L9530_DRV *)pDrv;
...
static void SetIOCtrl( SLIC_6818_L9530_DRV *pDev, int value )
{
   XDRV_UINT64 slicData;
...
*****************************************************************************
*/
static XDRV_UINT64 ConvertBpinsToMask( SLICCFG_6818_L9530_PIN_INFO* pinInfo, XDRV_UINT32 value )
{
   XDRV_UINT64 mask = 0;
   XDRV_UINT8  bit;
...
/*
*****************************************************************************
** FUNCTION:   slic6818L9530UpdateState
**
...
*****************************************************************************
*/
void slic6818L9530UpdateState( SLIC_6818_L9530_DRV *pDev )
{
   if( pDev->pendingSlicTime > 0 )
   {
