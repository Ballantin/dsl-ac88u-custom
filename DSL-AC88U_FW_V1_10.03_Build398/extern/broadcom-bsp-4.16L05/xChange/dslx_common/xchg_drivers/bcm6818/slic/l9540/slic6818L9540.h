...
#ifndef SLIC_6818_L9540_H
#define SLIC_6818_L9540_H
...
} SLICCFG_6818_L9540_CONNECT_INFO;


/*
** 6818 L9540 SLIC driver structure. Conceptually, this structure is similar to
...
**
** L9540 SLIC driver state that is specific to the 6818 should be stored in the
** 'SLIC_6818_L9540_DRV' structure. A pointer to 'XDRV_SLIC_FUNCS' must be the first
** member of the 'SLIC_6818_L9540_DRV' struct.
*/
typedef struct
{
   ...
   /* L9540 6818-specific state info. */
   int                              chan;                  /* SLIC channel ID              */
   XDRV_APM                        *pApmDrv;               /* Pointer to APM driver structure */
   SLICCFG_6818_L9540_CONNECT_INFO  slicCfgInfo;           /* SLIC conectivity configuration structure */
...
(
   ...
   int                              chan,
   const SLICCFG_6818_L9540_CONNECT_INFO *pSlicCfgInfo,
   XDRV_APM                         *pApmDrv
);
...
/*
*****************************************************************************
** FUNCTION:   slic3383L9540SetTestLoad
**
