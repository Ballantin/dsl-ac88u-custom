...
****************************************************************************
*
*    Filename: boot6818Vector.c
*
****************************************************************************
*    Description:
*
*     This file contains the exception/interrupt vector (and installation
*     code) used to bootload the secondary thread-processor on the 6818.
*
...
/*
** This code was lifted from the 6818 BFC BSP. It's currently not required 
...
#*     boot6818SendIpc:                                                 *
#*                                                                      *
#*      SYNTAX: void boot6818SendIpc(void *pIpcStruct);                 *
#*     RETURNS: Nothing                                                 *
#*                                                                      *
#************************************************************************
    .globl  boot6818SendIpc
    .ent    boot6818SendIpc
boot6818SendIpc:
    .set    noreorder
