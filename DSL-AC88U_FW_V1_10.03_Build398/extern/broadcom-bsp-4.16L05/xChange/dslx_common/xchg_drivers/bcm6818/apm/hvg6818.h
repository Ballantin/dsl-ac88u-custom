...
typedef HvgControlRegisters BCM6818_HVG;

#define BCM6818_HVG_PTR           ((volatile BCM6818_HVG *)APM_HVG_BASE)
...
int hvg6818UpdateSlicStatus( XDRV_APM *pApmDrv, int chan, int slicState, int dcOffset, int battery, int loopCurrent, XDRV_BOOL ringStop );
