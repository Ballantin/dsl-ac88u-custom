...
*****************************************************************************
*
*  apm6818_dsp.h - BCM6818 APM Definitions for the DSP only
*
*  PURPOSE:
*
*  NOTES:
...
#ifndef APM6818_DSP_H
#define APM6818_DSP_H
...
#define BCM6818_APM_CH_MIN          0
#define BCM6818_APM_CH_MAX          1
#define BCM6818_APM_CH_NUM          (BCM6818_APM_CH_MAX - BCM6818_APM_CH_MIN + 1)
...
#define BCM6818_CHANNEL_0_ONLY           0  /* APM Ch0 Rx */
#define BCM6818_CHANNEL_1_ONLY           0  /* APM Ch0 Tx */

/*
** BCM6818 APM Register Structure and definitions
*/
typedef struct
{
...
#define   BCM6818_RING_OFFSET_A                   0x000000ff    //
#define   BCM6818_RING_OFFSET_A_SHIFT             0

#define   BCM6818_RING_SCALE_A                    0x0000ff00    //
#define   BCM6818_RING_SCALE_A_SHIFT              8

#define   BCM6818_RING_OFFSET_B                   0x00ff0000    //
#define   BCM6818_RING_OFFSET_B_SHIFT             16

#define   BCM6818_RING_SCALE_B                    0xff000000    //
#define   BCM6818_RING_SCALE_B_SHIFT              24

  XDRV_UINT32        reg_ring_config_2;                      // (0x94)
#define   BCM6818_RING_CLIP_A                     0x00007fff    //15 bit number defining the clipping value to flatten
#define   BCM6818_RING_CLIP_A_SHIFT               0

#define   BCM6818_RING_GEN_ENABLE_A               0x00008000    //1=enabled
#define   BCM6818_RING_GEN_ENABLE_A_SHIFT         15

#define   BCM6818_RING_CLIP_B                     0x7fff0000    //15 bit number defining the clipping value to flatten
#define   BCM6818_RING_CLIP_B_SHIFT               16

#define   BCM6818_RING_GEN_ENABLE_B               0x80000000    //1=enabled
#define   BCM6818_RING_GEN_ENABLE_B_SHIFT         31
...
#define   BCM6818_RING_BREAK_PHASE_A              0x003f0000    //break phase
#define   BCM6818_RING_BREAK_PHASE_A_SHIFT        16

#define   BCM6818_RING_BREAK_PHASE_B              0x0fc00000    //break phase
#define   BCM6818_RING_BREAK_PHASE_B_SHIFT        22
...
#define   BCM6818_DPLL_K0_SHIFT                   8
   ...
   /* PCM registers - these are detailed in pcm6818.h */
   /* HVG registers - these are detailed in hvg6818.h */
} BCM6818_APM;

#define BCM6818_APM_PTR               ((volatile BCM6818_APM *)BCM6818_APM_BASE)


#define BCM6818_DMA_RX_NUM_BUFFERS    2     /* Only need two buffers for double buffering */
#define BCM6818_DMA_TX_NUM_BUFFERS    2     /* Only need two buffers for double buffering */

#define APM6818_DMA_MAX_BUFFER_SIZE 48    /* This is in 32-bit words.
