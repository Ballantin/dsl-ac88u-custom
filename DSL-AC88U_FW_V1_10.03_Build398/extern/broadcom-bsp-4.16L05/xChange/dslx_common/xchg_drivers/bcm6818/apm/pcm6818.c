...
****************************************************************************
*
*    Description:  PCM device driver for BCM6818
*
****************************************************************************/
...
static PCM6818_DMA_BUFFER dmaRxData[PCM6818_NUM_CHANNELS*DMA_RX_NUM_BUFFERS];
static PCM6818_DMA_BUFFER dmaTxData[PCM6818_NUM_CHANNELS*DMA_TX_NUM_BUFFERS];

/* DMA Channel info (simplex - one way) for easy access to DMA channels */
typedef struct PCM6818_DMA_SIMPLEX_CHANNEL_INFO
{
   ...
   PCM6818_DMA_BUFFER   *dmaDatap;     /* Where are the DMA buffers to store/fetch the data to/from for each channel */
   DMA_HANDLE           dmaBufHandle;
} PCM6818_DMA_SIMPLEX_CHANNEL_INFO;

/* DMA Channel info (duplex - both ways) for easy access to DMA channels */
typedef struct PCM6818_DMA_DUPLEX_CHANNEL_INFO
{
   PCM6818_DMA_SIMPLEX_CHANNEL_INFO rxChan;  /* RX channel */
   PCM6818_DMA_SIMPLEX_CHANNEL_INFO txChan;  /* TX channel */
} PCM6818_DMA_DUPLEX_CHANNEL_INFO;

#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 4, 0)
extern struct dma_pool *pcm_dma_pool;
#endif
/* Initialized DMA channel info */
static PCM6818_DMA_DUPLEX_CHANNEL_INFO gPcmDmaInfo[PCM6818_NUM_CHANNELS] =
{
   {
      /* RX Channel 0 */
      {
         BCM6818_APM_IUDMA_PCM_RX,
...
static int pcm6818_clkInit( void );
static int pcm6818_regInit( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap );
static int pcm6818_regDeinit ( void );
static void PcmTsAllocate( int chnum, int ts);
static int pcm6818_iudmaInit( void );
static int pcm6818_iudmaDeinit( void );
static int pcm6818_dmaDescrInit( void );
static int  pcm6818_dmaDescrDeinit(void);
static int pcm6818_enable( int chan_mask );
static int pcm6818_disable( void );
...
void printRegs( void )
{
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[4].intMask = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[4].intMask));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[5].intMask = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[5].intMask));
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[4].intStat = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[4].intStat));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[5].intStat = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[5].intStat));
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->regs.ctrlConfig = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->regs.ctrlConfig));

   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[4].maxBurst                  = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[4].maxBurst                 ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[4].config                    = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[4].config                   ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[4].baseDescPointer          = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[4].baseDescPointer         ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[4].stateBytesDoneRingOffset = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[4].stateBytesDoneRingOffset));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[4].flagsLengthStatus        = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[4].flagsLengthStatus       ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[4].currentBufferPointer     = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[4].currentBufferPointer    ));

   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[5].maxBurst                  = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[5].maxBurst                 ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->ctrl[5].config                    = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->ctrl[5].config                   ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[5].baseDescPointer          = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[5].baseDescPointer         ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[5].stateBytesDoneRingOffset = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[5].stateBytesDoneRingOffset));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[5].flagsLengthStatus        = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[5].flagsLengthStatus       ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6818_APM_IUDMA_PTR->stram[5].currentBufferPointer     = 0x%08X ", (unsigned int)BCM6818_APM_IUDMA_PTR->stram[5].currentBufferPointer    ));
}

/*****************************************************************************
*
*  FUNCTION: pcm6818_init
*
*  PURPOSE:
*      Intialize 6818 PCM Module
*
...
*
*****************************************************************************/
int pcm6818_init( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap, XDRV_UINT32 channelMask, XDRV_UINT8 supportMode  )
{
   gPcmSpecialMode = supportMode;

   XDRV_LOG_INFO(( XDRV_LOG_MOD_PCM, "------------------ PCM CONFIGURATION START ------------------ "));

   /* Enable clocks for PCM block. Also enable APM clocks just in case they werent */
   PERF->blkEnables |= APM_AUDIO_UBUS_CLKEN |
                       APM_AUDIO_A_CLKEN |
                       APM_AUDIO_B_CLKEN |
                       APM_BMU_CLKEN |
                       APM_AUDIO_COMMON_CLKEN;

   PERF->blkEnables |= APM_PCM_CLKEN;


   /* Setup GPIO 25:22 for PCM functionality on 6818 */
   GPIO->GPIOMode |= GPIO_MODE_APM_PCM_CLK | GPIO_MODE_APM_PCM_SDIN | GPIO_MODE_APM_PCM_SDOUT | GPIO_MODE_APM_PCM_FS;

   /* Disable HVW_MAX_PWM output as the pin is muxed with GPIO used for resetline -- TODO: Move this to boardhal */
   ...
   pcm6818_regInit( chanTsMap );

   pcm6818_enable( channelMask );

   pcm6818_dmaDescrInit();
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_deinit
*
*  PURPOSE:
*      Deintialize 6818 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
*
*****************************************************************************/
int pcm6818_deinit( void )
{
   pcm6818_disable();

   pcm6818_iudmaDeinit();

   pcm6818_dmaDescrDeinit();
...
static int pcm6818_clkInit( void )
{
  ...
  unsigned int muxControl;
   /* This code assumes that the DPLL was initialized already in the apm_pllStart() in apm6818.c */

   XDRV_LOG_INFO(( XDRV_LOG_MOD_PCM, "Set up PCM registers to generate PCM clock"));

   if ( gPcmSpecialMode & MODE_ISI )
   {  /* Settings with ISI */
      PCM->reg_pcm_clk_cntl_1 = 0x5FFEE88A;        // PCM_NCO clk_out = 24.576Mhz. NOTE: This value is based on o/p DPLL fcw of 0xA7C41D22.
      PCM->pcm_msif_intf      = 0x00000001;        // R_MSIF_ENABLE = 1
   }
   else if ( gPcmSpecialMode & MODE_ZSI )
   {  /* Settings with ZSI */
      PCM->reg_pcm_clk_cntl_1 = 0xBFFDA8CC;        // PCM_NCO clk_out = 49.152Mhz. NOTE: This value is based on o/p DPLL fcw of 0xA7C41D22.
      PCM->pcm_zds_intf       = 0x00000001;        // R_ZDS_ENABLE = 1
   }
   else
   {  /* Settings with normal PCM operation */
      PCM->reg_pcm_clk_cntl_1 = 0x3FFF4007;        // PCM_NCOclk_out = 16.384Mhz. NOTE: This value is based on o/p DPLL fcw of 0xA7C41D22.
   }

   PERF->blkEnables |= APM_SPI_SCLK_EN;
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_regInit
*
*  PURPOSE:
*      Intialize 6818 PCM Module Registers
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6818_regInit( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap )
{
   volatile BCM6818_APM *pApm = BCM6818_APM_PTR;
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_enable
*
*  PURPOSE:
*      Enable 6818 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
*
*****************************************************************************/
int pcm6818_enable( int chan_mask )
{
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_disable
*
*  PURPOSE:
*      Disable 6818 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_iudmaInit
*
*  PURPOSE:
*      Intialize 6818 IUDMA registers.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
{
   int chnum;
   volatile BCM6818_IUDMA *iuDmap = BCM6818_APM_IUDMA_PTR;

   /* Initialize the Rx/Tx IUDMA pair for PCM channel */
   for (chnum=0; chnum < PCM6818_NUM_CHANNELS; chnum++)
   {
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].intMask = BCM6818_IUDMA_INTMASK_BDONE | BCM6818_IUDMA_INTMASK_NOTVLD;
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].intMask = BCM6818_IUDMA_INTMASK_BDONE | BCM6818_IUDMA_INTMASK_NOTVLD;
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_iudmaDeinit
*
*  PURPOSE:
*      De-intialize 6818 IUDMA registers.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6818_iudmaDeinit( void)
{
   ...
   for (chnum=0; chnum < PCM6818_NUM_CHANNELS; chnum++)
   {
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config = ( BCM6818_IUDMA_CONFIG_BURSTHALT );

      while( (iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config & BCM6818_IUDMA_CONFIG_ENDMA) != 0x00000000 )
      {
         /* Set the burstHalt bit while clearing endma bit */
         iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config = ( BCM6818_IUDMA_CONFIG_BURSTHALT );
      ...
      /* Set the burstHalt bit while clearing endma bit */
      iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config = ( BCM6818_IUDMA_CONFIG_BURSTHALT );

      while( (iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config & BCM6818_IUDMA_CONFIG_ENDMA) != 0x00000000 )
      {
         /* Set the burstHalt bit while clearing endma bit */
         iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config = ( BCM6818_IUDMA_CONFIG_BURSTHALT );
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_dmaDescrInit
*
*  PURPOSE:
*      Intialize 6818 DMA descriptors.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6818_dmaDescrInit( void )
{
   ...
   volatile PCM6818_DMA_BUFFER*     dmaRxData;
   volatile PCM6818_DMA_BUFFER*     dmaTxData;
   PCM6818_DMA_SIMPLEX_CHANNEL_INFO *dmaChanInfop;
   ...
   rxDescriptorArea = sizeof(BCM6818_IUDMA_DESC) * PCM6818_NUM_CHANNELS * DMA_RX_NUM_BUFFERS + sizeof(XDRV_UINT8) * BCM6818_DMA_UBUS_BYTES;
   txDescriptorArea = sizeof(BCM6818_IUDMA_DESC) * PCM6818_NUM_CHANNELS * DMA_TX_NUM_BUFFERS + sizeof(XDRV_UINT8) * BCM6818_DMA_UBUS_BYTES;
   ...
   for (i=0; i < PCM6818_NUM_CHANNELS; i++)
   {
      ...
      gPcmDmaInfo[i].rxChan.dmaDescp = (BCM6818_IUDMA_DESC*)(dmaRxDesc_c + i * DMA_RX_NUM_BUFFERS);
      gPcmDmaInfo[i].txChan.dmaDescp = (BCM6818_IUDMA_DESC*)(dmaTxDesc_c + i * DMA_TX_NUM_BUFFERS);
   }
   ...
   rxBufferArea = sizeof(XDRV_UINT32) * (PCM6818_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32) * PCM6818_NUM_CHANNELS * DMA_RX_NUM_BUFFERS;
   txBufferArea = sizeof(XDRV_UINT32) * (PCM6818_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32) * PCM6818_NUM_CHANNELS * DMA_TX_NUM_BUFFERS;
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 4, 0)
   ...
   for (i=0; i < PCM6818_NUM_CHANNELS; i++)
   {
      gPcmDmaInfo[i].rxChan.dmaDatap = (PCM6818_DMA_BUFFER*)(dmaRxData + i * DMA_RX_NUM_BUFFERS);
      gPcmDmaInfo[i].txChan.dmaDatap = (PCM6818_DMA_BUFFER*)(dmaTxData + i * DMA_TX_NUM_BUFFERS);
   }
   ...
   for (chnum=0; chnum < PCM6818_NUM_CHANNELS; chnum++)
   {
      ...
      for( i = 0; i < DMA_TX_NUM_BUFFERS; i++ )
      {
         ...
         bufferSizeBytes = PCM6818_DMA_MAX_BUFFER_SIZE_BYTES;
         ...
         if (bufferSizeBytes <= PCM6818_DMA_MAX_BUFFER_SIZE_BYTES)
         {
         ...
         else
         {
            ...
            ** You can either increase the compile time buffer size (PCM6818_DMA_MAX_BUFFER_SIZE),
...
/*****************************************************************************
*
*  FUNCTION: pcm6818_dmaDescrDeinit
*
*  PURPOSE:
*      Deintialize 6818 DMA descriptors.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6818_dmaDescrDeinit( void )
{
   ...
   rxDescriptorArea = sizeof(BCM6818_IUDMA_DESC) * PCM6818_NUM_CHANNELS * DMA_RX_NUM_BUFFERS;
   txDescriptorArea = sizeof(BCM6818_IUDMA_DESC) * PCM6818_NUM_CHANNELS * DMA_TX_NUM_BUFFERS;
