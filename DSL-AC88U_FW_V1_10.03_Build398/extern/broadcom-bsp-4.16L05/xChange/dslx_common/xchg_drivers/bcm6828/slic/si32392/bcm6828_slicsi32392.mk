...
###########################################################################
#
# This makefile is used to build the bcm6828_slicsi32392 module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6828_slicsi32392

BCM6828_SLIC_SI32392_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))

#
# We use notdir and vpath so that the object files don't wind up in
# nested subdirectories
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6828_SLIC_SI32392_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6828_SLIC_SI32392_ROOT)

#all:
#	@echo "------kevin----32392--------->>>>>>>>>>>>>>>>>>>>>>>>>>>>"
#	@echo "XCHG_LIB_BASE="$(XCHG_LIB_BASE)
#	@echo "BCM6828_SLIC_SI3239_ROOT="$(XDRV_DIR_$(XCHG_LIB_BASE))
#	@echo "BCM6828_SLIC_SI32392_ROOT="$(BCM6828_SLIC_SI32392_ROOT)
#	@echo "------------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>"
