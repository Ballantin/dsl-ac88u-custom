...
###########################################################################
#
# This makefile is used to build the bcm6828_slicsi3239 module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6828_slicsi3239

BCM6828_SLIC_SI3239_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6828_SLIC_SI3239_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6828_SLIC_SI3239_ROOT)
