...
*
****************************************************************************/
#ifndef MSPI6828DEFS_H 
#define MSPI6828DEFS_H
...
#define MSPI6828_MAX_RX_SIZE                1088
                                   
#define BCM6828_MSPI_TX_QUEUE_SIZE           544
#define BCM6828_MSPI_RX_QUEUE_SIZE           544

#define MMR6828_MSPI_INTSTATUS_CMNDDONE     0x01
#define MMR6828_MSPI_INTSTATUS_RXOVERFL     0x02
#define MMR6828_MSPI_INTSTATUS_TXUNDRFL     0x04
#define MMR6828_MSPI_INTSTATUS_TXOVERFL     0x08
#define MMR6828_MSPI_INTSTATUS_RXUNDRFl     0x10
#define MMR6828_MSPI_INTSTATUS_MASK         0x1F

#define MMR6828_MSPI_START_NOOP             0x00
#define MMR6828_MSPI_START_SOFT_RESET       0x01
#define MMR6828_MSPI_START_HARD_RESET       0x02
#define MMR6828_MSPI_START_IMMEDIATE        0x03
#define MMR6828_MSPI_START_NONBUF           0x0F

#define MMR6828_MSPI_STATUS_RXEMPTY         0x02
#define MMR6828_MSPI_STATUS_CMDBUSY         0x04
#define MMR6828_MSPI_STATUS_SERBUSY         0x08
...
typedef struct
{
   volatile SpiControl *p6828SpiRegs;
   ...
   XDRV_UINT8   rxBuf[ MSPI6828_MAX_RX_SIZE ];
   unsigned     rxOffset;
...
typedef void (*MSPI6828_ISR)(void *contextP);
#endif /* MSPI6828_USE_INTERRUPTS */

/* ---- Variable Externs ------------------------------------- */

extern BCM_MSPI6828_DRV  mspi6828Drv;
extern BCM_MSPI6828_REGS mspi6828Registers;

#if MSPI6828_USE_INTERRUPTS
extern BOS_SEM           mspi6828IsrSem;
#endif /* MSPI6828_USE_INTERRUPTS */

/* ---- Function Prototypes ---------------------------------- */

#if MSPI6828_USE_INTERRUPTS
unsigned int mspi6828Isr( XDRV_INT_CTRL_ISR_PARM contextp );
#endif /* MSPI6828_USE_INTERRUPTS */
