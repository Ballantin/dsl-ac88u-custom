...
*
****************************************************************************/
#ifndef MSPI6828_H    /* support nested includes */
#define MSPI6828_H
...
typedef enum
{
   BCM_MSPI6828_INITREGS_CMD,
   BCM_MSPI6828_SETREGS_CMD,
   BCM_MSPI6828_GETREGS_CMD,
   BCM_MSPI6828_RXCALLBACK_INSTALL_CMD,
   BCM_MSPI6828_TXCALLBACK_INSTALL_CMD

} BCM_MSPI6828_CMD;

/*************************************************************************
**                   MSPI6828 REGISTERS AND DEFINES                     **
*************************************************************************/
...
#define MSPI6828_USE_INTERRUPTS 0

typedef enum
{
   BCM_MSPI6828_CTRL_MODE_POLLING,
   BCM_MSPI6828_CTRL_MODE_INTERRUPT

} BCM_MSPI6828_CTRL_MODE;

typedef struct BCM_MSPI6828_REGS
{
   ...
   BCM_MSPI6828_CTRL_MODE       mspiCtrlMode;
...
extern int mspiIOctl( BCM_MSPI6828_CMD command, void *cmdp );
