...
BOS_SEM           mspi6828IsrSem;   /* MSPI ISR semaphore */
#endif /* MSPI6828_USE_INTERRUPTS */

BCM_MSPI6828_DRV  mspi6828Drv;      /* MSPI Driver */
...
int mspiInit( void )
{
   ...
   bosSemCreate( "MSPI6828ISR", 0, 1, &mspi6828IsrSem ); 
...
#if 0  /** NOTE: SPI enable should be fixed for 6828 */
   /* Enable SPI Block */
   SpiClockControl( 1, 1 );
#endif    
