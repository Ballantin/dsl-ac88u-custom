...
###########################################################################
#
# This makefile is used to build the bcm6828_boot module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6828_boot

BCM6828_BOOT_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6828_BOOT_ROOT)/*.c $(BCM6828_BOOT_ROOT)/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6828_BOOT_ROOT)
vpath %.s $(BCM6828_BOOT_ROOT)
