...
****************************************************************************
*
*    Filename: boot6828Vector.c
*
****************************************************************************
*    Description:
*
*     This file contains the exception/interrupt vector (and installation
*     code) used to bootload the secondary thread-processor on the 6828.
*
...
/*
** This code was lifted from the 6828 BFC BSP. It's currently not required 
...
#*     boot6828SendIpc:                                                 *
#*                                                                      *
#*      SYNTAX: void boot6828SendIpc(void *pIpcStruct);                 *
#*     RETURNS: Nothing                                                 *
#*                                                                      *
#************************************************************************
    .globl  boot6828SendIpc
    .ent    boot6828SendIpc
boot6828SendIpc:
    .set    noreorder
