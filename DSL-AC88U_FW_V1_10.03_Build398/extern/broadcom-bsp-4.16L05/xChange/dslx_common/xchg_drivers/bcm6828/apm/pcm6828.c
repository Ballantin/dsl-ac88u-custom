...
****************************************************************************
*
*    Description:  PCM device driver for BCM6828
*
****************************************************************************/
...
static PCM6828_DMA_BUFFER dmaRxData[PCM6828_NUM_CHANNELS*DMA_RX_NUM_BUFFERS];
static PCM6828_DMA_BUFFER dmaTxData[PCM6828_NUM_CHANNELS*DMA_TX_NUM_BUFFERS];

/* DMA Channel info (simplex - one way) for easy access to DMA channels */
typedef struct PCM6828_DMA_SIMPLEX_CHANNEL_INFO
{
   ...
   PCM6828_DMA_BUFFER   *dmaDatap;     /* Where are the DMA buffers to store/fetch the data to/from for each channel */
   DMA_HANDLE           dmaBufHandle;
} PCM6828_DMA_SIMPLEX_CHANNEL_INFO;

/* DMA Channel info (duplex - both ways) for easy access to DMA channels */
typedef struct PCM6828_DMA_DUPLEX_CHANNEL_INFO
{
   PCM6828_DMA_SIMPLEX_CHANNEL_INFO rxChan;  /* RX channel */
   PCM6828_DMA_SIMPLEX_CHANNEL_INFO txChan;  /* TX channel */
} PCM6828_DMA_DUPLEX_CHANNEL_INFO;

#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 4, 0)
extern struct dma_pool *pcm_dma_pool;
#endif
/* Initialized DMA channel info */
static PCM6828_DMA_DUPLEX_CHANNEL_INFO gPcmDmaInfo[PCM6828_NUM_CHANNELS] =
{
   {
      /* RX Channel 0 */
      {
         BCM6828_APM_IUDMA_PCM_RX,
...
static int pcm6828_clkInit( void );
static int pcm6828_regInit( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap );
static int pcm6828_regDeinit ( void );
static void PcmTsAllocate( int chnum, int ts);
static int pcm6828_iudmaInit( void );
static int pcm6828_iudmaDeinit( void );
static int pcm6828_dmaDescrInit( void );
static int  pcm6828_dmaDescrDeinit(void);
static int pcm6828_enable( int chan_mask );
static int pcm6828_disable( void );
...
void printRegs( void )
{
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[4].intMask = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[4].intMask));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[5].intMask = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[5].intMask));
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[4].intStat = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[4].intStat));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[5].intStat = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[5].intStat));
   ...
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->regs.ctrlConfig = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->regs.ctrlConfig));

   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[4].maxBurst                  = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[4].maxBurst                 ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[4].config                    = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[4].config                   ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[4].baseDescPointer          = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[4].baseDescPointer         ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[4].stateBytesDoneRingOffset = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[4].stateBytesDoneRingOffset));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[4].flagsLengthStatus        = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[4].flagsLengthStatus       ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[4].currentBufferPointer     = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[4].currentBufferPointer    ));

   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[5].maxBurst                  = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[5].maxBurst                 ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->ctrl[5].config                    = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->ctrl[5].config                   ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[5].baseDescPointer          = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[5].baseDescPointer         ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[5].stateBytesDoneRingOffset = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[5].stateBytesDoneRingOffset));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[5].flagsLengthStatus        = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[5].flagsLengthStatus       ));
   XDRV_LOG_DBG((XDRV_LOG_MOD_PCM, "BCM6828_APM_IUDMA_PTR->stram[5].currentBufferPointer     = 0x%08X ", (unsigned int)BCM6828_APM_IUDMA_PTR->stram[5].currentBufferPointer    ));
}

/*****************************************************************************
*
*  FUNCTION: pcm6828_init
*
*  PURPOSE:
*      Intialize 6828 PCM Module
*
...
*
*****************************************************************************/
int pcm6828_init( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap, XDRV_UINT32 channelMask, XDRV_UINT8 supportMode  )
{
   ...
   /* Setup GPIO 25:22 for PCM functionality on 6828 */
   ...
   pcm6828_regInit( chanTsMap );

   pcm6828_enable( channelMask );

   pcm6828_dmaDescrInit();
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_deinit
*
*  PURPOSE:
*      Deintialize 6828 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
*
*****************************************************************************/
int pcm6828_deinit( void )
{
   pcm6828_disable();

   pcm6828_iudmaDeinit();

   pcm6828_dmaDescrDeinit();
...
static int pcm6828_clkInit( void )
{
  unsigned int muxControl = 0;

   /* This code assumes that the DPLL was initialized already in the apm_pllStart() in apm6828.c */
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_regInit
*
*  PURPOSE:
*      Intialize 6828 PCM Module Registers
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6828_regInit( PCM_CHANNEL_TIMESLOT_MAP* chanTsMap )
{
   volatile BCM6828_APM *pApm = BCM6828_APM_PTR;
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_enable
*
*  PURPOSE:
*      Enable 6828 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
*
*****************************************************************************/
int pcm6828_enable( int chan_mask )
{
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_disable
*
*  PURPOSE:
*      Disable 6828 PCM Module
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_iudmaInit
*
*  PURPOSE:
*      Intialize 6828 IUDMA registers.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
{
   int chnum;
   volatile BCM6828_IUDMA *iuDmap = BCM6828_APM_IUDMA_PTR;

   /* Initialize the Rx/Tx IUDMA pair for PCM channel */
   for (chnum=0; chnum < PCM6828_NUM_CHANNELS; chnum++)
   {
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].intMask = BCM6828_IUDMA_INTMASK_BDONE | BCM6828_IUDMA_INTMASK_NOTVLD;
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].intMask = BCM6828_IUDMA_INTMASK_BDONE | BCM6828_IUDMA_INTMASK_NOTVLD;
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_iudmaDeinit
*
*  PURPOSE:
*      De-intialize 6828 IUDMA registers.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6828_iudmaDeinit( void)
{
   ...
   for (chnum=0; chnum < PCM6828_NUM_CHANNELS; chnum++)
   {
      ...
      iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config = ( BCM6828_IUDMA_CONFIG_BURSTHALT );

      while( (iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config & BCM6828_IUDMA_CONFIG_ENDMA) != 0x00000000 )
      {
         /* Set the burstHalt bit while clearing endma bit */
         iuDmap->ctrl[gPcmDmaInfo[chnum].rxChan.iuChanNum].config = ( BCM6828_IUDMA_CONFIG_BURSTHALT );
      ...
      /* Set the burstHalt bit while clearing endma bit */
      iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config = ( BCM6828_IUDMA_CONFIG_BURSTHALT );

      while( (iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config & BCM6828_IUDMA_CONFIG_ENDMA) != 0x00000000 )
      {
         /* Set the burstHalt bit while clearing endma bit */
         iuDmap->ctrl[gPcmDmaInfo[chnum].txChan.iuChanNum].config = ( BCM6828_IUDMA_CONFIG_BURSTHALT );
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_dmaDescrInit
*
*  PURPOSE:
*      Intialize 6828 DMA descriptors.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6828_dmaDescrInit( void )
{
   ...
   volatile PCM6828_DMA_BUFFER*     dmaRxData;
   volatile PCM6828_DMA_BUFFER*     dmaTxData;
   PCM6828_DMA_SIMPLEX_CHANNEL_INFO *dmaChanInfop;
   ...
   rxDescriptorArea = sizeof(BCM6828_IUDMA_DESC) * PCM6828_NUM_CHANNELS * DMA_RX_NUM_BUFFERS + sizeof(XDRV_UINT8) * BCM6828_DMA_UBUS_BYTES;
   txDescriptorArea = sizeof(BCM6828_IUDMA_DESC) * PCM6828_NUM_CHANNELS * DMA_TX_NUM_BUFFERS + sizeof(XDRV_UINT8) * BCM6828_DMA_UBUS_BYTES;
   ...
   for (i=0; i < PCM6828_NUM_CHANNELS; i++)
   {
      ...
      gPcmDmaInfo[i].rxChan.dmaDescp = (BCM6828_IUDMA_DESC*)(dmaRxDesc_c + i * DMA_RX_NUM_BUFFERS);
      gPcmDmaInfo[i].txChan.dmaDescp = (BCM6828_IUDMA_DESC*)(dmaTxDesc_c + i * DMA_TX_NUM_BUFFERS);
   }
   ...
   rxBufferArea = sizeof(XDRV_UINT32) * (PCM6828_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32) * PCM6828_NUM_CHANNELS * DMA_RX_NUM_BUFFERS;
   txBufferArea = sizeof(XDRV_UINT32) * (PCM6828_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32) * PCM6828_NUM_CHANNELS * DMA_TX_NUM_BUFFERS;
   ...
   for (i=0; i < PCM6828_NUM_CHANNELS; i++)
   {
      gPcmDmaInfo[i].rxChan.dmaDatap = (PCM6828_DMA_BUFFER*)(dmaRxData + i * DMA_RX_NUM_BUFFERS);
      gPcmDmaInfo[i].txChan.dmaDatap = (PCM6828_DMA_BUFFER*)(dmaTxData + i * DMA_TX_NUM_BUFFERS);
   }
   ...
   for (chnum=0; chnum < PCM6828_NUM_CHANNELS; chnum++)
   {
      ...
      for( i = 0; i < DMA_TX_NUM_BUFFERS; i++ )
      {
         ...
         bufferSizeBytes = PCM6828_DMA_MAX_BUFFER_SIZE_BYTES;
         ...
         if (bufferSizeBytes <= PCM6828_DMA_MAX_BUFFER_SIZE_BYTES)
         {
         ...
         else
         {
            ...
            ** You can either increase the compile time buffer size (PCM6828_DMA_MAX_BUFFER_SIZE),
...
/*****************************************************************************
*
*  FUNCTION: pcm6828_dmaDescrDeinit
*
*  PURPOSE:
*      Deintialize 6828 DMA descriptors.
*
*  PARAMETERS:
*
*  RETURNS: 0 on SUCCESS
...
static int pcm6828_dmaDescrDeinit( void )
{
   ...
   rxDescriptorArea = sizeof(BCM6828_IUDMA_DESC) * PCM6828_NUM_CHANNELS * DMA_RX_NUM_BUFFERS;
   txDescriptorArea = sizeof(BCM6828_IUDMA_DESC) * PCM6828_NUM_CHANNELS * DMA_TX_NUM_BUFFERS;
