...
BOS_SEM           mspi6368IsrSem;   /* MSPI ISR semaphore */
#endif /* MSPI6368_USE_INTERRUPTS */

BCM_MSPI6368_DRV  mspi6368Drv;      /* MSPI Driver */
...
*****************************************************************************
*/
int mspi6368Init( void )
{
#if MSPI6368_USE_INTERRUPTS
   /* Create semaphore for MSPI ISR's */
   bosSemCreate( "MSPI6368ISR", 0, 1, &mspi6368IsrSem ); 
...
#if 0  /** NOTE: SPI enable should be fixed for 6368 */
   /* Enable SPI Block */
   SpiClockControl( 1, 1 );
#endif    
