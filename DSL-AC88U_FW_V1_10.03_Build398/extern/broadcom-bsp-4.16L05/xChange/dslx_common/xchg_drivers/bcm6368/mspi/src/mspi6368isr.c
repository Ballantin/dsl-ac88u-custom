...
unsigned int mspi6368Isr( XDRV_INT_CTRL_ISR_PARM contextp )
{
   ...
   */
   ...
   if( !( pMspiRegs->spiIntStatus & MMR6368_MSPI_INTSTATUS_CMNDDONE ))
   {
      XCHG_ASSERT( 0 );
   }
   ...
   */
   ...
   else
   {
      ...
      */
      if( pMspiDrv->bytesRemaining >= ( BCM6368_MSPI_TX_QUEUE_SIZE - 2 ))
      {
      ...
      */
      ...
      pMspiRegs->spiIntStatus |= MMR6368_MSPI_INTSTATUS_MASK;
      pMspiRegs->spiCmd |= MMR6368_MSPI_START_IMMEDIATE;
   }
