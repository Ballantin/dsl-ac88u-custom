...
int mspi6368Open( void )
{
  ...
  /* Register an interrupt handler */
   mspi6368intc_intVectIrqIsrInstall( mspi6368Isr );
#endif /* MSPI6368_USE_INTERRUPTS */

   /*
   ** Use IOctl to set registers to default values
   */
   result = mspi6368IOctl( BCM_MSPI6368_INITREGS_CMD, NULL );
