###########################################################################
#
# This makefile is used to build the bcm6368_dlb module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6368_dlb

BCM6368_DLB_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6368_DLB_ROOT)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6368_DLB_ROOT)/src
