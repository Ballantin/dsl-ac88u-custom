...
#
XCHG_LIB_BASE     := bcm6368_boot

BCM6368_BOOT_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6368_BOOT_ROOT)/*.c $(BCM6368_BOOT_ROOT)/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6368_BOOT_ROOT)
vpath %.s $(BCM6368_BOOT_ROOT)
