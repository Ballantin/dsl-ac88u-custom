###########################################################################
#
# This makefile is used to build the bcm63268_pcm module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63268_pcm

BCM63268_PCM_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63268_PCM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63268_PCM_ROOT)
