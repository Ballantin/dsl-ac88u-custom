###########################################################################
#
# This makefile is used to build the bcm63268_boot module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm63268_boot

BCM63268_BOOT_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63268_BOOT_ROOT)/*.c $(BCM63268_BOOT_ROOT)/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63268_BOOT_ROOT)
vpath %.s $(BCM63268_BOOT_ROOT)
