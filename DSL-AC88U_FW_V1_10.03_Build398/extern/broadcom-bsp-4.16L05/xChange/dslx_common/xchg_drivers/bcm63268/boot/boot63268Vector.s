...
****************************************************************************
*
*    Filename: boot63268Vector.c
*
****************************************************************************
*    Description:
*
*     This file contains the exception/interrupt vector (and installation
*     code) used to bootload the secondary thread-processor on the 63xx.
*
...
/*
** This code was lifted from the 63xx BFC BSP. It's currently not required 
...
#*     boot63268SendIpc:                                                 *
#*                                                                      *
#*      SYNTAX: void boot63268SendIpc(void *pIpcStruct);                 *
#*     RETURNS: Nothing                                                 *
#*                                                                      *
#************************************************************************
    .globl  boot63268SendIpc
    .ent    boot63268SendIpc
boot63268SendIpc:
    .set    noreorder
