...
*
****************************************************************************/
#ifndef MSPI_H    /* support nested includes */
#define MSPI_H
...
typedef enum
{
   BCM_MSPI_INITREGS_CMD,
   BCM_MSPI_SETREGS_CMD,
   BCM_MSPI_GETREGS_CMD,
   BCM_MSPI_RXCALLBACK_INSTALL_CMD,
   BCM_MSPI_TXCALLBACK_INSTALL_CMD

} BCM_MSPI_CMD;

/*************************************************************************
**                   MSPI REGISTERS AND DEFINES                     **
*************************************************************************/
...
#define MSPI_USE_INTERRUPTS 0

typedef enum
{
   BCM_MSPI_CTRL_MODE_POLLING,
   BCM_MSPI_CTRL_MODE_INTERRUPT

} BCM_MSPI_CTRL_MODE;

typedef struct BCM_MSPI_REGS
{
   ...
   BCM_MSPI_CTRL_MODE       mspiCtrlMode;
...
extern int mspiIOctl( BCM_MSPI_CMD command, void *cmdp );
