###########################################################################
#
# This makefile is used to build the MSPI module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm63268_mspi
 
BCM63268_MSPI_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63268_MSPI_ROOT)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63268_MSPI_ROOT)/src
