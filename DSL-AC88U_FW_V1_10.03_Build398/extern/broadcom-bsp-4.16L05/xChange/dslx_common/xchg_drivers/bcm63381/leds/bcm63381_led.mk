###########################################################################
#
# This makefile is used to build the leds module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63381_led

BCM63381_LED_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM63381_LED_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM63381_LED_ROOT)
