###########################################################################
#
# This makefile is used to build the bcm63138 dect Test module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63138_dectTest

BCM63138_DECTTEST_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))

#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := \
$(notdir $(wildcard $(BCM63138_DECTTEST_ROOT)/*.c))   \
$(notdir $(wildcard $(BCM63138_DECTTEST_ROOT)/dectIP/*.c))               
...
#
vpath %.c $(BCM63138_DECTTEST_ROOT)  \
          $(BCM63138_DECTTEST_ROOT)/dectIP
