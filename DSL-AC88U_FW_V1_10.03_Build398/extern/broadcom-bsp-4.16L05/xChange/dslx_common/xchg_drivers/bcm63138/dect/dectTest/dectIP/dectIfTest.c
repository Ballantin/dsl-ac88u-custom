...
#define DECT_SHIM_TEST_BASE (DECT_SHIM_CTRL_BASE + 0xF0)
...
void SetGpioTestMode(void)
{
   bcm_set_pinmux( 42, PINMUX_1 ); /* GPIO56 - PCM_SDIN */
   bcm_set_pinmux( 43, PINMUX_1 ); /* GPIO57 - PCM_SDOUT */
}
