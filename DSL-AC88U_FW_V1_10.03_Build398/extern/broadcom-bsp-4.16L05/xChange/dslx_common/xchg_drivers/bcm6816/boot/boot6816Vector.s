...
****************************************************************************
*
*    Filename: boot6816Vector.c
*
****************************************************************************
*    Description:
*
*     This file contains the exception/interrupt vector (and installation
*     code) used to bootload the secondary thread-processor on the 6816.
*
...
/*
** This code was lifted from the 6816 BFC BSP. It's currently not required 
...
#*     boot6816SendIpc:                                                 *
#*                                                                      *
#*      SYNTAX: void boot6816SendIpc(void *pIpcStruct);                 *
#*     RETURNS: Nothing                                                 *
#*                                                                      *
#************************************************************************
    .globl  boot6816SendIpc
    .ent    boot6816SendIpc
boot6816SendIpc:
    .set    noreorder
