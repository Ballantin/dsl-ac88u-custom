...
*     MIPS thread-processor on the 6816. The bootload is performed by the
...
} BOOT6816_THREAD_PROCESSOR_IMAGE;
...
/*****************************************************************************
*
*  FUNCTION:   boot6816Init
*
*  PURPOSE:    Initializes the 6816, MIPS thread-processor bootloader.
*
*
...
*
*****************************************************************************/
int boot6816Init( XDRV_ITPC *itpcDrv );


/*****************************************************************************
*
*  FUNCTION:   boot6816Deinit
*
*  PURPOSE:    De-initializes the 6816 thread-processor bootloader.
*
*  PARAMETERS: None.
*
*  RETURNS:    0 on success
...
*
*****************************************************************************/
int boot6816Deinit( void );


/*
*****************************************************************************
** FUNCTION:   boot6816LoadImage
**
...
*****************************************************************************
*/
int boot6816LoadImage
(
   const BOOT6816_THREAD_PROCESSOR_IMAGE *image,
...
*****************************************************************************
*/
void boot6816SendIpc( void *ipcStruct );
