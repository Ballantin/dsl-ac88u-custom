...
#ifndef SLIC_6816_L9530_H
#define SLIC_6816_L9530_H
...
} SLICCFG_6816_L9530_CONNECT_INFO;


/*
** 6816 L9530 SLIC driver structure. Conceptually, this structure is similar to
...
**
** When the 6816 SLIC driver initialization function is invoked, the base HPI
...
**
** L9530 SLIC driver state that is specific to the 6816 should be stored in the
** 'SLIC_6816_L9530_DRV' structure. A pointer to 'XDRV_SLIC_FUNCS' must be the first
** member of the 'SLIC_6816_L9530_DRV' struct.
*/
typedef struct
{
   ...
   /* L9530 6816-specific state info. */
   int                              chan;                  /* SLIC channel ID              */
   XDRV_APM                        *pApmDrv;               /* Pointer to APM driver structure */
   SLICCFG_6816_L9530_PIN_INFO      pinInfo;               /* SLIC pin information */
   SLICCFG_6816_L9530_CONNECT_INFO  slicCfgInfo;           /* SLIC conectivity configuration structure */
