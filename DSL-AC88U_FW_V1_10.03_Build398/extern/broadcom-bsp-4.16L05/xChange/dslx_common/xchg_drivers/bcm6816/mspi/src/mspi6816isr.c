...
unsigned int mspi6816Isr( XDRV_INT_CTRL_ISR_PARM contextp )
{
   ...
   */
   ...
   if( !( pMspiRegs->spiIntStatus & MMR6816_MSPI_INTSTATUS_CMNDDONE ))
   {
      XCHG_ASSERT( 0 );
   }
   ...
   */
   ...
   else
   {
      ...
      */
      if( pMspiDrv->bytesRemaining >= ( BCM6816_MSPI_TX_QUEUE_SIZE - 2 ))
      {
      ...
      */
      ...
      pMspiRegs->spiIntStatus |= MMR6816_MSPI_INTSTATUS_MASK;
      pMspiRegs->spiCmd |= MMR6816_MSPI_START_IMMEDIATE;
   }
