...
int mspiClose( void )
{
   volatile BCM_MSPI6816_DRV *pMspiDrv;
   pMspiDrv = &mspi6816Drv;

   /* Reset MSPI */
   pMspiDrv->p6816SpiRegs->spiCmd |= MMR6816_MSPI_START_HARD_RESET;
   ...
   mspi6816intc_intVectIrqIsrInstall( 0 );

   /* Destroy the semaphore */
   bosSemDestroy( &mspi6816IsrSem );
#endif /* MSPI6816_USE_INTERRUPTS */
