...
*
****************************************************************************/
#ifndef MSPI6816_H    /* support nested includes */
#define MSPI6816_H
...
typedef enum
{
   BCM_MSPI6816_INITREGS_CMD,
   BCM_MSPI6816_SETREGS_CMD,
   BCM_MSPI6816_GETREGS_CMD,
   BCM_MSPI6816_RXCALLBACK_INSTALL_CMD,
   BCM_MSPI6816_TXCALLBACK_INSTALL_CMD

} BCM_MSPI6816_CMD;

/*************************************************************************
**                   MSPI6816 REGISTERS AND DEFINES                     **
*************************************************************************/
...
#define MSPI6816_USE_INTERRUPTS 0

typedef enum
{
   BCM_MSPI6816_CTRL_MODE_POLLING,
   BCM_MSPI6816_CTRL_MODE_INTERRUPT

} BCM_MSPI6816_CTRL_MODE;

typedef struct BCM_MSPI6816_REGS
{
   ...
   BCM_MSPI6816_CTRL_MODE       mspiCtrlMode;
...
extern int mspiIOctl( BCM_MSPI6816_CMD command, void *cmdp );
