###########################################################################
#
# This makefile is used to build the bcm63148 dect Test module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63148_dectTest

BCM63148_DECTTEST_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))

#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := \
$(notdir $(wildcard $(BCM63148_DECTTEST_ROOT)/*.c))   \
$(notdir $(wildcard $(BCM63148_DECTTEST_ROOT)/dectIP/*.c))               
...
#
vpath %.c $(BCM63148_DECTTEST_ROOT)  \
          $(BCM63148_DECTTEST_ROOT)/dectIP
