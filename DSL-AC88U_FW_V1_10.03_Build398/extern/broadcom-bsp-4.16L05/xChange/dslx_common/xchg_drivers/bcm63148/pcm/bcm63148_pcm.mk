###########################################################################
#
# This makefile is used to build the pcm module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm63148_pcm

BCM_PCM_ROOT            := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM_PCM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM_PCM_ROOT)
