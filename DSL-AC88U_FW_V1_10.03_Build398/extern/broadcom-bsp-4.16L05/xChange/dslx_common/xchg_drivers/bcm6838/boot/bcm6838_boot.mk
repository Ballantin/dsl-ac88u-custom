...
###########################################################################
#
# This makefile is used to build the bcm6838_boot module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6838_boot

BCM6838_BOOT_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_BOOT_ROOT)/*.c $(BCM6838_BOOT_ROOT)/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_BOOT_ROOT)
vpath %.s $(BCM6838_BOOT_ROOT)
