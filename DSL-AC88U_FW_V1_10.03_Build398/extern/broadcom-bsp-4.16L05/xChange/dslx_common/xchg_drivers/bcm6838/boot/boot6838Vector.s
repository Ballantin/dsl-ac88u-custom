...
****************************************************************************
*
*    Filename: boot6838Vector.c
*
****************************************************************************
*    Description:
*
*     This file contains the exception/interrupt vector (and installation
*     code) used to bootload the secondary thread-processor on the 6838.
*
...
/*
** This code was lifted from the 6838 BFC BSP. It's currently not required 
...
#*     boot6838SendIpc:                                                 *
#*                                                                      *
#*      SYNTAX: void boot6838SendIpc(void *pIpcStruct);                 *
#*     RETURNS: Nothing                                                 *
#*                                                                      *
#************************************************************************
    .globl  boot6838SendIpc
    .ent    boot6838SendIpc
boot6838SendIpc:
    .set    noreorder
