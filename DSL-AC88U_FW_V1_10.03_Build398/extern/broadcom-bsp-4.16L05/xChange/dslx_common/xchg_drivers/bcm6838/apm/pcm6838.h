...
****************************************************************************
*
*  hvg6838.h - BCM6838 High Voltage Generator Definitions
*
*  PURPOSE:
*
*  NOTES:
...
typedef PcmControlRegisters BCM6838_PCM;
...
*/
#   define PCM6838_DMA_MAX_BUFFER_SIZE          ( 32 * HAUSWARE_PERIOD_MS )
#   else
/* PCM ULAW */
/* For 8Khz Fsync, we have 8 samples/ms/channel
 * 8 channels  available, then we have 8 * 8 = 64 samples/ms
...
*/
#   define PCM6838_DMA_MAX_BUFFER_SIZE          ( 16 * HAUSWARE_PERIOD_MS )
#   endif
#else
/* PCM ALAW */
#define PCM6838_DMA_MAX_BUFFER_SIZE          ( 16 * HAUSWARE_PERIOD_MS )
...
#define PCM6838_DMA_MAX_BUFFER_SIZE_BYTES   (PCM6838_DMA_MAX_BUFFER_SIZE*sizeof(XDRV_UINT32))

/*#define PCM6838_DMA_MAX_BUFFER_SIZE 88 */   /* This is in 32-bit words.
                                      **  Allocate enaough for (10ms + 1ms prime) worth of 16kHz data:
                                      **   1ms=16*16-bit=8 32-bit words
                                      **  11ms=11*8*32-bit=88 32bit words */

typedef struct PCM6838_DMA_BUFFER
{
   ...
   volatile XDRV_UINT32 dmaBuff[ PCM6838_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32 ];
} PCM6838_DMA_BUFFER;
...
#define PCM6838_NUM_CHANNELS    1    /* One PCM Rx/Tx channel */
