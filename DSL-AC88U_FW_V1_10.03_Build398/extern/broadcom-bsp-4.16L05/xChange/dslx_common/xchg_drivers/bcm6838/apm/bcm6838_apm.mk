...
###########################################################################
#
# This makefile is used to build the bcm3341_apm module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6838_apm

BCM6838_APM_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_APM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_APM_ROOT)
...
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(XCHG_LINUX_ROOT)/../../bcmdrivers/opensource/char/rdpa_gpl/impl1/include \
                                          ...
                                          $(XCHG_LINUX_ROOT)/../../bcmdrivers/opensource/char/bdmf/bcm96838/system/linux/cm \
                                          $(XCHG_LINUX_ROOT)/../../bcmdrivers/opensource/char/bdmf/bcm96838/system/sim \
                                          $(XCHG_LINUX_ROOT)/../../bcmdrivers/opensource/char/bdmf/bcm96838/system/linux \
                                          $(XCHG_LINUX_ROOT)/../../bcmdrivers/opensource/char/bdmf/bcm96838/system \
                                          $(XCHG_LINUX_ROOT)/../../bcmdrivers/broadcom/char/rdpa/bcm96838/platform/sim \
...
XCHG_C_LOCAL_DEFS_$(XCHG_LIB_BASE) := USE_KERNEL_LIB
else
