...
*****************************************************************************
*
*  apm6838_dsp.h - BCM6838 APM Definitions for the DSP only
*
*  PURPOSE:
*
*  NOTES:
...
#ifndef APM6838_DSP_H
#define APM6838_DSP_H
...
#define BCM6838_APM_CH_MIN          0
#define BCM6838_APM_CH_MAX          1
#define BCM6838_APM_CH_NUM          (BCM6838_APM_CH_MAX - BCM6838_APM_CH_MIN + 1)
...
#define BCM6838_CHANNEL_0_ONLY           0  /* APM Ch0 Rx */
#define BCM6838_CHANNEL_1_ONLY           0  /* APM Ch0 Tx */

/*
** BCM6838 APM Register Structure and definitions
*/
typedef struct
{
...
#define   APM6838_HYBAL_NUM_TAPS          5
#define   APM6838_YFLTR_FIR_NUM_TAPS      18
#define   APM6838_YFLTR_IIR1_NUM_TAPS     1
#define   APM6838_YFLTR_IIR2_NUM_TAPS     5
#define   APM6838_YFLTR_BLOCK_SIZE        28
#define   APM6838_RX_EQ_NUM_TAPS          80
#define   APM6838_TX_EQ_NUM_TAPS          80
#define   APM6838_ASRC_DEC_NUM_TAPS       120
#define   APM6838_ASRC_INT_NUM_TAPS       120
...
#define   BCM6838_CLOCK_SOURCE                    0x00000000    //2 bit mux control 0=DPLL 1=misc 2=NTP 3=TRC
...
#define   BCM6838_RING_OFFSET_A                   0x000000ff    //
#define   BCM6838_RING_OFFSET_A_SHIFT             0

#define   BCM6838_RING_SCALE_A                    0x0000ff00    //
#define   BCM6838_RING_SCALE_A_SHIFT              8

#define   BCM6838_RING_OFFSET_B                   0x00ff0000    //
#define   BCM6838_RING_OFFSET_B_SHIFT             16

#define   BCM6838_RING_SCALE_B                    0xff000000    //
#define   BCM6838_RING_SCALE_B_SHIFT              24

  XDRV_UINT32        reg_ring_config_2;                      // (0x94)
#define   BCM6838_RING_CLIP_A                     0x00007fff    //15 bit number defining the clipping value to flatten
#define   BCM6838_RING_CLIP_A_SHIFT               0

#define   BCM6838_RING_GEN_ENABLE_A               0x00008000    //1=enabled
#define   BCM6838_RING_GEN_ENABLE_A_SHIFT         15

#define   BCM6838_RING_CLIP_B                     0x7fff0000    //15 bit number defining the clipping value to flatten
#define   BCM6838_RING_CLIP_B_SHIFT               16

#define   BCM6838_RING_GEN_ENABLE_B               0x80000000    //1=enabled
#define   BCM6838_RING_GEN_ENABLE_B_SHIFT         31

  XDRV_UINT32        reg_ring_config_3;                      // (0x98)
#define   BCM6838_RING_OMEGA_NORM_A               0x000000ff    //the omega man is Charlton Heston on channel A
#define   BCM6838_RING_OMEGA_NORM_A_SHIFT         0

#define   BCM6838_RING_OMEGA_NORM_B               0x0000ff00    //the omega man is Charlton Heston on channel B
#define   BCM6838_RING_OMEGA_NORM_B_SHIFT         8

#define   BCM6838_RING_BREAK_PHASE_A              0x003f0000    //break phase
#define   BCM6838_RING_BREAK_PHASE_A_SHIFT        16

#define   BCM6838_RING_BREAK_PHASE_B              0x0fc00000    //break phase
#define   BCM6838_RING_BREAK_PHASE_B_SHIFT        22

#define   BCM6838_RING_BREAK_PHASE_SIGN_A         0x10000000    //1=break phase sign
#define   BCM6838_RING_BREAK_PHASE_SIGN_A_SHIFT   28

#define   BCM6838_RING_BREAK_PHASE_SIGN_B         0x20000000    //1=break phase sign
#define   BCM6838_RING_BREAK_PHASE_SIGN_B_SHIFT   29

#define   BCM6838_RING_START_CADENCE_A            0x40000000    //1=start cadence
#define   BCM6838_RING_START_CADENCE_A_SHIFT      30

#define   BCM6838_RING_START_CADENCE_B            0x80000000    //1=start cadence
#define   BCM6838_RING_START_CADENCE_B_SHIFT      31

  XDRV_UINT32        reg_ring_config_4;                      // (0x9c)
#define   BCM6838_RING_STOP_IMMED_A               0x00000001    // stop ring now!
#define   BCM6838_RING_STOP_IMMED_A_SHIFT         0

#define   BCM6838_RING_STOP_IMMED_B               0x00000002    // stop ring now!
#define   BCM6838_RING_STOP_IMMED_B_SHIFT         1

#define   BCM6838_RING_STOP_NEXT_BREAK_A          0x00000004    // stop ring at next break
#define   BCM6838_RING_STOP_NEXT_BREAK_A_SHIFT    2

#define   BCM6838_RING_STOP_NEXT_BREAK_B          0x00000008    // stop ring at next break
#define   BCM6838_RING_STOP_NEXT_BREAK_B_SHIFT    3
...
#define   BCM6838_REF_CONTROL                     0x00000007    // control for bandgap voltage switching matrix
#define   BCM6838_REF_REFAMP_PD                   0x00000010    // power down for 50uA ref amp
#define   BCM6838_REF_BIASAMP_PD                  0x00000020    // power down for 10uA bias amp
#define   BCM6838_REF_BANDGAP_PD                  0x00000040    // power down for bandgap
#define   BCM6838_REF_SPARE                       0x00000f00    // reserved for future use

  XDRV_UINT32        reg_codec_config_1;                     // (0x124) VTX1
#define   BCM6838_VTX_PGA_MUX                     0x00000300    // analog loopback VDAC out to MICPGA in
#define   BCM6838_VTX_PG                          0x00001800    // gain setting
#define   BCM6838_VTX_CALEN                       0x00002000    // calibration enable
#define   BCM6838_VTX_OSCRST                      0x00004000    // unstable status reset
#define   BCM6838_VTX_PWD                         0x00008000    // ADC power down
#define   BCM6838_VTX_VOCM_CTL                    0x00070000    // opamp output common mode control
#define   BCM6838_VTX_FBIAS_CTL                   0x00300000    // flash bias control
#define   BCM6838_VTX_INT1BIAS_CTL                0x00c00000    // int1 bias control
#define   BCM6838_VTX_INT2BIAS_CTL                0x03000000    // int2 bias control
#define   BCM6838_VTX_VOS_ENA                     0x04000000    // ADC voltage offset enable
#define   BCM6838_VTX_SHUFF_DIS                   0x08000000    // shuffle disable
#define   BCM6838_VTX_SHUFF_DELAY_DIS             0x10000000    // shuffle feedback delay disable
#define   BCM6838_VTX_DITHER_DIS                  0x20000000    // dither disable
#define   BCM6838_VTX_DCANCEL_DIS                 0x40000000    // dither cancellation algorithm disable

#define   BCM6838_PGA_CTL_VADC                    0x30000000
#define   BCM6838_PGA_CTL_VADC_SHIFT                      28

#define   BCM6838_PGA_GAIN_CTL_VDAC_A             0x00000100
#define   BCM6838_PGA_GAIN_CTL_VDAC_A_SHIFT                8

#define   BCM6838_PGA_GAIN_CTL_VDAC_B             0x00000010
#define   BCM6838_PGA_GAIN_CTL_VDAC_B_SHIFT                4

  XDRV_UINT32        reg_codec_config_2;                     // (0x128) same as config 16 for VTX2

  XDRV_UINT32        reg_codec_config_3;                     // (0x12c) VRX1
#define   BCM6838_VRX_PG                          0x00000003    // PGA gain setting
#define   BCM6838_VRX_ASP_BYPASS                  0x00000080    // bypass testmode
#define   BCM6838_VRX_AUXPG                       0x00000300    // aux PGA gain setting
#define   BCM6838_VRX_PD                          0x00008000    // power down
#define   BCM6838_VRX_CMCTL                       0x00070000    // common mode voltage control
#define   BCM6838_VRX_PDDELAY                     0x00300000
#define   BCM6838_VRX_IDAC_CM_CTL                 0x03000000    // IDAC common mode voltage control
#define   BCM6838_VRX_ALOOPBACK                   0x0c000000    // Analog loopback test mode
...
#define   BCM6838_RING_PD                         0x00000001
#define   BCM6838_RING_RESETB                     0x00000002
#define   BCM6838_REF_RESETB                      0x00000004
#define   BCM6838_VTX1_RESETB                     0x00000008
#define   BCM6838_VTX2_RESETB                     0x00000010
#define   BCM6838_VRX1_RESETB                     0x00000020
#define   BCM6838_VRX2_RESETB                     0x00000040
...
#define   BCM6838_P16_CORE_INST_MEM_TM            0x0000000f
#define   BCM6838_P16_CORE_INST_ROM_TM            0x000001f0
#define   BCM6838_BMU_BUS_MAIN_IF_TM              0x00000600
#define   BCM6838_APM_EQ_DATA_RAM_TM_RX_A         0x00001800
#define   BCM6838_APM_EQ_DATA_RAM_TM_RX_B         0x00006000
#define   BCM6838_APM_EQ_DATA_RAM_TM_TX_A         0x00018000
#define   BCM6838_APM_EQ_DATA_RAM_TM_TX_B         0x00060000
#define   BCM6838_APM_EQ_COEFF_RAM_TM_RX_A        0x00180000
#define   BCM6838_APM_EQ_COEFF_RAM_TM_RX_B        0x00600000
#define   BCM6838_APM_EQ_COEFF_RAM_TM_TX_A        0x01800000
#define   BCM6838_APM_EQ_COEFF_RAM_TM_TX_B        0x06000000
#define   BCM6838_APM_Y_FLTR_TM_A                 0x18000000
#define   BCM6838_APM_Y_FLTR_TM_B                 0x60000000
  XDRV_UINT32        reg_mbist_1;                            // (0x14c) MBIST control register
#define   BCM6838_ASRC_DEC_COEFF_RAM_TM_A         0x00000003
#define   BCM6838_ASRC_DEC_DATA_RAM_TM_A          0x0000000c
#define   BCM6838_ASRC_DEC_COEFF_RAM_TM_B         0x00000030
#define   BCM6838_ASRC_DEC_DATA_RAM_TM_B          0x000000c0
#define   BCM6838_ASRC_INTERPFIR_COEFF_RAM_TM_A   0x00000300
#define   BCM6838_ASRC_INTERPFIR_DATA_RAM_TM_A    0x00000c00
#define   BCM6838_ASRC_INTERPFIR_COEFF_RAM_TM_B   0x00003000
#define   BCM6838_ASRC_INTERPFIR_DATA_RAM_TM_B    0x0000c000
...
#define   BCM6838_DPLL_K0_SHIFT                   8
   ...
   /* PCM registers - these are detailed in pcm6838.h */
   /* HVG registers - these are detailed in hvg6838.h */
} BCM6838_APM;

#define BCM6838_APM_PTR               ((volatile BCM6838_APM *)BCM6838_APM_BASE)


#define BCM6838_DMA_RX_NUM_BUFFERS    2     /* Only need two buffers for double buffering */
#define BCM6838_DMA_TX_NUM_BUFFERS    2     /* Only need two buffers for double buffering */

#define APM6838_DMA_MAX_BUFFER_SIZE 48    /* This is in 32-bit words.
