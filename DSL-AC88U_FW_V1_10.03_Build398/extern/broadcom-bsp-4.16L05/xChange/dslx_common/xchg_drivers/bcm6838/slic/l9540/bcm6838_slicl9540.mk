...
###########################################################################
#
#    Filename: bcm6838_slicl9540.mk
#
###########################################################################
#
# This makefile is used to build the bcm6838_slicl9540 module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6838_slicl9540

BCM6838_SLIC_L9540_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_SLIC_L9540_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_SLIC_L9540_ROOT)
