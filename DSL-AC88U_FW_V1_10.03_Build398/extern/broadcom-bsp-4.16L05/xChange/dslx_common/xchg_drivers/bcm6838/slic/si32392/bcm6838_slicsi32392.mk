...
###########################################################################
#
# This makefile is used to build the bcm6838_slicsi32392 module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6838_slicsi32392

BCM6838_SLIC_SI32392_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))

#
# We use notdir and vpath so that the object files don't wind up in
# nested subdirectories
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_SLIC_SI32392_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_SLIC_SI32392_ROOT)
