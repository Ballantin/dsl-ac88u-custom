...
#define SI32392_REG_LINEFEED_CONFIG_4                (4)
#define SI32392_REG_LINEFEED_CONFIG_5                (5)
#define SI32392_REG_LINEFEED_CONFIG_6                (6)
#define SI32392_REG_LINEFEED_CONFIG_7                (7)
...
#define SI32392_CHAN0_LOOP_CUR_THRESH_32      0x0002   /* Bit 11&1: 01-32mA */
#define SI32392_CHAN0_LOOP_CUR_THRESH_23      0x0802   /* Bit 11&1: 11-32mA */
...
#define SI32392_CHAN1_LOOP_CUR_THRESH_32      0x0001   /* Bit 8&0: 01-32mA */
#define SI32392_CHAN1_LOOP_CUR_THRESH_23      0x0101   /* Bit 8&0: 11-32mA */
...
#define SI32392_CHAN0_TEST_LOAD_40K           0x0000   /* Bit 9: Off */
#define SI32392_CHAN0_TEST_LOAD_26K           0x0200   /* Bit 9: On */
#define SI32392_CHAN0_TEST_LOAD_SEL_MASK      0x0200   /* Bit 9 Reg2 */
...
#define SI32392_CHAN1_TEST_LOAD_40K           0x0000   /* Bit 6: Off */
#define SI32392_CHAN1_TEST_LOAD_26K           0x0040   /* Bit 6: On */
#define SI32392_CHAN1_TEST_LOAD_SEL_MASK      0x0040   /* Bit 6 Reg2 */

#define SI32392_RINGTRIP_DETECT_THRESH_70     0x0000   /* Bit 5: 0-70mA */
#define SI32392_RINGTRIP_DETECT_THRESH_80     0x0020   /* Bit 5: 1-80mA */
...
#define SI32392_INTERRUPT_DISABLED            0x0000   /* Bit 3: 0-Disable */
#define SI32392_INTERRUPT_ENABLED             0x0008   /* Bit 3: 1-Enabale */
#define SI32392_INTERRUPT_ENABLE_MASK         0x0008   /* Bit 3 Reg2 */
...
/* Extended config 4 */
#define SI32392_TEST_SPDUPDIS1                0x0400
#define SI32392_TEST_SHORTCTRL1               0x0100
#define SI32392_TEST_SHORTR1                  0x0080
#define SI32392_TEST_SHORTT1                  0x0040
#define SI32392_TEST_SPDUPDIS2                0x0010
#define SI32392_TEST_SHORTCTRL2               0x0004
#define SI32392_TEST_SHORTR2                  0x0002
#define SI32392_TEST_SHORTT2                  0x0001

#define SI32392_CHAN0_TEST_LOAD_OFF           0x0000   /* Bit 9: Off */
#define SI32392_CHAN0_TEST_LOAD_ON            0x0200   /* Bit 9: On */
#define SI32392_CHAN0_TEST_LOAD_MASK          0x0200   /* Bit 9 Reg4 */

#define SI32392_CHAN1_TEST_LOAD_OFF           0x0000   /* Bit 3: Off */
#define SI32392_CHAN1_TEST_LOAD_ON            0x0008   /* Bit 3: On */
#define SI32392_CHAN1_TEST_LOAD_MASK          0x0008   /* Bit 3 Reg4 */

/* Extended config 6 */
#define SI32392_VABTRIM1_MASK                 0x0E00
#define SI32392_VABTRIM2_MASK                 0x0038
#define SI32392_VABTRIM1_SHIFT                     9
#define SI32392_VABTRIM2_SHIFT                     3
#define SI32392_VABTRIM_39V                   0x0003
#define SI32392_VABTRIM_26V                   0x0002
#define SI32392_VABTRIM_13V                   0x0001
#define SI32392_VABTRIM_00V                   0x0000
#define SI32392_VABTRIM_13V_NEG               0x0007
#define SI32392_VABTRIM_26V_NEG               0x0006
#define SI32392_VABTRIM_39V_NEG               0x0005

/* Extended config 7 */
#define SI32392_IND_RING_DISABLED             0x0000
#define SI32392_IND_RING_ENABLED              0x0004
#define SI32392_IND_RING_MASK                 0x0004
