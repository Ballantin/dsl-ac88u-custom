...
#
XCHG_LIB_BASE     := bcm6838_tpdl9530

BCM6838_TPD_L9530_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_TPD_L9530_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_TPD_L9530_ROOT)
