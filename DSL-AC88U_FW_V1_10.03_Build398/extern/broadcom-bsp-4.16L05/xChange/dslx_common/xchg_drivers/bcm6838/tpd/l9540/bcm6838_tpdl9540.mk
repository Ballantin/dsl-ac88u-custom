...
###########################################################################
#
#    Filename: bcm6838_tpdl9540.mk
#
###########################################################################
#
#  This makefile is used to build the bcm6838 L9540 TPD module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6838_tpdl9540

BCM6838_TPD_L9540_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_TPD_L9540_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_TPD_L9540_ROOT)
...
#
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_ROOT)/boardHal/inc \
                                         $(VRG_ROOT)/casCtl/inc \
                                         $(VRG_ROOT)/inc \
