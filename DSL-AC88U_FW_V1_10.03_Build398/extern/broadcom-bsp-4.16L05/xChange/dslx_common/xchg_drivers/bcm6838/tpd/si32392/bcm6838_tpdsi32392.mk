...
###########################################################################
#
#    Filename: bcm6838_tpdsi32392.mk
#
###########################################################################
#
#  This makefile is used to build the bcm6838 SI32392 TPD module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := bcm6838_tpdsi32392

BCM6838_TPD_SI32392_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6838_TPD_SI32392_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6838_TPD_SI32392_ROOT)
...
#
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(VRG_ROOT)/casCtl/inc \
                                         $(VRG_ROOT)/inc \
