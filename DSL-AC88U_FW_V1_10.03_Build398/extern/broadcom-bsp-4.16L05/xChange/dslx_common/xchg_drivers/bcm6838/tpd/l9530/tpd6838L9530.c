...
*****************************************************************************
*/
int tpd6838InitChannel( int chan, XDRV_SLIC *slicDrv, XDRV_APM *apmDrv, XDRV_DEBUG *debugDrv )
{
