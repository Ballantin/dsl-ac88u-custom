...
BOS_SEM           mspi6838IsrSem;   /* MSPI ISR semaphore */
#endif /* MSPI6838_USE_INTERRUPTS */

BCM_MSPI6838_DRV  mspi6838Drv;      /* MSPI Driver */
...
int mspiInit( void )
{
   ...
   bosSemCreate( "MSPI6838ISR", 0, 1, &mspi6838IsrSem ); 
...
#if 0  /** NOTE: SPI enable should be fixed for 6838 */
   /* Enable SPI Block */
   SpiClockControl( 1, 1 );
#endif    
