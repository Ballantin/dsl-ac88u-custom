...
*
****************************************************************************/
#ifndef MSPI6838_H    /* support nested includes */
#define MSPI6838_H
...
typedef enum
{
   BCM_MSPI6838_INITREGS_CMD,
   BCM_MSPI6838_SETREGS_CMD,
   BCM_MSPI6838_GETREGS_CMD,
   BCM_MSPI6838_RXCALLBACK_INSTALL_CMD,
   BCM_MSPI6838_TXCALLBACK_INSTALL_CMD

} BCM_MSPI6838_CMD;

/*************************************************************************
**                   MSPI6838 REGISTERS AND DEFINES                     **
*************************************************************************/
...
#define MSPI6838_USE_INTERRUPTS 0

typedef enum
{
   BCM_MSPI6838_CTRL_MODE_POLLING,
   BCM_MSPI6838_CTRL_MODE_INTERRUPT

} BCM_MSPI6838_CTRL_MODE;

typedef struct BCM_MSPI6838_REGS
{
   ...
   BCM_MSPI6838_CTRL_MODE       mspiCtrlMode;
...
extern int mspiIOctl( BCM_MSPI6838_CMD command, void *cmdp );
