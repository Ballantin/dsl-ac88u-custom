...
#
XCHG_LIB_BASE     := bcm6362_boot

BCM6362_BOOT_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6362_BOOT_ROOT)/*.c $(BCM6362_BOOT_ROOT)/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6362_BOOT_ROOT)
vpath %.s $(BCM6362_BOOT_ROOT)
