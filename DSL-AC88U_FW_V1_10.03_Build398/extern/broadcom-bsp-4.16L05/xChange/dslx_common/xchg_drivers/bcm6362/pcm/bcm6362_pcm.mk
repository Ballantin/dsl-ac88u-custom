###########################################################################
#
# This makefile is used to build the bcm3368_pcm module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6362_pcm

BCM3368_PCM_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM3368_PCM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM3368_PCM_ROOT)
