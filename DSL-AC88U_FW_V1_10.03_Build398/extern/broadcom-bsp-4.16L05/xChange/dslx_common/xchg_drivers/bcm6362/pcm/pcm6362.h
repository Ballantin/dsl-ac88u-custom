...
****************************************************************************
*
*  pcm6362.h - PCM highway Definitions
*
*  PURPOSE:
*
*  NOTES:
...
*/
#   define PCM6362_DMA_MAX_BUFFER_SIZE          ( 32 * HAUSWARE_PERIOD_MS )
#   else
/* PCM ULAW */
/* For 8Khz Fsync, we have 8 samples/ms/channel
 * 8 channels  available, then we have 8 * 8 = 64 samples/ms
...
*/
#   define PCM6362_DMA_MAX_BUFFER_SIZE          ( 16 * HAUSWARE_PERIOD_MS )
#   endif
#else
/* PCM ALAW */
#define PCM6362_DMA_MAX_BUFFER_SIZE          ( 16 * HAUSWARE_PERIOD_MS )
...
#define PCM6362_DMA_MAX_BUFFER_SIZE_BYTES   (PCM6362_DMA_MAX_BUFFER_SIZE*sizeof(XDRV_UINT32))

typedef struct PCM6362_DMA_BUFFER
{
   ...
   volatile XDRV_UINT32 dmaBuff[ PCM6362_DMA_MAX_BUFFER_SIZE + DMA_PADDING_WORD32 ];
} PCM6362_DMA_BUFFER;
...
int pcm6362_enable( int chan_mask );

#define PCM6362_NUM_DMA_CHANNELS    1     /* Only one duplex RX/TX DMA channel */
