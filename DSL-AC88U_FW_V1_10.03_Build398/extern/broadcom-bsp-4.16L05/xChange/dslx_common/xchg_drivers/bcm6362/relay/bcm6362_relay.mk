...
#
XCHG_LIB_BASE           := bcm6362_relay

BCM6362_RELAY_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6362_RELAY_ROOT)/*.c))
