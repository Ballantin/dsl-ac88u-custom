...
#
###########################################################################
# Filename: bcm6328_ntr.mk
#
# This makefile is used to build the bcm6328_ntr module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := bcm6328_ntr

BCM6328_NTR_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6328_NTR_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BCM6328_NTR_ROOT)
