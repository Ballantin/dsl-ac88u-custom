...
*****************************************************************************
*/
RELAY_STATUS relay6328Init( RELAY_6328_DRV *pDev )
{
...
*****************************************************************************
*/
RELAY_STATUS relayDeinit( RELAY_6328_DRV *pDev )
{
...
static XDRV_BOOL relayIsActive( XDRV_RELAY *pDrv )
{
   RELAY_6328_DRV *pDev = (RELAY_6328_DRV *)pDrv;
