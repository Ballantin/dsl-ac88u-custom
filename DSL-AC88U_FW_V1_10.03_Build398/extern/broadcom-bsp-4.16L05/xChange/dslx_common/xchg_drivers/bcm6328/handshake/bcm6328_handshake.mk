###########################################################################
#
# This makefile is used to build the handshake module.
#
###########################################################################
...
BCM6328_HANDSHAKE_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BCM6328_HANDSHAKE_ROOT)/*.s $(BCM6328_HANDSHAKE_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.s $(BCM6328_HANDSHAKE_ROOT)
vpath %.c $(BCM6328_HANDSHAKE_ROOT)
