...
*     MIPS thread-processor on the 3368. The bootload is performed by the
...
static void ResetThreadProcessor( unsigned int *entryPoint )
{
   ...
   if ( firstTime )
   {
      ...
      */
      ...
      boot6328SendIpc( (void*)entryPoint );
   }
   else
   {
      /*
