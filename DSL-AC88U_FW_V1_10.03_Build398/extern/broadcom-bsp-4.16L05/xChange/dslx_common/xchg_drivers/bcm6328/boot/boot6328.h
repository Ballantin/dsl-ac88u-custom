...
*     MIPS thread-processor on the 63xx. The bootload is performed by the
...
*  FUNCTION:   bootInit
*
*  PURPOSE:    Initializes the MIPS thread-processor bootloader.
*
*
...
*
*****************************************************************************/
int boot6328Init( XDRV_ITPC *itpcDrv );
...
*  FUNCTION:   bootDeinit
*
*  PURPOSE:    De-initializes the thread-processor bootloader.
*
*  PARAMETERS: None.
*
*  RETURNS:    0 on success
...
*
*****************************************************************************/
int boot6328Deinit( void );


/*
*****************************************************************************
** FUNCTION:   bootLoadImage
**
...
*****************************************************************************
*/
int boot6328LoadImage
(
   const BOOT_THREAD_PROCESSOR_IMAGE *image,
...
*****************************************************************************
*/
void boot6328SendIpc( void *ipcStruct );
