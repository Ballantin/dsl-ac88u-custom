...
#
XCHG_LIB_BASE        := cacheArm

CACHE_ARM_ROOT      := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(CACHE_ARM_ROOT)/*.c $(CACHE_ARM_ROOT)/*.s))
...
#
vpath %.c $(CACHE_ARM_ROOT)
vpath %.s $(CACHE_ARM_ROOT)
