...
*     obtain DSP debug information. Therefore, the APIs provided in this
*     file are platform specific, and should be used by the HAL to instantiate
*     the debug module. The platform-independant API to obtain debug information
*     by the application is provided by debug.h.
*
****************************************************************************/

#ifndef DEBUG_ZSP_INTERFACE_H
#define DEBUG_ZSP_INTERFACE_H
