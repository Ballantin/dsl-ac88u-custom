###########################################################################
#
# This makefile is used to build the shared memory IPC control module.
#
###########################################################################
...
#
XCHG_LIB_BASE := ipcSharedMem

IPC_SHARED_MEM_ROOT := $(XDRV_DIR_ipcSharedMem)
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(IPC_SHARED_MEM_ROOT)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(IPC_SHARED_MEM_ROOT)/src
