###########################################################################
#
# This makefile is used to build the flow control module.
#
###########################################################################
...
#
XCHG_LIB_BASE  := flowCtrl

FLOW_CTRL_ROOT := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(FLOW_CTRL_ROOT)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(FLOW_CTRL_ROOT)/src
