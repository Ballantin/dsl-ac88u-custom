...
#
XCHG_LIB_BASE     := casDriver

CAS_DRIVER_ROOT   := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(CAS_DRIVER_ROOT)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(CAS_DRIVER_ROOT)/src
