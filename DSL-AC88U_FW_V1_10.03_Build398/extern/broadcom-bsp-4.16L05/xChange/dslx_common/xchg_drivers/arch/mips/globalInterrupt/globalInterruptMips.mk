...
#
XCHG_LIB_BASE           := globalInterruptMips
...
ifeq ($(strip $(DSP_APP_BUILD)),1)
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(GLOBAL_INTERRUPT_ROOT)/*.s))
vpath %.s $(GLOBAL_INTERRUPT_ROOT)
else
