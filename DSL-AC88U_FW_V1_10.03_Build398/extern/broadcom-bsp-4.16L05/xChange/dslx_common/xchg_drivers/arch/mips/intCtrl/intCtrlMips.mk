###########################################################################
#
# This makefile is used to build the MIPS interrupt control module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := intCtrlMips

INT_CTRL_MIPS_ROOT      := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(INT_CTRL_MIPS_ROOT)/src/*.c $(INT_CTRL_MIPS_ROOT)/src/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(INT_CTRL_MIPS_ROOT)/src
vpath %.s $(INT_CTRL_MIPS_ROOT)/src
