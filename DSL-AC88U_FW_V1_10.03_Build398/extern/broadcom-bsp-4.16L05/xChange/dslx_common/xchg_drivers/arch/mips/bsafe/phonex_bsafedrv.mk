...
#
XCHG_LIB_BASE     := phonex_bsafedrv

BSAFE_DRV_ROOT    := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
#XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(BSAFE_DRV_ROOT)/sys/*.c))
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := bsafe_io.c bsafe_misc.c bsafe_readwrite.c

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(BSAFE_DRV_ROOT)/sys
...
#
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) := $(BSAFE_DRV_ROOT)/shared $(BSAFE_DRV_ROOT)/sys
