###########################################################################
#
# This makefile is used to build the ITPC module.
#
###########################################################################
...
#
XCHG_LIB_BASE        := itpcMips

ITPC_MIPS_ROOT       := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(ITPC_MIPS_ROOT)/src/*.c $(ITPC_MIPS_ROOT)/src/*.s))
...
#
vpath %.c $(ITPC_MIPS_ROOT)/src
vpath %.s $(ITPC_MIPS_ROOT)/src
