###########################################################################
#
# This makefile is used to build the MIPS spin-lock module.
#
###########################################################################
...
#
XCHG_LIB_BASE        := spinLockMips

SPIN_LOCK_MIPS_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(SPIN_LOCK_MIPS_ROOT)/src/*.c $(SPIN_LOCK_MIPS_ROOT)/src/*.s))
...
#
vpath %.c $(SPIN_LOCK_MIPS_ROOT)/src
vpath %.s $(SPIN_LOCK_MIPS_ROOT)/src
