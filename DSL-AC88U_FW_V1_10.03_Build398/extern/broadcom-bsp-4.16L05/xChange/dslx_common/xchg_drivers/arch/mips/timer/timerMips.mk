###########################################################################
#
# This makefile is used to build the MIPS timer module.
#
###########################################################################
...
#
XCHG_LIB_BASE        := timerMips

TIMER_MIPS_ROOT      := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(TIMER_MIPS_ROOT)/src/*.c $(TIMER_MIPS_ROOT)/src/*.s))
...
#
vpath %.c $(TIMER_MIPS_ROOT)/src
vpath %.s $(TIMER_MIPS_ROOT)/src
