###########################################################################
#
# This makefile is used to build the exception handler module.
#
###########################################################################
...
#
XCHG_LIB_BASE              := exceptionHdlrMips

EXCEPTION_HDLR_MIPS        := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(EXCEPTION_HDLR_MIPS)/src/*.c $(EXCEPTION_HDLR_MIPS)/src/*.s))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(EXCEPTION_HDLR_MIPS)/src
vpath %.s $(EXCEPTION_HDLR_MIPS)/src
