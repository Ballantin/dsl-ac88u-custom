###########################################################################
#
# This makefile is used to build the exception module.
#
###########################################################################
...
#
XCHG_LIB_BASE        := exceptionMips

EXCEPTION_MIPS_ROOT  := $(XDRV_DIR_$(XCHG_LIB_BASE))


#
# List of all source files. Do not specify directories, we use vpath below.
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(EXCEPTION_MIPS_ROOT)/src/*.c $(EXCEPTION_MIPS_ROOT)/src/*.s))
...
#
vpath %.c $(EXCEPTION_MIPS_ROOT)/src
vpath %.s $(EXCEPTION_MIPS_ROOT)/src
