###########################################################################
#
# This makefile is used to build the CMT exception handler module.
#
###########################################################################
...
#
XCHG_LIB_BASE              := exceptionHdlrCmtMips

EXCEPTION_HDLR_CMT_MIPS    := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(EXCEPTION_HDLR_CMT_MIPS)/src/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(EXCEPTION_HDLR_CMT_MIPS)/src
