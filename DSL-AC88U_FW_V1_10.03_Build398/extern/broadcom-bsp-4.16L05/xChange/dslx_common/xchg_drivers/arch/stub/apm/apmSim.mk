###########################################################################
#
# This makefile is used to build the apmSim module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := apmSim

APM_SIM_ROOT           := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(APM_SIM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(APM_SIM_ROOT)
