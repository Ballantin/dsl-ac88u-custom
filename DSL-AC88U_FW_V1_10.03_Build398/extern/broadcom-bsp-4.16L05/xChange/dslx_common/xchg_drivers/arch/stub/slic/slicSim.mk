###########################################################################
#
# This makefile is used to build the slicSim module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := slicSim

SLIC_SIM_ROOT           := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(SLIC_SIM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(SLIC_SIM_ROOT)
