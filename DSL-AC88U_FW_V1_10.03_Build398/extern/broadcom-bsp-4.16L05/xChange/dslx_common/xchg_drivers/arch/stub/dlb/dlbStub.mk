###########################################################################
#
# This makefile is used to build the dynamic load balancing stub module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := dlbStub

DLB_STUB_ROOT           := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(DLB_STUB_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(DLB_STUB_ROOT)
