###########################################################################
#
# This makefile is used to build the IPC control module.
#
###########################################################################
...
#
XCHG_LIB_BASE     := ipcSim

IPC_SIM_ROOT      := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(IPC_SIM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(IPC_SIM_ROOT)
