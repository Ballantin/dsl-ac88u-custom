###########################################################################
#
# This makefile is used to build the ledSim module.
#
###########################################################################
...
#
XCHG_LIB_BASE           := ledSim

LED_SIM_ROOT           := $(XDRV_DIR_$(XCHG_LIB_BASE))
...
#
XCHG_SRC_FILES_$(XCHG_LIB_BASE) := $(notdir $(wildcard $(LED_SIM_ROOT)/*.c))

XCHG_SRC_FILES += $(XCHG_SRC_FILES_$(XCHG_LIB_BASE))

vpath %.c $(LED_SIM_ROOT)
