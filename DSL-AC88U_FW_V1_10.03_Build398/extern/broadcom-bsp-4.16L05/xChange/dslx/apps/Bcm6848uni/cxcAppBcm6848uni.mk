...
#
#****************************************************************************
#    Filename: cxcAppBcm6848uni.mk
#
#****************************************************************************
#
#  This makefile is used to build all of the components of the 6848uni
#  DSLX application.
#
#****************************************************************************
...
#
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_6848_DEFAULT_TARGETS)     \
...
ifeq ($(strip $(BRCM_NTR_SUP PORT)),1)
CXC_XDRV_TARGET_LIST += bcm6848_ntr
endif
...
#
CXC_CM_APP_BUILD_OPTIONS := bcm96848
...
CXC_XDRV_TARGET_LIST += bcm6848_boot        \
                        bcm6848_handshake   \
...
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848_COMP)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848_COMP
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848_INT)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848_INT
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848_BOND
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848_COMP_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848_COMP_BOND
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6848_INT_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6848_INT_BOND
endif
