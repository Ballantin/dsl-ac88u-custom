...
#
#****************************************************************************
#    Filename: cxcAppBcm6362advng.mk
#
#****************************************************************************
#
#  This makefile is used to build all of the components of the 6362advng
#  DSLX application.
#
#****************************************************************************
...
#
ifeq ($(strip $(BRCM_6362_DECTTEST_SUPPORT)),1)
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_6362_DEFAULT_TARGETS)     \
...
#
CXC_CM_APP_BUILD_OPTIONS := bcm96362
...
CXC_XDRV_TARGET_LIST += bcm6362_boot         \
                        bcm6362_handshake    \
...
ifeq ($(strip $(BRCM_NTR_SUPPORT_6362)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6362
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6362_COMP)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6362_COMP
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6362_INT)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6362_INT
endif
ifeq ($(strip $(BRCM_6362_DECTTEST_SUPPORT)),1)
