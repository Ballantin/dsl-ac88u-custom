...
#
#****************************************************************************
#    Filename: cxcAppBcm63268advng.mk
#
#****************************************************************************
#
#  This makefile is used to build all of the components of the 63268advng
#  DSLX application.
#
#****************************************************************************
...
#
CXC_VRG_BOARD_TYPE := bcm63268uni
...
#
ifeq ($(strip $(BRCM_63268_DECTTEST_SUPPORT)),1)
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_63268_DEFAULT_TARGETS)     \
...
CXC_XDRV_TARGET_LIST += bcm63268_ntr
endif

# If any DECT channels are present, then we need to enable correct PCM PLL settings
ifneq ($(strip $(NUM_IDECT_CHANNELS)),0)
XCHG_C_GLOBAL_DEFS += PCM_63268_DECT=1
endif
...
#
CXC_CM_APP_BUILD_OPTIONS := bcm963268
...
CXC_XDRV_TARGET_LIST += bcm63268_boot        \
                        bcm63268_handshake   \
...
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268_COMP)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268_COMP
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268_INT)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268_INT
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268_BOND
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268_COMP_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268_COMP_BOND
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_63268_INT_BOND)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_63268_INT_BOND
endif
ifeq ($(strip $(BRCM_63268_DECTTEST_SUPPORT)),1)
