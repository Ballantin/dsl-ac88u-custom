...
#****************************************************************************
#
#  This makefile is used to build all the components of the 63138uni application
#
#****************************************************************************
...
#
CXC_VRG_BOARD_TYPE := bcm63138uni
...
#
ifeq ($(strip $(BRCM_63138_DECTTEST_SUPPORT)),1)
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_63138_DEFAULT_TARGETS)     \
...
CXC_XDRV_TARGET_LIST += bcm63138_ntr
endif
