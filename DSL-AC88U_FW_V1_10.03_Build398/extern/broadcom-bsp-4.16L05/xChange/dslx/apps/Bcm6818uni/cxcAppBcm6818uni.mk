...
#
#****************************************************************************
#    Filename: cxcAppBcm6818pvwm.mk
#
#****************************************************************************
#
#  This makefile is used to build all of the components of the 6348gw
#  CablexChange application.
#
#****************************************************************************
...
#
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_6818_DEFAULT_TARGETS)     \
...
CXC_XDRV_TARGET_LIST += bcm6818_boot         \
                        bcm6818_handshake    \
...
ifneq ($(strip $(BRCM_6818_LE9530_APM_MODE)),1)
