...
#
XCHG_LIB_BASE  := lib_cell_cmgr

XCHG_LIB_DIR = $(CXC_CABLEX_DIR)/lib/$(CXC_OS_TYPE)
XCHG_OBJ_DIR = $(CXC_CABLEX_DIR)/obj/$(CXC_OS_TYPE)/cell_cmgr

#
# Define necessary variable used in the core makefile(s).
#
CELL_ROOT := $(CXC_CELL_ROOT)
CMGR_ROOT := $(CELL_ROOT)/cmgr
...
#
include $(CELL_ROOT)/cmgr/build/xchg/cmgr.mk
...
# These must be absolute paths in order to support non-recursive makefiles.
#
XCHG_C_LOCAL_INCLUDE_$(XCHG_LIB_BASE) :=  $(CXC_APPS_DIR)/cell_cmgr/cfginc                          \
										  ...
										  $(CXC_VIEW_DIR)/userspace/public/libs/openssl/openssl-1.0.1j/include \
                                          $(CELL_ROOT)/apps/inc
