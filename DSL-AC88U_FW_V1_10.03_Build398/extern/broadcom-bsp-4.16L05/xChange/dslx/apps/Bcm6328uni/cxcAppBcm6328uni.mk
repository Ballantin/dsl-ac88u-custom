...
#
#****************************************************************************
#    Filename: cxcAppBcm6328avng.mk
#
#****************************************************************************
#
#  This makefile is used to build all of the components of the 6328avng
#  DSLX application.
#
#****************************************************************************
...
#
CXC_XDRV_TARGET_LIST = $(CXC_XDRV_6328_DEFAULT_TARGETS)    \
...
CXC_XDRV_TARGET_LIST += bcm6328_ntr
endif
...
#
CXC_CM_APP_BUILD_OPTIONS := bcm96328
...
CXC_XDRV_TARGET_LIST += bcm6328_boot         \
                        bcm6328_handshake    \
...
ifeq ($(strip $(BRCM_NTR_SUPPORT_6328)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6328
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6328_COMP)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6328_COMP
endif
ifeq ($(strip $(BRCM_NTR_SUPPORT_6328_INT)),1)
XCHG_C_GLOBAL_DEFS += NTR_SUPPORT_6328_INT
endif
