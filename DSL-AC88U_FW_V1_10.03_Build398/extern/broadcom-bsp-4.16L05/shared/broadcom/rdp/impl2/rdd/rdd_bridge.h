                                                                     ...
                                                                     BL_LILAC_RDD_WAN_PHYSICAL_PORT_DTE  xi_wan_physical_port )
{
    ...
    else
    {
        ...
        {
            if ( ( xi_wan_physical_port == BL_LILAC_RDD_WAN_PHYSICAL_PORT_GPON ) || ( xi_wan_physical_port == BL_LILAC_RDD_WAN_PHYSICAL_PORT_EPON ) || ( xi_wan_physical_port == BL_LILAC_RDD_WAN_PHYSICAL_PORT_ETH5 ) )
            {
                return ( BL_LILAC_RDD_WAN0_BRIDGE_PORT ); // DSL
            }
