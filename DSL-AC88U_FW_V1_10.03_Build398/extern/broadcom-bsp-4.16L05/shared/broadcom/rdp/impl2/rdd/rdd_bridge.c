...
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_entry_in_cache ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_entry_in_ddr ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t, rdpa_iptv_lookup_method );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_ssm_context_entry_in_ddr ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l2_mac_entry ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l2_mac_vid_entry ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l3_dst_ip_src_ip_entry ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l3_dst_ip_entry ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l3_dst_ip_src_ip_vid_entry ( uint32_t, BL_LILAC_RDD_BRIDGE_PORT_DTE, uint16_t, uint8_t );
...
BL_LILAC_RDD_ERROR_DTE f_rdd_iptv_initialize ( void )
{
    ...
    iptv_table_address = ( g_runner_ddr_base_addr + IPTV_DDR_LOOKUP_TABLE_ADDRESS ) & 0x1FFFFFFF;
    iptv_context_table_address = ( g_runner_ddr_base_addr + IPTV_DDR_CONTEXT_TABLE_ADDRESS ) & 0x1FFFFFFF;
    ...
    iptv_ssm_context_table_address = ( g_runner_ddr_base_addr + IPTV_SSM_DDR_CONTEXT_TABLE_ADDRESS ) & 0x1FFFFFFF;
...
{
    RDD_DS_INGRESS_FILTERS_LOOKUP_TABLE_DTS  *filters_cam_table_ptr;
    ...
    for ( bridge_port = BL_LILAC_RDD_WAN_BRIDGE_PORT; bridge_port <= BL_LILAC_RDD_PCI_BRIDGE_PORT; bridge_port++ )
    {
        ...
        {
            filters_cam_table_ptr = ( RDD_DS_INGRESS_FILTERS_LOOKUP_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + DS_INGRESS_FILTERS_LOOKUP_TABLE_ADDRESS );
        }
        else
        {
            filters_cam_table_ptr = ( RDD_DS_INGRESS_FILTERS_LOOKUP_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + US_INGRESS_FILTERS_LOOKUP_TABLE_ADDRESS );
        }
        ...
        for ( subnet_id = BL_LILAC_RDD_SUBNET_FLOW_CACHE; subnet_id < LILAC_RDD_NUMBER_OF_SUBNETS; subnet_id++ )
        {
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_IGMP_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_ICMPV6_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_USER_0_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_USER_1_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_USER_2_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_USER_3_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_PPPOE_D_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_PPPOE_S_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_ARP_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_1588_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_802_1X_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_802_1AG_CFM_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_BROADCAST_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_MULTICAST_FILTER_NUMBER ] );
            ...
            filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_STOP_FILTER_NUMBER ] );
...
{
    RDD_VLAN_OPTIMIZATION_TABLE_DTS  *vlan_optimization_table_ptr;
    RDD_VLAN_OPTIMIZATION_ENTRY_DTS  *vlan_optimization_entry_ptr;
    RDD_VLAN_COMMANDS_TABLE_DTS      *vlan_commands_table_ptr;
    ...
    vlan_optimization_table_ptr = ( RDD_VLAN_OPTIMIZATION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + VLAN_OPTIMIZATION_TABLE_ADDRESS );

    for ( vlan_command_id = 0; vlan_command_id < RDD_VLAN_OPTIMIZATION_TABLE_SIZE; vlan_command_id++ )
    {
        vlan_optimization_entry_ptr = &( vlan_optimization_table_ptr->entry[ vlan_command_id ] );

        RDD_VLAN_OPTIMIZATION_ENTRY_OPTIMIZE_ENABLE_WRITE ( ( LILAC_RDD_TRUE << 7 ), vlan_optimization_entry_ptr );
    }

    vlan_optimization_table_ptr = ( RDD_VLAN_OPTIMIZATION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + VLAN_OPTIMIZATION_TABLE_ADDRESS );
        ...
        for ( pbits_command_id = rdd_pbits_command_transparent; pbits_command_id < rdd_max_pbits_command; pbits_command_id++ )
        {
            ...
            if ( action_exist == LILAC_RDD_TRUE )
            {
                ...
                for ( runner_id = 0; runner_id <= 1; runner_id++ )
                {
                    if ( runner_id == 0 )
                    {
                        vlan_commands_table_ptr = ( RDD_VLAN_COMMANDS_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + VLAN_COMMANDS_TABLE_ADDRESS );
                    }
                    else
                    {
                        vlan_commands_table_ptr = ( RDD_VLAN_COMMANDS_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + VLAN_COMMANDS_TABLE_ADDRESS );
                    }

                    vlan_command_entry_ptr = &( vlan_commands_table_ptr->entry[ vlan_action_counter ] );
...
BL_LILAC_RDD_ERROR_DTE f_rdd_multicast_initialize ( void )
{
    ...
    RDD_MULTICAST_VECTOR_TO_PORT_TABLE_DTS  *multicast_vector_to_port_table_ptr;
    ...
    multicast_active_ports_table_ptr = ( RDD_MULTICAST_ACTIVE_PORTS_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_COMMON_1_OFFSET ) + MULTICAST_ACTIVE_PORTS_TABLE_ADDRESS - sizeof ( RUNNER_COMMON ) );
    ...
    multicast_vector_to_port_table_ptr = ( RDD_MULTICAST_VECTOR_TO_PORT_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + MULTICAST_VECTOR_TO_PORT_TABLE_ADDRESS );

    multicast_vector_to_port_entry_ptr = &( multicast_vector_to_port_table_ptr->entry[ BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT >> 5 ] );
    ...
    multicast_vector_to_port_table_ptr = ( RDD_MULTICAST_VECTOR_TO_PORT_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + MULTICAST_VECTOR_TO_PORT_TABLE_ADDRESS );
    ...
    vlan_optimization_entry_ptr = &( vlan_optimization_table_ptr->entry[ 127 ] );
                                                                                            ...
                                                                                            uint32_t              xi_cache_index )
{
    ...
    if ( xi_entry->l3_entry_fields.bridge_port < BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT )
    {
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_WRITE ( LILAC_RDD_FALSE, forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_EGRESS_PORT_WRITE ( xi_entry->l3_entry_fields.bridge_port, forward_entry_ptr );
    }
    else
    {
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_VECTOR_WRITE ( ( ( xi_entry->l3_entry_fields.bridge_port / BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT ) >> 5 ), forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_EGRESS_PORT_WRITE ( xi_entry->l3_entry_fields.bridge_port / BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT, forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_WRITE ( LILAC_RDD_TRUE, forward_entry_ptr ); 
    }

    if ( ( xi_entry->l3_entry_fields.bridge_port == BL_LILAC_RDD_PCI_BRIDGE_PORT ) ||
         ( xi_entry->l3_entry_fields.bridge_port & BL_LILAC_RDD_MULTICAST_PCI_BRIDGE_PORT ) )
    {
        RDD_IPTV_SSID_EXTENSION_ENTRY_SSID_VECTOR_WRITE ( xi_entry->l3_entry_fields.ssid_vector, iptv_ssid_entry_ptr );
    }
                                                                                          ...
                                                                                          uint32_t              xi_base_index )
{
    ...
    bridge_port = p_rdd_bridge_port_to_iptv_context_bridge_port ( xi_entry->l3_entry_fields.bridge_port );

    RDD_IPTV_DDR_CONTEXT_ENTRY_BRIDGE_PORT_WRITE ( bridge_port, iptv_ssm_context_entry_ptr );
    RDD_IPTV_DDR_CONTEXT_ENTRY_COUNTER_WRITE ( 0, iptv_ssm_context_entry_ptr );
    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_WRITE ( xi_entry->l3_entry_fields.ssid_vector, iptv_ssm_context_entry_ptr );
                                                                                  ...
                                                                                  uint32_t                 *xo_index )
{
    ...
    crc_result = crcbitbybit ( &xi_entry_bytes[ 4 ], 12, 0, crc_init_value, RDD_CRC_TYPE_32 );
                                                              ...
                                                              uint32_t              *xo_cache_index )
{
    ...
    context_entry = p_rdd_bridge_port_to_iptv_context_bridge_port ( xi_entry->l2_entry_fields.bridge_port );
    ...
    *xo_cache_index = entry_index;
    ...
    if ( ( xi_entry->l2_entry_fields.bridge_port == BL_LILAC_RDD_PCI_BRIDGE_PORT ) ||
         ( xi_entry->l2_entry_fields.bridge_port & BL_LILAC_RDD_MULTICAST_PCI_BRIDGE_PORT ) )
    {
        iptv_ssid_table_ptr = ( RDD_IPTV_SSID_EXTENSION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + IPTV_SSID_EXTENSION_TABLE_ADDRESS );
        ...
        RDD_IPTV_SSID_EXTENSION_ENTRY_SSID_VECTOR_WRITE ( xi_entry->l2_entry_fields.ssid_vector, iptv_ssid_entry_ptr );
    }
                                                            ...
                                                            uint32_t                 *xo_index )
{
    ...
    bridge_port = p_rdd_bridge_port_to_iptv_context_bridge_port ( xi_entry->l2_entry_fields.bridge_port );

    RDD_IPTV_L3_DDR_LOOKUP_ENTRY_BRIDGE_PORT_WRITE ( bridge_port, iptv_entry_ptr );
    RDD_IPTV_L2_DDR_LOOKUP_ENTRY_COUNTER_WRITE ( 0, iptv_entry_ptr );
    ...
    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_WRITE ( xi_entry->l2_entry_fields.ssid_vector, iptv_context_entry_ptr );
                                            ...
                                            uint32_t              *xo_cache )
{
    ...
    if ( xi_entry->l3_entry_fields.dst_ip.family == bdmf_ip_family_ipv6 )
    {
        ...
        crc_init_value = get_crc_init_value ( RDD_CRC_TYPE_32 );
        crc_result = crcbitbybit ( &(xi_entry->l3_entry_fields.dst_ip.addr.ipv6.data[0]), 16, 0, crc_init_value, RDD_CRC_TYPE_32 );
        ...
        if ( ( iptv_classification_mode == iptv_lookup_method_group_ip_src_ip ) || ( iptv_classification_mode == iptv_lookup_method_group_ip_src_ip_vid ) )
        {
            ...
            if ( memcmp ( ipv6_src_ip_any.addr.ipv6.data, xi_entry->l3_entry_fields.src_ip.addr.ipv6.data, 16 ) )
            {
                ...
                crc_init_value = get_crc_init_value ( RDD_CRC_TYPE_32 );
                crc_result = crcbitbybit ( &(xi_entry->l3_entry_fields.src_ip.addr.ipv6.data[0]), 16, 0, crc_init_value, RDD_CRC_TYPE_32 );
...
static BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_entry_in_cache ( uint32_t                      xi_entry_index_in_ddr,
                                                                 BL_LILAC_RDD_BRIDGE_PORT_DTE  xi_egress_bridge_port,
                                                                 ...
                                                                 uint8_t                       xi_ingress_classification_context )
{
    ...
    RDD_IPTV_INGRESS_CLASSIFICATION_CONTEXT_ENTRY_DTS  *iptv_ingress_classification_context_entry_ptr; 
    BL_LILAC_RDD_ERROR_DTE                             rdd_error;
    uint32_t                                           entry_cached;
    uint32_t                                           entry_index_in_cache;
    ...
    if ( xi_egress_bridge_port < BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT )
    {
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_WRITE ( LILAC_RDD_FALSE, forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_VECTOR_WRITE ( 0, forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_EGRESS_PORT_WRITE ( xi_egress_bridge_port, forward_entry_ptr );
    }
    else
    {
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_WRITE ( LILAC_RDD_TRUE, forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_MULTICAST_VECTOR_WRITE ( ( ( xi_egress_bridge_port / BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT ) >> 5 ), forward_entry_ptr );
        RDD_IPTV_CONTEXT_ENTRY_EGRESS_PORT_WRITE ( xi_egress_bridge_port / BL_LILAC_RDD_MULTICAST_LAN0_BRIDGE_PORT, forward_entry_ptr );
    }

    if ( ( xi_egress_bridge_port == BL_LILAC_RDD_PCI_BRIDGE_PORT ) || ( xi_egress_bridge_port & BL_LILAC_RDD_MULTICAST_PCI_BRIDGE_PORT ) )
    {
        RDD_IPTV_SSID_EXTENSION_ENTRY_SSID_VECTOR_WRITE ( xi_wifi_ssid_vector, iptv_ssid_entry_ptr );
    }
                                                               ...
                                                               rdpa_iptv_lookup_method       iptv_mode )
{
    ...
    bridge_port = p_rdd_bridge_port_to_iptv_context_bridge_port ( xi_egress_bridge_port );

    if ( ( iptv_mode == iptv_lookup_method_group_ip_src_ip ) || ( iptv_mode == iptv_lookup_method_group_ip_src_ip_vid ) )
    {
        RDD_IPTV_DDR_CONTEXT_ENTRY_BRIDGE_PORT_WRITE ( bridge_port, iptv_context_entry_ptr );
    }
    else
    {
        RDD_IPTV_L3_DDR_LOOKUP_ENTRY_BRIDGE_PORT_WRITE ( bridge_port, iptv_entry_ptr );
    ...
    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_WRITE ( xi_wifi_ssid_vector, iptv_context_entry_ptr );
                                                               ...
                                                               uint8_t                       xi_ingress_classification_context )
{
    ...
    rdd_error = f_rdd_modify_iptv_entry_in_ddr ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context, iptv_lookup_method_mac );

    if ( rdd_error == BL_LILAC_RDD_OK )
    {
        rdd_error = f_rdd_modify_iptv_entry_in_cache ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
    }
                                                                   ...
                                                                   uint8_t                       xi_ingress_classification_context )
{
    ...
    rdd_error = f_rdd_modify_iptv_entry_in_ddr ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context, iptv_lookup_method_mac_vid );
                                                                         ...
                                                                         uint8_t                       xi_ingress_classification_context )
{
    ...
    {
        rdd_error = f_rdd_modify_iptv_entry_in_ddr ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context, iptv_lookup_method_group_ip_src_ip );
    ...
    {
        rdd_error = f_rdd_modify_iptv_ssm_context_entry_in_ddr ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
    }
                                                                  ...
                                                                  uint8_t                       xi_ingress_classification_context )
{
    ...
    rdd_error = f_rdd_modify_iptv_entry_in_ddr ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context, iptv_lookup_method_group_ip );
...
static inline BL_LILAC_RDD_ERROR_DTE f_rdd_modify_iptv_l3_dst_ip_src_ip_vid_entry ( uint32_t                      xi_entry_index,
                                                                                    ...
                                                                                    uint8_t                       xi_ingress_classification_context )
{
    return ( f_rdd_modify_iptv_l3_dst_ip_src_ip_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context ) );
}
                                               ...
                                               uint8_t                       xi_ingress_classification_context )
{
    ...
    case iptv_lookup_method_mac:
         ...
         rdd_error = f_rdd_modify_iptv_l2_mac_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
         break;

    case iptv_lookup_method_mac_vid:

         rdd_error = f_rdd_modify_iptv_l2_mac_vid_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
         break;

    case iptv_lookup_method_group_ip_src_ip:

         rdd_error = f_rdd_modify_iptv_l3_dst_ip_src_ip_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
         break;

    case iptv_lookup_method_group_ip:

        rdd_error = f_rdd_modify_iptv_l3_dst_ip_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
        break;

    case iptv_lookup_method_group_ip_src_ip_vid:

         rdd_error = f_rdd_modify_iptv_l3_dst_ip_src_ip_vid_entry ( xi_entry_index, xi_egress_bridge_port, xi_wifi_ssid_vector, xi_ingress_classification_context );
         break;
    }
                                                                                      ...
                                                                                      uint32_t  *xo_base_deleted )
{
    ...
    /* in ssm mode the context of entries with src ip = any is written according to the "regular" context table according to the ssm mode context format */
    RDD_IPTV_DDR_CONTEXT_ENTRY_BRIDGE_PORT_WRITE ( 0, iptv_ssm_context_entry_ptr );
    RDD_IPTV_DDR_CONTEXT_ENTRY_COUNTER_WRITE ( 0, iptv_ssm_context_entry_ptr );
    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_WRITE ( 0, iptv_ssm_context_entry_ptr );
                                                          ...
                                                          bdmf_ip_t                *xo_ipv6_dst_ip_ptr )
{
    ...
    RDD_IPTV_DDR_CONTEXT_ENTRY_BRIDGE_PORT_READ ( xo_entry->l3_entry_fields.bridge_port, iptv_context_entry_ptr );

    xo_entry->l3_entry_fields.bridge_port = p_rdd_iptv_context_bridge_port_to_bridge_port ( xo_entry->l3_entry_fields.bridge_port );

    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_READ ( xo_entry->l3_entry_fields.ssid_vector, iptv_context_entry_ptr );
                                                      ...
                                                      bdmf_ip_t                *xo_ipv6_dst_ip_ptr )
{
    ...
    if ( ( xi_iptv_mode == iptv_lookup_method_group_ip_src_ip ) || ( xi_iptv_mode == iptv_lookup_method_group_ip_src_ip_vid ) )
    {
        RDD_IPTV_DDR_CONTEXT_ENTRY_BRIDGE_PORT_READ ( xo_entry->l2_entry_fields.bridge_port, iptv_context_entry_ptr );
    }
    else
    {
        RDD_IPTV_L3_DDR_LOOKUP_ENTRY_BRIDGE_PORT_READ ( xo_entry->l2_entry_fields.bridge_port, iptv_entry_ptr );
    }

    xo_entry->l2_entry_fields.bridge_port = p_rdd_iptv_context_bridge_port_to_bridge_port ( xo_entry->l2_entry_fields.bridge_port );

    RDD_IPTV_DDR_CONTEXT_ENTRY_SSID_VECTOR_READ ( xo_entry->l2_entry_fields.ssid_vector, iptv_context_entry_ptr );
                                                              ...
                                                              uint16_t  *xo_counter_value )
{
    ...
    RDD_IPTV_L2_DDR_LOOKUP_ENTRY_COUNTER_READ ( *xo_counter_value, iptv_entry_ptr );
    RDD_IPTV_L2_DDR_LOOKUP_ENTRY_COUNTER_WRITE ( 0, iptv_entry_ptr );
                                                 ...
                                                 rdd_vlan_command_params                 *xi_vlan_command_params )
{
    RDD_VLAN_OPTIMIZATION_TABLE_DTS  *vlan_optimization_table_ptr;
    RDD_VLAN_OPTIMIZATION_ENTRY_DTS  *vlan_optimization_entry_ptr;
    RDD_VLAN_PARAMETER_TABLE_DTS     *vlan_parameters_table_ptr;
    RDD_VLAN_PARAMETER_ENTRY_DTS     *vlan_parameters_entry_ptr;
    RDD_PBITS_PARAMETER_TABLE_DTS    *pbits_parameters_table_ptr;
    ...
    {
         vlan_parameters_table_ptr = ( RDD_VLAN_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + VLAN_PARAMETER_TABLE_ADDRESS );
         pbits_parameters_table_ptr = ( RDD_PBITS_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + PBITS_PARAMETER_TABLE_ADDRESS );
         vlan_optimization_table_ptr = ( RDD_VLAN_OPTIMIZATION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + VLAN_OPTIMIZATION_TABLE_ADDRESS );
    }
    else
    {
        vlan_parameters_table_ptr = ( RDD_VLAN_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + VLAN_PARAMETER_TABLE_ADDRESS );
        pbits_parameters_table_ptr = ( RDD_PBITS_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + PBITS_PARAMETER_TABLE_ADDRESS );
        vlan_optimization_table_ptr = ( RDD_VLAN_OPTIMIZATION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + VLAN_OPTIMIZATION_TABLE_ADDRESS );
    }

    vlan_parameters_entry_ptr = &( vlan_parameters_table_ptr->entry[ xi_vlan_command_params->vlan_command_id ] );
    ...
    pbits_parameters_entry_ptr = &( pbits_parameters_table_ptr->entry[ xi_vlan_command_params->vlan_command_id ] );
    ...
    vlan_optimization_entry_ptr = &( vlan_optimization_table_ptr->entry[ xi_vlan_command_params->vlan_command_id ] );
...
{
    RDD_PBITS_TO_PBITS_TABLE_DTS  *pbits_to_pbits_table_ptr;
    RDD_PBITS_TO_PBITS_ENTRY_DTS  *pbits_to_pbits_entry_ptr;

    pbits_to_pbits_table_ptr = ( RDD_PBITS_TO_PBITS_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + PBITS_TO_PBITS_TABLE_ADDRESS );

    pbits_to_pbits_entry_ptr = &( pbits_to_pbits_table_ptr->entry[ xi_table_number ][ xi_input_pbits ] );

    RDD_PBITS_TO_PBITS_ENTRY_PBITS_WRITE ( xi_output_pbits, pbits_to_pbits_entry_ptr );


    pbits_to_pbits_table_ptr = ( RDD_PBITS_TO_PBITS_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + PBITS_TO_PBITS_TABLE_ADDRESS );
                                                         ...
                                                         rdpa_traffic_dir  xi_direction )
{
    ...
    RDD_TPID_OVERWRITE_TABLE_DTS  *tpid_overwrite_table_ptr;
    RDD_TPID_OVERWRITE_ENTRY_DTS  *tpid_overwrite_entry_ptr;
    uint32_t                      i;

    if ( xi_direction == rdpa_dir_ds )
    {
        tpid_overwrite_table_ptr = ( RDD_TPID_OVERWRITE_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + TPID_OVERWRITE_TABLE_ADDRESS );
    }
    else
    {
        tpid_overwrite_table_ptr = ( RDD_TPID_OVERWRITE_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + TPID_OVERWRITE_TABLE_ADDRESS );
    }

    for ( i = 0; i < RDD_TPID_OVERWRITE_TABLE_SIZE; i++ )
    {
                                                ...
                                                BL_LILAC_RDD_FILTER_ACTION_DTE  xi_filter_action )
{
    ...
    RDD_DS_INGRESS_FILTERS_LOOKUP_TABLE_DTS      *filters_cam_table_ptr;
    RDD_INGRESS_FILTERS_LOOKUP_ENTRY_DTS         *filters_cam_entry_ptr;
    RDD_DS_INGRESS_FILTERS_PARAMETER_TABLE_DTS   *filters_cam_parameter_table_ptr;
    ...
    if ( xi_bridge_port == BL_LILAC_RDD_WAN_BRIDGE_PORT || xi_bridge_port == BL_LILAC_RDD_WAN_IPTV_BRIDGE_PORT || xi_bridge_port == BL_LILAC_RDD_WAN_ROUTER_PORT )
    {
        ...
        filters_cam_parameter_table_ptr = ( RDD_DS_INGRESS_FILTERS_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + DS_INGRESS_FILTERS_PARAMETER_TABLE_ADDRESS );
    }
    else
    {
        filters_cfg_table_ptr = ( RDD_INGRESS_FILTERS_CONFIGURATION_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + INGRESS_FILTERS_CONFIGURATION_TABLE_ADDRESS );
        ...
        filters_cam_parameter_table_ptr = ( RDD_DS_INGRESS_FILTERS_PARAMETER_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + US_INGRESS_FILTERS_PARAMETER_TABLE_ADDRESS );
    }
    ...
    filters_cam_parameter_entry_ptr = &( filters_cam_parameter_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_IGMP_FILTER_NUMBER ] );
    ...
    if ( xi_igmp_filter_mode == BL_LILAC_RDD_FILTER_ENABLE )
    {
        ...
        {
            RDD_INGRESS_FILTERS_PARAMETER_ENTRY_PARAMETER_WRITE ( rdpa_cpu_rx_reason_igmp, filters_cam_parameter_entry_ptr );
                                                  ...
                                                  BL_LILAC_RDD_FILTER_MODE_DTE  xi_icmpv6_filter_mode )
{
    ...
    filters_cam_parameter_entry_ptr = &( filters_cam_parameter_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_ICMPV6_FILTER_NUMBER ] );
    ...
    if ( xi_icmpv6_filter_mode == BL_LILAC_RDD_FILTER_ENABLE )
    {
        ...
        RDD_INGRESS_FILTERS_PARAMETER_ENTRY_PARAMETER_WRITE ( rdpa_cpu_rx_reason_icmpv6, filters_cam_parameter_entry_ptr );
        RDD_INGRESS_FILTERS_PARAMETER_ENTRY_CPU_TRAP_WRITE ( LILAC_RDD_TRUE, filters_cam_parameter_entry_ptr );
                                                      ...
                                                      BL_LILAC_RDD_FILTER_ACTION_DTE             xi_ether_type_action )
{
    ...
    filters_cam_entry_ptr = &( filters_cam_table_ptr->entry[ bridge_port_index ][ xi_ether_type_filter_number ] );

    filters_cam_parameter_entry_ptr = &( filters_cam_parameter_table_ptr->entry[ bridge_port_index ][ xi_ether_type_filter_number ] );
    ...
    if ( xi_ether_type_filter_mode == BL_LILAC_RDD_FILTER_ENABLE )
    {
        ...
        {
            cpu_reason = rdpa_cpu_rx_reason_etype_udef_0 + xi_ether_type_filter_number - BL_LILAC_RDD_ETHER_TYPE_FILTER_USER_0;
                                                     ...
                                                     BL_LILAC_RDD_FILTER_ACTION_DTE  xi_filter_action )
{
    ...
    filters_cam_parameter_entry_ptr = &( filters_cam_parameter_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_BROADCAST_FILTER_NUMBER ] );
    ...
    if ( xi_broadcast_filter_mode == BL_LILAC_RDD_FILTER_ENABLE )
    {
        ...
        if ( xi_filter_action == BL_LILAC_RDD_FILTER_ACTION_CPU_TRAP )
        {
            RDD_INGRESS_FILTERS_PARAMETER_ENTRY_PARAMETER_WRITE ( rdpa_cpu_rx_reason_bcast, filters_cam_parameter_entry_ptr );
            RDD_INGRESS_FILTERS_PARAMETER_ENTRY_CPU_TRAP_WRITE ( LILAC_RDD_TRUE, filters_cam_parameter_entry_ptr );
                                                     ...
                                                     BL_LILAC_RDD_FILTER_ACTION_DTE  xi_filter_action )
{
    ...
    filters_cam_parameter_entry_ptr = &( filters_cam_parameter_table_ptr->entry[ bridge_port_index ][ BL_LILAC_RDD_MULTICAST_FILTER_NUMBER ] );
...
BL_LILAC_RDD_ERROR_DTE rdd_virtual_port_config ( BL_LILAC_RDD_BRIDGE_PORT_VECTOR_DTE  xi_lan_port_vector )
{
    ...
    bridge_cfg_register_ptr = ( RDD_BRIDGE_CONFIGURATION_REGISTER_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + BRIDGE_CONFIGURATION_REGISTER_ADDRESS );
                                              ...
                                              BL_LILAC_RDD_MAC_ENTRY_TYPE_DTE  xi_entry_type )
{
    ...
    rdd_error = rdd_remove_hash_entry_64_bit ( &g_hash_table_cfg[ BL_LILAC_RDD_MAC_TABLE ],
                                               ...
                                               MAC_ENTRY_KEY_MASK_LOW,
                                               0,
                                               BL_LILAC_RDD_CAM_OPTIMIZATION_ENABLE,
                                               &entry_index );
...
{
    RDD_FORWARDING_MATRIX_TABLE_DTS  *forwarding_matrix_table_ptr;
    RDD_FORWARDING_MATRIX_ENTRY_DTS  *forwarding_matrix_entry_ptr;
    uint8_t                          forward_matrix_enable;

    forwarding_matrix_table_ptr = ( RDD_FORWARDING_MATRIX_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_0_OFFSET ) + FORWARDING_MATRIX_TABLE_ADDRESS );

    forwarding_matrix_entry_ptr = &( forwarding_matrix_table_ptr->entry[ xi_src_bridge_port ][ xi_dst_bridge_port ] );
    ...
    forwarding_matrix_table_ptr = ( RDD_FORWARDING_MATRIX_TABLE_DTS * )(DEVICE_ADDRESS( RUNNER_PRIVATE_1_OFFSET ) + FORWARDING_MATRIX_TABLE_ADDRESS );
