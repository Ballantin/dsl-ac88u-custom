...
#ifdef CONFIG_DHD_RUNNER
    if ( is_dhd_enabled && xi_runner_index == PICO_RUNNER_A && xi_msg_type == LILAC_RDD_CPU_TX_MESSAGE_DHD_MESSAGE )
    {
                                                          ...
                                                          RDD_SERVICE_QUEUE_PM_COUNTERS_DTE  *xo_pm_counters )
{
    ...
    rdd_error = rdd_4_bytes_counter_get ( SERVICE_QUEUE_PACKET_GROUP, xi_service_queue, LILAC_RDD_TRUE, &xo_pm_counters->good_tx_packet );
    ...
    rdd_error = rdd_2_bytes_counter_get ( SERVICE_QUEUE_PACKET_GROUP, SERVICE_QUEUE_DROP_COUNTER_GROUP_OFFSET + xi_service_queue, LILAC_RDD_TRUE, &xo_pm_counters->error_tx_packets_discard );
