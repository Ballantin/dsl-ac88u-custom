...
int ext_switch_init(void)
{
    ...
    if ((data32 == BCM53115) || (data32 == BCM53125) || (data32 == BCM53128) || (data32 == BCM53134))
    {
        int i; 
        ...
        for (i = 4; i < EPHY_PORTS; i++) {      
            ...
            if ((EnetInfo[0].sw.port_map & (1 << i)) && ((data32 == BCM53125) || (data32 == BCM53128) || (data32 == BCM53134)) && IsRGMII(phy_id)) {            
