...
//For ASUS DSL-AC88U
  ...
  //{bp_usGpioLedBlStop,         .u.us = BP_GPIO_37_AL},
  //{bp_usGpioDectLed,           .u.us = BP_GPIO_25_AL},
  //{bp_usGpioVoip1Led,          .u.us = BP_GPIO_19_AL},
  //{bp_usGpioVoip2Led,          .u.us = BP_GPIO_21_AL},
#if 0 // Never use Interrupt Pin to control BP_EXT_INTR_0 (GPIO 32) and  BP_EXT_INTR_1 (GPIO 33)
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},
#endif
  //{bp_usGpioLedSesWireless,    .u.us = BP_GPIO_23_AL}, 
  //{bp_usGpioLedAdsl,           .u.us = BP_GPIO_27_AL},
  //{bp_usGpioLedAdslFail,	   .u.us = BP_GPIO_27_AL},
  //{bp_usGpioSecLedAdsl,        .u.us = BP_GPIO_21_AL},
  //{bp_usGpioLedWanData,        .u.us = BP_GPIO_27_AL},
  //{bp_usGpioSecLedWanData,     .u.us = BP_GPIO_21_AL},
  
  // AFE for ASUS DSL-AC88U Annex-A
  // AFE_ID: 0 is GFAST and 1 is DSL.
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_GFAST | BP_AFE_LD_6303 | BP_AFE_FE_REV_6303_REV_12_50 },
  {bp_ulAfeId1,                .u.ul = BP_AFE_CHIP_CH1 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6303_REV_12_3_40 },
  //{bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_CH1 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6303_REV_12_3_40 },
  //{bp_ulAfeId1,                .u.ul = BP_AFE_CHIP_GFAST_CH0 | BP_AFE_LD_6303 | BP_AFE_FE_REV_6303_REV_12_50 },
  ...
  {bp_usGpioExtAFELDData,      .u.us = BP_GPIO_9_AH},
  {bp_usGpioExtAFELDClk,       .u.us = BP_GPIO_10_AH},
  //{bp_usGpioAFELDRelay,        .u.us = BP_GPIO_7_AL},
  ...
  {bp_ulCrossbarPhyId,         .u.ul = (BCM963138_PHY_BASE + 0x04) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
  /* use the WAN LED from runner */
  //{bp_ulCrossbar,              .u.ul = 9}, // We don't support SFP.  So comment out to avoid SFP module plugged in/unplugged message in some H/Ws */
  //{bp_ulCrossbarPhyId,         .u.ul = 6 |  PHY_INTEGRATED_VALID | MAC_IF_SERDES | PHY_EXTERNAL},
  {bp_ulPhyId1,                .u.ul = GMII_DIRECT | EXTSW_CONNECTED},
  {bp_ulPortFlags,             .u.ul = PORT_FLAG_MGMT }, // Managment port is on switch
  {bp_ucPhyType1,              .u.uc = BP_ENET_EXTERNAL_SWITCH},
  ...
  //{bp_usSpeedLed1000,          .u.us = BP_GPIO_3_AL},
  //{bp_usLinkLed,               .u.us = BP_GPIO_11_AL},
  //{bp_usGpioWirelessPowerDown, .u.us = BP_GPIO_1_AL},  // wifi 2.4G power-down
  //{bp_usGpioWirelessPowerDown2,.u.us = BP_GPIO_7_AL},  // wifi 5G power-down
  //---
  {bp_ulPhyId2,                .u.ul = (BCM963138_PHY_BASE + 0x02) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
//  {bp_usSpeedLed100,           .u.us = BP_GPIO_4_AL},
  {bp_usSpeedLed1000,          .u.us = BP_GPIO_5_AL},
/* Velmurugan 05192015> Press reset button stops booting @ CFE */
  {bp_usButtonIdx,             .u.us = 1},
  {bp_usGpio_Intr,             .u.us = BP_GPIO_32_AL},
  {bp_usButtonAction,        .u.us = BP_BTN_ACTION_PRINT | BP_BTN_TRIG_PRESS },
  {bp_ulButtonActionParm,    .u.ul = (unsigned long)"Button 1 Press -- Hold for 5s to do restore to default" },
...
#endif
  //---Lancelot
  {bp_ulPhyId5,                .u.ul = 0x18 | RGMII_DIRECT },
  {bp_ulPortFlags,             .u.ul = PORT_FLAG_TRUNK_GROUP_0},//Enable trunk mode for QTN 5G wifi
  {bp_ulPhyId7,                .u.ul = 0x19 | RGMII_DIRECT },
  {bp_ulPortFlags,             .u.ul = PORT_FLAG_TRUNK_GROUP_0},//Enable trunk mode for QTN 5G wifi
  {bp_ucDspType0,              .u.uc = BP_VOIP_DSP},
  {bp_ucDspAddress,            .u.uc = 0},
  //{bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_128MB| BP_DDR_DEVICE_WIDTH_16},
  //{bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_533_8_8_8 | BP_DDR_TOTAL_SIZE_256MB| BP_DDR_DEVICE_WIDTH_16},
  {bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16},
  {bp_usUsbPwrOn0,             .u.us = BP_GPIO_133_AH},
  {bp_usUsbPwrOn1,             .u.us = BP_GPIO_135_AH},
  //---
  {bp_last}
};
/// ARCADYAN
...
bp_elem_t * g_BoardParms[] = {g_bcm963138sv, g_bcm963138dvt, g_bcm963138ref_gfast_p40x, g_bcm963138ref_gfast_2,  g_bcm963138ref_gfast_p40x_mem,
    g_bcm963138bg_gfast, g_arcadyan, g_bcm963138ref_p502, g_bcm963138ref_p802, g_bcm963138bmu_p202, g_bcm963138lte_p302, g_bcm963138lte2, g_bcm963138ref_p502_plc, g_bcm963138ref_p502_moca,  
    g_bcm963138ref_p502_bhr, g_bcm963138dvt_p300, g_bcm963138ref_rnc, g_bcm963138ref_rncp400, g_bcm963138ref_p502_moca_p200, g_bcm963138ref_p502_dual_moca_p200, g_bcm963138ref_3wlan, 0};
#endif
