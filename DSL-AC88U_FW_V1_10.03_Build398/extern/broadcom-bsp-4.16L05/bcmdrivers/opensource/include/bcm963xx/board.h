...
// ARCADYAN
#define BOARD_IOCTL_SET_GPIO_PINMUX             _IOWR(BOARD_IOCTL_MAGIC, 60, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_GPIO                    _IOWR(BOARD_IOCTL_MAGIC, 61, BOARD_IOCTL_PARMS)
/* ARCADYAN #ARC_RC_SD6#, 2015/03/20, simon, add DECT IOCTL */
#define BOARD_IOCTL_WAKEUP_DECT                 _IOWR(BOARD_IOCTL_MAGIC, 62, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_RESET_DECT                  _IOWR(BOARD_IOCTL_MAGIC, 63, BOARD_IOCTL_PARMS)
/* ARCADYAN #ARC_RC_SD6#, 2015/07/06, simon, add GET/SET DECT RFPI */
#define BOARD_IOCTL_DECT_GET_PARAM		_IOWR(BOARD_IOCTL_MAGIC, 64, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_DECT_SET_PARAM              _IOWR(BOARD_IOCTL_MAGIC, 65, BOARD_IOCTL_PARMS)
/// ARCADYAN
...
typedef enum 
{
    ...
    SYSLOG,
// ARCADYAN
    ACTION_RFPI,     /*Arcadyan Simon Chu 2015.09.01, Add DECT IO control action */
    ACTION_RXTUN
/// ARCADYAN
} BOARD_IOCTL_ACTION;
