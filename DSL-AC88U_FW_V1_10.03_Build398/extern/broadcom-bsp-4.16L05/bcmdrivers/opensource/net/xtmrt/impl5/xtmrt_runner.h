...
static inline int bcmxapi_xmit_packet(pNBuff_t *ppNBuf, UINT8 **ppData, UINT32 *pLen,
                                      ...
                                      UINT16 bufStatus, UINT32 skbMark, UINT32 phyOverhead);
